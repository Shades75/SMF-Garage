...
function Garage() 
{
    ...
    if ($smfgSettings['enable_search_menu']) {
        $g_subActions['g_search'] = array(&$txt['smfg_search'], 'G_Search', $context['garage_sa'] == 'g_search' || $context['garage_sa'] == 'search_results');
    }           
    ...
    if($smfgSettings['enable_featured_vehicle'] != 0 && $context['total_vehicles'] != 0) {
        ...
        if(isset($context['featured_vehicle']['id']) && !empty($context['featured_vehicle']['id'])) {
            ...
            if(isset($context['featured_vehicle']['image_id'])) {
                ...
                $smcFunc['db_free_result']($request);
                if(empty($context['featured_vehicle'][$count]['attach_desc'])) $context['featured_vehicle'][$count]['attach_desc'] = $txt['smfg_no_desc'];    
...
{    
    ...
    // Clean up the mess
    if(empty($_POST['engine_type'])) $_POST['engine_type'] = 0;
    ...
    if($smfgSettings['enable_vehicle_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'user_id' => 'int', 'made_year' => 'int', 'engine_type' => 'int', 'color' => 'string', 'mileage' => 'int', 'mileage_unit' => 'string', 'price' => 'string', 'currency' => 'int', 'comments' => 'string', 'date_created' => 'int', 'date_updated' => 'int', 'make_id' => 'int', 'model_id' => 'int', 'main_vehicle' => 'int', 'pending' => 'string',
                ),
                array(
                    $context['user']['id'], $_POST['made_year'], $_POST['engine_type'], $_POST['color'], $_POST['mileage'], $_POST['mileage_units'], $_POST['price'], $_POST['currency'], $_POST['comments'], $context['date_created'], $context['date_created'], $_POST['make_id'], $_POST['model_id'], $main_vehicle, $pending,
                ),
                array(
                    // no data
                )
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'image_id' => 'int', 'hilite' => 'int',
                ),
                array(
                    $context['vehicle_id'], $context['image_id'], 1,
                ),
                array(
                    // no data
                )
    ...
    if($smfgSettings['enable_vehicle_video'] && $_POST['video_url'] > 'http://') {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                'vehicle_id' => 'int', 'url' => 'string', 'title' => 'string', 'video_desc' => 'string',
            ),
            array(
                $context['vehicle_id'], $_POST['video_url'], $_POST['video_title'], $_POST['video_desc'],
            ),
            array(
                // no data
            )
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                'vehicle_id' => 'int', 'video_id' => 'int', 'type' => 'string',
            ),
            array(
                $context['vehicle_id'], $context['video_id'], 'vehicle',
            ),
            array(
                // no data
            )
...
function G_View_Garage()
{
    ...
    $smcFunc['db_free_result']($request2);
    if(empty($context['user_vehicles'][$count]['attach_desc'])) $context['user_vehicles'][$count]['attach_desc'] = $txt['smfg_no_desc'];    
...
function G_View_Vehicle()
{
        ...
        $request = $smcFunc['db_query']('','
            ...
            while($row = $smcFunc['db_fetch_row']($request)) {
                ...
                if(!empty($context['user_vehicles'][$count]['video_id'])) {
                    ...
                    $smcFunc['db_free_result']($request2); 
                    if(empty($context['user_vehicles'][$count]['video_desc'])) $context['user_vehicles'][$count]['video_desc'] = $txt['smfg_no_desc'];
    ...
    while($row = $smcFunc['db_fetch_row']($request)) {
        ...
        if(!empty($context['mods'][$count]['image_id'])) {              
            ...
            if(empty($context['mods'][$count]['attach_desc'])) $context['mods'][$count]['attach_desc'] = $txt['smfg_no_desc'];
            ...
            if($smfgSettings['enable_modification_video']) {
                ...
                if(!empty($context['mods'][$count]['video_id'])) {              
                    ...
                    $smcFunc['db_free_result']($request3);
                    if(empty($context['mods'][$count]['video_desc'])) $context['mods'][$count]['video_desc'] = $txt['smfg_no_desc'];
    ...
    while($row = $smcFunc['db_fetch_row']($request)) {
        ...
        if(!empty($context['dynoruns'][$count]['image_id'])) {              
            ...
            $smcFunc['db_free_result']($request3);    
            if(empty($context['dynoruns'][$count]['attach_desc'])) $context['dynoruns'][$count]['attach_desc'] = $txt['smfg_no_desc'];        
        ...
        if($smfgSettings['enable_dynorun_video']) {
            ...
            if(!empty($context['dynoruns'][$count]['video_id'])) {              
                ...
                $smcFunc['db_free_result']($request3);
                if(empty($context['dynoruns'][$count]['video_desc'])) $context['dynoruns'][$count]['video_desc'] = $txt['smfg_no_desc'];
    ...
    while($row = $smcFunc['db_fetch_row']($request)) {
        ...
        if(!empty($context['qmiles'][$count]['image_id'])) {              
            ...
            $smcFunc['db_free_result']($request3); 
            if(empty($context['qmiles'][$count]['attach_desc'])) $context['qmiles'][$count]['attach_desc'] = $txt['smfg_no_desc'];
        ...
        if($smfgSettings['enable_quartermile_video']) {
            ...
            if(!empty($context['qmiles'][$count]['video_id'])) {              
                ...
                $smcFunc['db_free_result']($request3);
                if(empty($context['qmiles'][$count]['video_desc'])) $context['qmiles'][$count]['video_desc'] = $txt['smfg_no_desc'];
    ...
    while($row = $smcFunc['db_fetch_row']($request)) {
        ...
        if(!empty($context['laps'][$count]['image_id'])) {              
            ...
            $smcFunc['db_free_result']($request3);        
            if(empty($context['laps'][$count]['attach_desc'])) $context['laps'][$count]['attach_desc'] = $txt['smfg_no_desc'];
        ...
        if($smfgSettings['enable_laptime_video']) {
            ...
            if(!empty($context['laps'][$count]['video_id'])) {              
                ...
                $smcFunc['db_free_result']($request3);
                if(empty($context['laps'][$count]['video_desc'])) $context['laps'][$count]['video_desc'] = $txt['smfg_no_desc'];
    ...
    if($num_rows == 0) {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                $context['user_vehicles']['id'], $client_ip,
            ),
            array(
                // no data
            )
...
function G_Insert_Modification()
{
    ...
    if(empty($_POST['shop_id'])) $_POST['shop_id'] = 0;
    if(empty($_POST['installer_id'])) $_POST['installer_id'] = 0;
    ...
    if($smfgSettings['enable_modification_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'user_id' => 'int', 'category_id' => 'int', 'manufacturer_id' => 'int', 'product_id' => 'int', 'price' => 'string', 'install_price' => 'string', 'product_rating' => 'int', 'purchase_rating' => 'int', 'install_rating' => 'int', 'shop_id' => 'int', 'installer_id' => 'int', 'comments' => 'string', 'install_comments' => 'string', 'date_created' => 'int', 'date_updated' => 'int', 'pending' => 'string',
                ),
                array(
                    $context['vehicle_id'], $context['owner_id'], $_POST['category_id'], $_POST['manufacturer_id'], $_POST['product_id'], $_POST['price'], $_POST['install_price'], $_POST['product_rating'], $_POST['purchase_rating'], $_POST['install_rating'], $_POST['shop_id'], $_POST['installer_id'], $_POST['comments'], $_POST['install_comments'], $context['date_created'], $context['date_created'], $pending,
                ),
                array(
                    'id'
                )
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'modification_id' => 'int', 'image_id' => 'int', 'hilite' => 'int',
                ),
                array(
                    $context['vehicle_id'], $context['mod_id'], $context['image_id'], 1,
                ),
                array(
                    'vehicle_id', 'modification_id', 'image_id'
                )
            );         
    ...
    if($smfgSettings['enable_modification_images'] != 1 | $_FILES['FILE_UPLOAD']['error'] == 4 && $_POST['url_image'] <= 'http://') {
        ...
        $request = $smcFunc['db_insert']('',
            ...
            array(
                'vid' => $context['vehicle_id'], $context['owner_id'], $_POST['category_id'], $_POST['manufacturer_id'], $_POST['product_id'], $_POST['price'], $_POST['install_price'], $_POST['product_rating'], $_POST['purchase_rating'], $_POST['install_rating'], $_POST['shop_id'], $_POST['installer_id'], $_POST['comments'], $_POST['install_comments'], $context['date_created'], $context['date_created'], $pending,
            ),
            array(
                // no data
            )
    ...
    if($smfgSettings['enable_modification_video'] && $_POST['video_url'] > 'http://') {
        ...
        $request = $smcFunc['db_insert']('insert',
            '{db_prefix}garage_video_gallery',
            array(
                'vehicle_id' => 'int', 'video_id' => 'int', 'type' => 'string', 'type_id' => 'int',
            ),
            array(
                $context['vehicle_id'], $context['video_id'], 'mod', $context['mod_id'],
            ),
            array(
                // no data
            )
...
function G_Insert_Insurance()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'vehicle_id' => 'int', 'business_id' => 'int', 'premium' => 'int', 'cover_type_id' => 'int', 'comments' => 'string',
        ),
        array(
            $_POST['VID'], $_POST['business_id'], $_POST['premium'], $_POST['cover_type'], $_POST['comments'],
        ),
        array(
            // no data
        )
...
function G_Insert_Quartermile()
{
    ...
    if(!$smfgSettings['enable_quartermile']) {
     ...
     if(empty($_POST['dynorun_id'])) $_POST['dynorun_id'] = 0;
    ...
    if($smfgSettings['enable_quartermile_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'rt' => 'string', 'sixty' => 'string', 'three' => 'string', 'eighth' => 'string', 'eighthmph' => 'string', 'thou' => 'string', 'quart' => 'string', 'quartmph' => 'string', 'dynorun_id' => 'int', 'date_created' => 'int', 'date_updated' => 'int', 'pending' => 'string',
                ),
                array(
                    $context['vehicle_id'], $_POST['rt'], $_POST['sixty'], $_POST['three'], $_POST['eighth'], $_POST['eighthmph'], $_POST['thou'], $_POST['quart'], $_POST['quartmph'], $_POST['dynorun_id'], $context['date_created'], $context['date_created'], $pending,
                ),
                array(
                    // no data
                )
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'quartermile_id' => 'int', 'image_id' => 'int', 'hilite' => 'int',
                ),
                array(
                    $context['vehicle_id'], $context['qmile_id'], $context['image_id'], 1,
                ),
                array(
                    // no data
                )
    ...
    if($smfgSettings['enable_quartermile_video'] && $_POST['video_url'] > 'http://') {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                $context['vehicle_id'], $context['video_id'], 'qmile', $context['qmile_id'],
            ),
            array(
                // no data
            )
...
function G_Insert_Dynorun()
{
    ...
    if($smfgSettings['enable_dynorun_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'dynocenter_id' => 'int', 'bhp' => 'string', 'bhp_unit' => 'string', 'torque' => 'string', 'torque_unit' => 'string', 'boost' => 'string', 'boost_unit' => 'string', 'nitrous' => 'string', 'peakpoint' => 'string', 'date_created' => 'int', 'date_updated' => 'int', 'pending' => 'string',
                ),
                array(
                    $context['vehicle_id'], $_POST['dynocenter_id'], $_POST['bhp'], $_POST['bhp_unit'], $_POST['torque'], $_POST['torque_unit'], $_POST['boost'], $_POST['boost_unit'], $_POST['nitrous'], $_POST['peakpoint'], $context['date_created'], $context['date_created'], $pending,
                ),
                array(
                    // no data
                )
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'dynorun_id' => 'int', 'image_id' => 'int', 'hilite' => 'int',
                ),
                array(
                    $context['vehicle_id'], $context['dynorun_id'], $context['image_id'], 1,
                )
            );         
    ...
    if($smfgSettings['enable_dynorun_video'] && $_POST['video_url'] > 'http://') {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                $context['vehicle_id'], $context['video_id'], 'dynorun', $context['dynorun_id'],
            ),
            array(
                // no data
            )
...
function G_Insert_Laptime()
{
    ...
    if($smfgSettings['enable_lap_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'track_id' => 'int', 'condition_id' => 'int', 'type_id' => 'int', 'minute' => 'int', 'second' => 'int', 'millisecond' => 'int', 'pending' => 'string',
                ),
                array(
                    $context['vehicle_id'], $_POST['track_id'], $_POST['condition'], $_POST['type'], $_POST['minute'], $_POST['second'], $_POST['millisecond'], $pending,
                ),
                array(
                    // no data
                )
            ...
            $request = $smcFunc['db_insert']('insert',
                ...
                array(
                    'vehicle_id' => 'int', 'lap_id' => 'int', 'image_id' => 'int', 'hilite' => 'int',
                ),
                array(
                    $context['vehicle_id'], $context['lap_id'], $context['image_id'], 1,
                ),
                array(
                    // no data
                )
    ...
    if($smfgSettings['enable_laptime_video'] && $_POST['video_url'] > 'http://') {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                $context['vehicle_id'], $context['video_id'], 'lap', $context['lap_id'],
            ),
            array(
                // no data
            )
...
function G_Insert_Service()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'vehicle_id' => 'int', 'garage_id' => 'int', 'type_id' => 'int', 'price' => 'string', 'rating' => 'int', 'mileage' => 'int', 'date_created' => 'int', 'date_updated' => 'int',
        ),
        array(
            $_POST['VID'], $_POST['garage_id'], $_POST['type_id'], $_POST['price'], $_POST['rating'], $_POST['mileage'], $date_created, $date_created,
        ),
        array(
            // no data
        )
...
function G_Insert_Blog()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'vehicle_id' => 'int', 'user_id' => 'int', 'blog_title' => 'string', 'blog_text' => 'string', 'post_date' => 'int',
        ),
        array(
            $_POST['VID'], $_POST['user_id'], $blog_title, $blog_text, $date_created,
        ),
        array(
            // no data
        )
...
function G_Insert_Garage_Comment()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'user_id' => 'int', 'author_id' => 'int', 'post_date' => 'int', 'ip_address' => 'string', 'pending' => 'string', 'post' => 'string',
        ),
        array(
            $_POST['UID'], $_POST['user_id'], $date_created, $client_ip, $pending, $comment,
        ),
        array(
            // no data
        )
...
function G_Insert_Comment()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'vehicle_id' => 'int', 'author_id' => 'int', 'post_date' => 'int', 'ip_address' => 'string', 'pending' => 'string', 'post' => 'string',
        ),
        array(
            $_POST['VID'], $_POST['user_id'], $date_created, $client_ip, $pending, $comment,
        ),
        array(
            // no data
        )
        ...
        if($_SESSION['smfg']['display_as'] == "vehicles") {
            ...
            $context['search_results'][$count]['views'] = number_format($context['search_results'][$count]['views'], 0, '.', ',');
                ...
                if(isset($context['search_results'][$count]['image_id'])) {
                    ...
                    $smcFunc['db_free_result']($request2);
                    if(empty($context['search_results'][$count]['attach_desc'])) $context['search_results'][$count]['attach_desc'] = $txt['smfg_no_desc'];
                ...
                if($smfgSettings['enable_vehicle_video']) {
                    ...
                    if(isset($context['search_results'][$count]['video_id'])) {
                        ...
                        $smcFunc['db_free_result']($request2);
                         if(empty($context['search_results'][$count]['video_desc'])) $context['search_results'][$count]['video_desc'] = $txt['smfg_no_desc'];
...
function G_Insert_Vehicle_Images()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            $context['vehicle_id'], $context['image_id'], $hilite,
        ),
        array(
            // no data
        )
...
function G_Insert_Modification_Images()
{
    ...
    if($smfgSettings['enable_modification_images']) {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                $context['vehicle_id'], $context['MID'], $context['image_id'], $hilite,
            ),
            array(
                // no data
            )
...
function G_Insert_Quartermile_Images()
{
    ...
    if($smfgSettings['enable_quartermile_images']) {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                $context['vehicle_id'], $context['QID'], $context['image_id'], $hilite,
            ),
            array(
                // no data
            )
...
function G_Insert_Dynorun_Images()
{
    ...
    if($smfgSettings['enable_dynorun_images']) {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                $context['vehicle_id'], $context['DID'], $context['image_id'], $hilite,
            ),
            array(
                // no data
            )
...
function G_Insert_Laptime_Images()
{
    ...
    if($smfgSettings['enable_lap_images']) {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                $context['vehicle_id'], $context['LID'], $context['image_id'], $hilite,
            ),
            array(
                // no data
            )
...
{    
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'vehicle_id' => 'int', 'rating' => 'int', 'user_id' => 'int', 'rate_date' => 'int',
        ),
        array(
            $_POST['VID'], $_POST['rating'], $_POST['user_id'], time(),
        ),
        array(
            // no data
        )
...
function G_Submit_Model_Insert()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'make_id' => 'int', 'model' => 'string', 'pending' => 'string',
        ),
        array(
            $_POST['make_id'], $_POST['model'], $pending,
        ),
        array(
            // no data
        )
...
function G_Submit_Business_Insert()
{
    ...
    if ($matching_business > 0) {
        ...
        $request = $smcFunc['db_insert']('insert',
            ...
            array(
                'title' => 'string', 'address' => 'string', 'telephone' => 'string', 'fax' => 'string', 'website' => 'string', 'email' => 'string', 'opening_hours' => 'string', 'product' => 'int', 'retail' => 'int', 'garage' => 'int', 'insurance' => 'int', 'dynocenter' => 'int', 'pending' => 'string',
            ),
            array(
                $_POST['title'], $_POST['address'], $_POST['telephone'], $_POST['fax'], $_POST['website'], $_POST['email'], $_POST['opening_hours'], $typeval['product'], $typeval['retail'], $typeval['garage'], $typeval['insurance'], $typeval['dynocenter'], 'pending' => $pending,
            ),
            array(
                // no data
            )
...
function G_Submit_Product_Insert()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'business_id' => 'int', 'category_id' => 'int', 'title' => 'string', 'pending' => 'string',
        ),
        array(
            $_POST['manufacturer_id'], $_POST['category_id'], $_POST['product'], $pending,
        ),
        array(
            // no data
        )
...
function G_Submit_Track_Insert()
{
    ...
    $request = $smcFunc['db_insert']('insert',
        ...
        array(
            'title' => 'string', 'length' => 'string', 'mileage_unit' => 'string', 'pending' => 'string',
        ),
        array(
            $_POST['track'], $_POST['length'], $_POST['mileage_unit'], $pending,
        ),
        array(
            // no data
        )
    ...
    if(isset($thumb) && !empty($thumb)){
        if($is_remote) {
            ...
            if(url_validate($thumb)) getRemoteImage($thumb,$target);
                else $veh_image_thumb = $boarddir."/Themes/default/images/garage_no_vehicle_thumb.png";
