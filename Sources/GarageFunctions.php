 ...
 {     
     ...
     if ($source == 0) {
        ...
        $request = $smcFunc['db_insert']('insert', 
            ...
            array(
                'vehicle_id' => 'int', 'attach_location' => 'string', 'attach_ext' => 'string', 'attach_file' => 'string', 'attach_thumb_location' => 'string', 'attach_thumb_width' => 'int', 'attach_thumb_height' => 'int', 'attach_is_image' => 'int', 'attach_date' => 'int', 'attach_filesize' => 'int', 'attach_thumb_filesize' => 'int', 'attach_desc' => 'string',
            ),
            array(
                $context['vehicle_id'], $attach_filename, $ext, $file['name'], $attach_thumb_filename, $attach_thumb_width, $attach_thumb_height, $attach_is_image, $context['date_created'], $attach_filesize, $attach_thumb_filesize, $extra['attach_desc'],
            ),
            array(
                'vehicle_id'
            )
     ...
     // If a remote image was supplied, use it instead   
        ...
        $request = $smcFunc['db_insert']('insert', 
            '{db_prefix}garage_images', 
            array(
                'vehicle_id' => 'int', 'attach_location' => 'string', 'attach_ext' => 'string', 'attach_file' => 'string', 'attach_thumb_location' => 'string', 'attach_thumb_width' => 'int', 'attach_thumb_height' => 'int', 'attach_is_image' => 'int', 'attach_date' => 'int', 'attach_filesize' => 'int', 'attach_thumb_filesize' => 'int', 'attach_desc' => 'string', 'is_remote' => 'int',
            ),
            array(
                $context['vehicle_id'], $attach_filename, $ext, $url_image, $attach_thumb_filename, $attach_thumb_width, $attach_thumb_height, $attach_is_image, $context['date_created'], $attach_filesize, $attach_thumb_filesize, $file['attach_desc'], $context['display_as_remote'],
            ),
            array(
                // no data
            )
 ...
 function smfg_footer()
 {
  ...
  $output =  '
    <table border="0" width="100%">
        ...
        <tr>
            <td align="center">
            <span class="smalltext"><a href="http://www.smfgarage.com" target="_blank">'.$txt['smfg_powered_by'].' '.$smfgSettings['version'].'</a> | <a href="'.$scripturl.'?action=garage;sa=copyright">'.$txt['smfg_copy'].' 2007-'.date('Y', time()).'</a></span>
            </td>
        </tr>
    </table>';
