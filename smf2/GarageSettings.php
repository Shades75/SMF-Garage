...
function UpdateGeneral()
{
    ...
    // Define all indices
    if(!isset($_POST['config']['enable_vehicle_approval'])) $_POST['config']['enable_vehicle_approval'] = 0;
    if(!isset($_POST['config']['enable_user_submit_make'])) $_POST['config']['enable_user_submit_make'] = 0;
    if(!isset($_POST['config']['enable_make_approval'])) $_POST['config']['enable_make_approval'] = 0;
    if(!isset($_POST['config']['enable_user_submit_model'])) $_POST['config']['enable_user_submit_model'] = 0;
    if(!isset($_POST['config']['enable_model_approval'])) $_POST['config']['enable_model_approval'] = 0;
    if(!isset($_POST['config']['enable_user_submit_business'])) $_POST['config']['enable_user_submit_business'] = 0;
    if(!isset($_POST['config']['enable_business_approval'])) $_POST['config']['enable_business_approval'] = 0;
    if(!isset($_POST['config']['enable_user_submit_product'])) $_POST['config']['enable_user_submit_product'] = 0;
    if(!isset($_POST['config']['enable_product_approval'])) $_POST['config']['enable_product_approval'] = 0;
    if(!isset($_POST['config']['enable_pm_pending_notify'])) $_POST['config']['enable_pm_pending_notify'] = 0;
    if(!isset($_POST['config']['enable_pm_pending_notify_optout'])) $_POST['config']['enable_pm_pending_notify_optout'] = 0;
    if(!isset($_POST['config']['enable_email_pending_notify'])) $_POST['config']['enable_email_pending_notify'] = 0;
    if(!isset($_POST['config']['enable_email_pending_notify_optout'])) $_POST['config']['enable_email_pending_notify_optout'] = 0;
    if(!isset($_POST['config']['integrate_viewtopic'])) $_POST['config']['integrate_viewtopic'] = 0;
    if(!isset($_POST['config']['integrate_profile'])) $_POST['config']['integrate_profile'] = 0;
    if(!isset($_POST['config']['disable_garage'])) $_POST['config']['disable_garage'] = 0;
...
function UpdateMenu()
{
    ...
    // Define all indices
    if(!isset($_POST['config']['enable_index_menu'])) $_POST['config']['enable_index_menu'] = 0;
    if(!isset($_POST['config']['enable_browse_menu'])) $_POST['config']['enable_browse_menu'] = 0;
    if(!isset($_POST['config']['enable_search_menu'])) $_POST['config']['enable_search_menu'] = 0;
    if(!isset($_POST['config']['enable_insurance_review_menu'])) $_POST['config']['enable_insurance_review_menu'] = 0;
    if(!isset($_POST['config']['enable_garage_review_menu'])) $_POST['config']['enable_garage_review_menu'] = 0;
    if(!isset($_POST['config']['enable_shop_review_menu'])) $_POST['config']['enable_shop_review_menu'] = 0;
    if(!isset($_POST['config']['enable_quartermile_menu'])) $_POST['config']['enable_quartermile_menu'] = 0;
    if(!isset($_POST['config']['enable_dynorun_menu'])) $_POST['config']['enable_dynorun_menu'] = 0;
    if(!isset($_POST['config']['enable_lap_menu'])) $_POST['config']['enable_lap_menu'] = 0;
...
function UpdateIndex()
{
    ...
    // Define all indices
    if(!isset($_POST['config']['featured_vehicle_image_required'])) $_POST['config']['featured_vehicle_image_required'] = 0;
    if(empty($_POST['config']['featured_vehicle_id'])) $_POST['config']['featured_vehicle_id'] = 0;
    if(empty($_POST['config']['featured_vehicle_from_block'])) $_POST['config']['featured_vehicle_from_block'] = 0;
...
function UpdateImage()
{
    ...
    // Define all indices
    if(!isset($_POST['config']['enable_vehicle_images'])) $_POST['config']['enable_vehicle_images'] = 0;
    if(!isset($_POST['config']['enable_modification_images'])) $_POST['config']['enable_modification_images'] = 0;
    if(!isset($_POST['config']['enable_quartermile_images'])) $_POST['config']['enable_quartermile_images'] = 0;
    if(!isset($_POST['config']['enable_dynorun_images'])) $_POST['config']['enable_dynorun_images'] = 0;
    if(!isset($_POST['config']['enable_lap_images'])) $_POST['config']['enable_lap_images'] = 0;
    if(!isset($_POST['config']['enable_remote_images'])) $_POST['config']['enable_remote_images'] = 0;
    if(!isset($_POST['config']['store_remote_images_locally'])) $_POST['config']['store_remote_images_locally'] = 0;
    if(!isset($_POST['config']['enable_watermark'])) $_POST['config']['enable_watermark'] = 0;
    if(!isset($_POST['config']['gcard_watermark'])) $_POST['config']['gcard_watermark'] = 0;
    if(!isset($_POST['config']['enable_watermark_thumb'])) $_POST['config']['enable_watermark_thumb'] = 0;
    if(!isset($_POST['config']['enable_lightbox'])) $_POST['config']['enable_lightbox'] = 0;
    ...
    if(!isset($_POST['config']['image_processor'])) $_POST['config']['image_processor'] = 0;
...
function UpdateVideo()
{
    ...
    // Define all indices
    if(!isset($_POST['config']['enable_vehicle_video'])) $_POST['config']['enable_vehicle_video'] = 0;
    if(!isset($_POST['config']['enable_modification_video'])) $_POST['config']['enable_modification_video'] = 0;
    if(!isset($_POST['config']['enable_quartermile_video'])) $_POST['config']['enable_quartermile_video'] = 0;
    if(!isset($_POST['config']['enable_dynorun_video'])) $_POST['config']['enable_dynorun_video'] = 0;
    if(!isset($_POST['config']['enable_laptime_video'])) $_POST['config']['enable_laptime_video'] = 0;
...
function UpdateModule()
{
    ...
    // Define all indices
    if(!isset($_POST['config']['enable_modification'])) $_POST['config']['enable_modification'] = 0;
    if(!isset($_POST['config']['enable_modification_approval'])) $_POST['config']['enable_modification_approval'] = 0;
    if(!isset($_POST['config']['enable_quartermile'])) $_POST['config']['enable_quartermile'] = 0;
    if(!isset($_POST['config']['enable_quartermile_approval'])) $_POST['config']['enable_quartermile_approval'] = 0;
    if(!isset($_POST['config']['enable_quartermile_image_required'])) $_POST['config']['enable_quartermile_image_required'] = 0;
    if(!isset($_POST['config']['enable_dynorun'])) $_POST['config']['enable_dynorun'] = 0;
    if(!isset($_POST['config']['enable_dynorun_approval'])) $_POST['config']['enable_dynorun_approval'] = 0;
    if(!isset($_POST['config']['enable_dynorun_image_required'])) $_POST['config']['enable_dynorun_image_required'] = 0;
    if(!isset($_POST['config']['enable_laptimes'])) $_POST['config']['enable_laptimes'] = 0;
    if(!isset($_POST['config']['enable_user_add_track'])) $_POST['config']['enable_user_add_track'] = 0;
    if(!isset($_POST['config']['enable_lap_approval'])) $_POST['config']['enable_lap_approval'] = 0;
    if(!isset($_POST['config']['enable_lap_image_required'])) $_POST['config']['enable_lap_image_required'] = 0;
    if(!isset($_POST['config']['enable_track_approval'])) $_POST['config']['enable_track_approval'] = 0;
    if(!isset($_POST['config']['enable_insurance'])) $_POST['config']['enable_insurance'] = 0;
    if(!isset($_POST['config']['enable_guestbooks'])) $_POST['config']['enable_guestbooks'] = 0;
    if(!isset($_POST['config']['enable_guestbooks_bbcode'])) $_POST['config']['enable_guestbooks_bbcode'] = 0;
    if(!isset($_POST['config']['enable_guestbooks_comment_approval'])) $_POST['config']['enable_guestbooks_comment_approval'] = 0;
    if(!isset($_POST['config']['enable_service'])) $_POST['config']['enable_service'] = 0;
    if(!isset($_POST['config']['enable_blogs'])) $_POST['config']['enable_blogs'] = 0;
    if(!isset($_POST['config']['enable_blogs_bbcode'])) $_POST['config']['enable_blogs_bbcode'] = 0;
