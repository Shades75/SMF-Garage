...
function Garage() 
{
    ...
    if ($context['user']['is_logged']) {
        $g_subActions['user_garage'] = array(&$txt['smfg_my_vehicles'], 'G_User_Garage', $context['garage_sa'] == 'user_garage' || $context['garage_sa'] == 'add_vehicle' || $context['garage_sa'] == 'edit_vehicle' || $context['garage_sa'] == 'add_modification' || $context['garage_sa'] == 'add_insurance' || $context['garage_sa'] == 'add_quartermile' || $context['garage_sa'] == 'add_dynorun' || $context['garage_sa'] == 'add_laptime' || $context['garage_sa'] == 'add_service' || $context['garage_sa'] == 'edit_modification' || $context['garage_sa'] == 'edit_insurance' || $context['garage_sa'] == 'edit_dynorun' || $context['garage_sa'] == 'edit_quartermile' || $context['garage_sa'] == 'edit_laptime' || $context['garage_sa'] == 'edit_service' || $context['garage_sa'] == 'edit_blog');
    }       
    if ($smfgSettings['enable_browse_menu']) {
        $g_subActions['browse'] = array(&$txt['smfg_browse'], 'G_Browse', $context['garage_sa'] == 'browse' || $context['garage_sa'] == 'view_garage' || $context['garage_sa'] == 'view_vehicle' || $context['garage_sa'] == 'view_modification' || $context['garage_sa'] == 'view_dynorun' || $context['garage_sa'] == 'view_quartermile' || $context['garage_sa'] == 'view_laptime'  || $context['garage_sa'] == 'view_track' || $context['garage_sa'] == 'modifications' || $context['garage_sa'] == 'mostmodified' || $context['garage_sa'] == 'mostviewed' || $context['garage_sa'] == 'latestservice' || $context['garage_sa'] == 'toprated' || $context['garage_sa'] == 'mostspent' || $context['garage_sa'] == 'latestblog' || $context['garage_sa'] == 'latestvideo');
    }       
    if ($smfgSettings['enable_search_menu']) {
        $g_subActions['search'] = array(&$txt['smfg_search'], 'G_Search', $context['garage_sa'] == 'search' || $context['garage_sa'] == 'search_results');
    }           
    if ($smfgSettings['enable_insurance_review_menu'] && $smfgSettings['enable_insurance']) {
        $g_subActions['insurance'] = array(&$txt['smfg_insurance'], 'G_Insurance', $context['garage_sa'] == 'insurance' || $context['garage_sa'] == 'insurance_review');
    }       
    if ($smfgSettings['enable_shop_review_menu']) {
        $g_subActions['shops'] = array(&$txt['smfg_shops'], 'G_Shops', $context['garage_sa'] == 'shops' || $context['garage_sa'] == 'shop_review');
    }       
    if ($smfgSettings['enable_garage_review_menu']) {
        $g_subActions['garages'] = array(&$txt['smfg_garages'], 'G_Garages', $context['garage_sa'] == 'garages' || $context['garage_sa'] == 'garage_review');
    }   
    if ($smfgSettings['enable_quartermile_menu'] && $smfgSettings['enable_quartermile']) {
        $g_subActions['quartermiles'] = array(&$txt['smfg_quartermiles'], 'G_Quartermiles', $context['garage_sa'] == 'quartermiles');
    }       
...
function G_Main()
{
    global $txt, $scripturl, $db_prefix, $user_info, $settings, $boardurl;
    global $smfgSettings, $modSettings, $context, $func;
    ...
    $context['total_vehicles'] = mysql_num_rows($request);
    ...
    $context['total_mods'] = mysql_num_rows($request);
    mysql_free_result($request);
    ...
    $context['total_comments'] = mysql_num_rows($request);
    mysql_free_result($request);
        ...
        if(isset($context['featured_vehicle']['id']) && !empty($context['featured_vehicle']['id'])) {
            ...
            if(isset($context['featured_vehicle']['image_id'])) {
                ...
                WHERE attach_id = " . $context['featured_vehicle']['image_id'],__FILE__,__LINE__);
                    ...
                    mysql_free_result($request);
                if(empty($context['featured_vehicle'][$count]['attach_desc'])) $context['featured_vehicle'][$count]['attach_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';    
            ...
            }else if(!isset($context['featured_vehicle']['image_id']) && $smfgSettings['featured_vehicle_image_required']){
                list($fv_width, $fv_height) = getimagesize($settings['actual_images_url']."/no_image.png");
                $context['featured_vehicle']['image'] = "<img src=\"".$settings['actual_images_url']."/no_image.png\" width=\"".$fv_width."\" height=\"".$fv_height."\" /><br />";
            }
        }
    }
    ...
    if($smfgSettings['enable_newest_vehicle']) {
        ...
        if(isset($context['blocks']['total'])) $context['blocks']['total']++;
            else $context['blocks']['total'] = 1;
    
        // Get the five newest vehicles
        $request = db_query("
            SELECT v.id, v.user_id, v.date_created, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName
            FROM {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}members AS u
            ...
            LIMIT 0, ".$smfgSettings['newest_vehicle_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'newestVehicles\', \'newestVehiclesUpshrink\'); return false;"><img id="newestVehiclesUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=browse">' . $txt['smfg_newest_vehicles'] . '</a></td>
            </tr>
            
            <tr id="newestVehicles">
                <td class="windowbg">
                ...
                $context['blocks']['newest_vehicles'] .= '
                    ...
                    <tr class="windowbg">
                        ...
                        <td align="center" valign="middle" nowrap="nowrap">'.date($context['date_format'],$context['newest_vehicles'][$count]['date_created']).'</td>
                    </tr>';
                    $count++;
                    }
                } else {
    ...
    if($smfgSettings['enable_newest_modification']) {
        ...
        $request = db_query("
            SELECT m.id, p.title, m.vehicle_id, m.user_id, m.date_created, u.realName
            ...
            WHERE m.vehicle_id = v.id
                ...
                LIMIT 0, ".$smfgSettings['newest_modification_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'newestMods\', \'newestModsUpshrink\'); return false;"><img id="newestModsUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=modifications">' . $txt['smfg_newest_mods'] . '</a></td>
            </tr>
            <tr id="newestMods">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['newest_mods'] .= '
                    ...
                    <tr class="windowbg">
                        ...
                        <td align="center" valign="middle" nowrap="nowrap">'.date($context['date_format'],$context['newest_mods'][$count]['date_created']).'</td>
                    </tr>';
                    $count++;
                    }
                } else {
                    $context['blocks']['newest_mods'] .= '
                    <tr class="windowbg">
                        <td align="center" valign="middle">'.$txt['smfg_no_modifications_in_garage'].'</td>
                    </tr>';
                }
                    $context['blocks']['newest_mods'] .= '
                </table>
    ...
    if($smfgSettings['enable_most_modified']) {
        ...
        $request = db_query("
            SELECT v.id, COUNT( m.id ) AS total_mods, v.user_id, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName
            ...
            WHERE v.make_id = mk.id
                ...
                LIMIT 0, ".$smfgSettings['most_modified_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'mostMods\', \'mostModsUpshrink\'); return false;"><img id="mostModsUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=mostmodified">' . $txt['smfg_most_modified'] . '</a></td>
            </tr>
            <tr id="mostMods">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['most_mods'] .= '
                    <tr>
                        <td class="catbg">' . $txt['smfg_vehicle'] . '</td>
                        <td class="catbg">' . $txt['smfg_owner'] . '</td>
                        <td class="catbg">' . $txt['smfg_mods'] . '</td>
                    </tr>';
    ...
    if($smfgSettings['enable_most_viewed']) {
        ...
        $request = db_query("
            SELECT v.id, v.user_id, v.views, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName
            FROM {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}members AS u
            WHERE v.make_id = mk.id
                AND v.model_id = md.id
                AND mk.pending != '1'
                ...
                LIMIT 0, ".$smfgSettings['most_viewed_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'mostViews\', \'mostViewsUpshrink\'); return false;"><img id="mostViewsUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=mostviewed">' . $txt['smfg_most_viewed'] . '</a></td>
            </tr>
            <tr id="mostViews">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['most_views'] .= '
                    <tr>
                        <td class="catbg">' . $txt['smfg_vehicle'] . '</td>
                        <td class="catbg">' . $txt['smfg_owner'] . '</td>
                        <td class="catbg">' . $txt['smfg_views'] . '</td>
                    </tr>';
    ...
    if($smfgSettings['enable_top_quartermile']) {
        ...
        $request = db_query("
            SELECT q.id, v.user_id, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName, q.vehicle_id, q.quart, q.quartmph
            ...
            WHERE q.vehicle_id = v.id
                ...
                LIMIT 0, ".$smfgSettings['top_quartermile_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'topQm\', \'topQmUpshrink\'); return false;"><img id="topQmUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=quartermiles">' . $txt['smfg_top_qmile'] . '</a></td>
            </tr>
            <tr id="topQm">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['top_qm'] .= '
                    <tr>
                        <td class="catbg">' . $txt['smfg_vehicle'] . '</td>
                        <td class="catbg">' . $txt['smfg_owner'] . '</td>
                        <td class="catbg">' . $txt['smfg_quartermile_fraction'] . '</td>
                    </tr>';
    ...
    if($smfgSettings['enable_top_rating']) {
        ...
        $request = db_query("
            SELECT r.vehicle_id, ".$ratingfunc."( r.rating ) AS rating, COUNT( r.id ) * 10 AS poss_rating, v.user_id, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName
            ...
            WHERE r.vehicle_id = v.id
                ...
                LIMIT 0, ".$smfgSettings['top_rating_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'topRated\', \'topRatedUpshrink\'); return false;"><img id="topRatedUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=toprated">' . $txt['smfg_top_rated'] . '</a></td>
            </tr>
            <tr id="topRated">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
    ...
    if($smfgSettings['enable_updated_vehicle']) {
        ...
        $request = db_query("
            SELECT v.id, v.user_id, v.date_updated, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName
            FROM {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}members AS u
            WHERE v.make_id = mk.id
                AND v.model_id = md.id
                AND mk.pending != '1'
            ...
            LIMIT 0, ".$smfgSettings['updated_vehicle_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'updatedVehicles\', \'updatedVehiclesUpshrink\'); return false;"><img id="updatedVehiclesUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=browse;sort=updated">' . $txt['smfg_last_updated_vehicles'] . '</a></td>
            </tr>
            <tr id="updatedVehicles">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                $count = 0;                 
                if(isset($context['last_updated_veh'][$count]['id'])) {
                    ...
                    <tr class="windowbg">
                        ...
                        <td align="center" valign="middle" nowrap="nowrap">'.date($context['date_format'],$context['last_updated_veh'][$count]['date_updated']).'</td>
                    </tr>';
                    $count++;
                    }
                } else {
    ...
    if($smfgSettings['enable_updated_modification']) {
        ...
        $request = db_query("
            SELECT m.id, p.title, m.vehicle_id, m.user_id, m.date_updated, u.realName
            FROM {$db_prefix}garage_modifications AS m, {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}garage_products AS p, {$db_prefix}garage_business AS b, {$db_prefix}members AS u
            WHERE m.vehicle_id = v.id
                AND m.product_id = p.id
                AND p.business_id = b.id
            ...
            LIMIT 0, ".$smfgSettings['updated_modification_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'updatedMods\', \'updatedModsUpshrink\'); return false;"><img id="updatedModsUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=modifications;sort=updated">' . $txt['smfg_last_updated_mods'] . '</a></td>
            </tr>
            <tr id="updatedMods">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['last_updated_mods'] .= '
                    ...
                    <tr class="windowbg">
                        ...
                        <td align="center" valign="middle" nowrap="nowrap">'.date($context['date_format'],$context['last_updated_mods'][$count]['date_updated']).'</td>
                    </tr>';
                    $count++;
                    }
                } else {
    ...
    if($smfgSettings['enable_most_spent']) {
        ...
        $request = db_query("
            SELECT v.id, IFNULL(m.total_mods,0) + IFNULL(s.total_service,0) AS total_spent, v.user_id, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName, c.title AS currency
                FROM {$db_prefix}garage_vehicles AS v
                LEFT OUTER JOIN (
                ...
                WHERE v.make_id = mk.id
                    ...
                    LIMIT 0, ".$smfgSettings['most_spent_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'mostSpent\', \'mostSpentUpshrink\'); return false;"><img id="mostSpentUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=mostspent">' . $txt['smfg_most_spent'] . '</a></td>
            </tr>
            <tr id="mostSpent">
                <td class="windowbg">
                    <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                    ...
                    if(isset($context['most_spent'][$count]['id'])) {
                        ...
                        <tr>
                            <td class="catbg">' . $txt['smfg_vehicle'] . '</td>
                            <td class="catbg">' . $txt['smfg_owner'] . '</td>
                            <td class="catbg">' . $txt['smfg_total_spent'] . '</td>
                        </tr>';
    ...
    if($smfgSettings['enable_last_commented']) {
        ...
        $request = db_query("
            SELECT gb.id, gb.vehicle_id, gb.post_date, gb.author_id, u2.ID_MEMBER, u2.realName, CONCAT(CONCAT_WS(' ', v.made_year, mk.make, md.model)), u.realName 
            ...
            LIMIT 0, ".$smfgSettings['last_commented_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr class="titlebg">
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'lastComments\', \'lastCommentsUpshrink\'); return false;"><img id="lastCommentsUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div>' . $txt['smfg_latest_comments'] . '</td>
            </tr>
            <tr id="lastComments">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['last_comments'] .= '
                    <tr>
                        ...
                        <td class="catbg">' . $txt['smfg_posted_date'] . '</td>
                    </tr>';
                    ...
                    <tr class="windowbg">
                        ...
                        <td align="center" valign="middle" nowrap="nowrap">'.date($context['date_format'],$context['last_comments'][$count]['post_date']).'</td>
                    </tr>';
                    $count++;
                    }
                } else {
    ...
    if($smfgSettings['enable_top_dynorun']) {
        ...
        $request = db_query("
            SELECT d.id, d.vehicle_id, d.bhp, d.bhp_unit, d.torque, d.torque_unit, d.nitrous, v.user_id, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName
            ...
            WHERE d.vehicle_id = v.id
                ...
                AND v.user_id = u.ID_MEMBER
            ORDER BY bhp DESC
            LIMIT 0, ".$smfgSettings['top_dynorun_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr>
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'topDyno\', \'topDynoUpshrink\'); return false;"><img id="topDynoUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=dynoruns">' . $txt['smfg_top_dynorun'] . '</a></td>
            </tr>
            <tr id="topDyno">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['top_dr'] .= '
                    <tr>
                        <td class="catbg">' . $txt['smfg_vehicle'] . '</td>
                        <td class="catbg">' . $txt['smfg_owner'] . '</td>
                        <td class="catbg" nowrap="nowrap">' . $txt['smfg_dyno_specs'] . '</td>
                    </tr>';
    ...
    if($smfgSettings['enable_top_lap']) {
        ...
        $request = db_query("
            ...
            WHERE l.vehicle_id = v.id
                ...
                ".$spec_track."
                ORDER BY time ASC
                LIMIT 0, ".$smfgSettings['top_lap_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
                <tr>
                    <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'topLaps\', \'topLapsUpshrink\', \'topLaps2\'); return false;"><img id="topLapsUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=laptimes">' . $txt['smfg_top_laptimes'] . '</a></td>
                </tr>
                <tr id="topLaps">
                    <td class="windowbg">
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                <tr>
                    <td class="titlebg" align="right" height="26">
                    <form action="'.$scripturl.'?action=garage;sa=main" name="trackSelect" method="post" style="padding:0; margin:0;">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr id="topLaps2">
                            <td><b>'.$txt['smfg_select_track'].':</b>&nbsp;<select name="track_select" onchange="trackSelect.submit();"><option value="">--------</option>';
    ...
    if($smfgSettings['enable_last_service']) {
        ...
        $request = db_query("
            SELECT sh.id, sh.vehicle_id, sh.date_created, v.user_id, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName
            ...
            LIMIT 0, ".$smfgSettings['latest_service_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr class="titlebg">
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'lastService\', \'lastServiceUpshrink\'); return false;"><img id="lastServiceUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div></div><a href="'.$scripturl.'?action=garage;sa=latestservice">' . $txt['smfg_latest_service'] . '</a></td>
            </tr>
            <tr id="lastService">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['last_service'] .= '
                    ...
                    <tr class="windowbg">
                        ...
                        <td align="center" valign="middle" nowrap="nowrap">'.date($context['date_format'],$context['last_service'][$count]['date_created']).'</td>
                    </tr>';
                    $count++;
                    }
                } else {
    ...
    if($smfgSettings['enable_last_blog']) {
        ...
        $request = db_query("
            SELECT b.id, b.vehicle_id, b.blog_title, v.user_id, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName
            ...
            LIMIT 0, ".$smfgSettings['latest_blog_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr class="titlebg">
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'lastBlog\', \'lastBlogUpshrink\'); return false;"><img id="lastBlogUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=latestblog">' . $txt['smfg_latest_blog'] . '</a></td>
            </tr>
            <tr id="lastBlog">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['last_blog'] .= '
                    <tr>
                        <td class="catbg">' . $txt['smfg_vehicle'] . '</td>
                        <td class="catbg">' . $txt['smfg_owner'] . '</td>
                        <td class="catbg">' . $txt['smfg_blog'] . '</td>
                    </tr>';
                    while(isset($context['last_blog'][$count]['id'])) {

                    //Check the string length of blog title and trim it
                    $context['last_blog'][$count]['blog_title'] = smfg_trim($context['last_blog'][$count]['blog_title']);
    ...
    if($smfgSettings['enable_last_video']) {
        ...
        $request = db_query("
            SELECT b.id, b.vehicle_id, b.title, v.user_id, CONCAT_WS( ' ', v.made_year, mk.make, md.model), u.realName, b2.type, b2.type_id
            ...
            WHERE b.vehicle_id = v.id
                ...
                AND v.user_id = u.ID_MEMBER
            ORDER BY b.id DESC
            LIMIT 0, ".$smfgSettings['latest_video_limit'],__FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="bordercolor">
            <tr class="titlebg">
                <td align="center" class="titlebg"><div style="float:right"><a href="#" onclick="shrinkSection(\'lastVideo\', \'lastVideoUpshrink\'); return false;"><img id="lastVideoUpshrink" src="'. $settings['actual_images_url'] . '/upshrink.gif" alt="*" title="Shrink or expand the table." align="bottom" style="margin: 0 1ex;" /></a></div><a href="'.$scripturl.'?action=garage;sa=latestvideo">' . $txt['smfg_latest_video'] . '</a></td>
            </tr>
            <tr id="lastVideo">
                <td class="windowbg">
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                ...
                $context['blocks']['last_video'] .= '
                    <tr>
                        <td class="catbg">' . $txt['smfg_vehicle'] . '</td>
                        <td class="catbg">' . $txt['smfg_owner'] . '</td>
                        <td class="catbg">' . $txt['smfg_video'] . '</td>
                    </tr>';
    ...
    foreach($blocks as $block) {
        ...
        if($smfgSettings['index_columns'] == 2) {
            ...
            if($context['blocks']['total'] & 1) $context['blocks']['total'] += 1;
            // Get the median
...
function G_User_Garage()
{
    ...
    $context['date_format'] = $smfgSettings['dateformat']; 
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_my_vehicles'];
    $context['linktree'][] = array(
    ...
    $request = db_query(" 
        ...
        WHERE v.user_id = " . $context['user']['id'] . "
            AND v.make_id = mk.id
    ...
    if($context['user_vehicles'][$count]['pending']) $context['pending_modules'] = 1;
    
    // Get the # of total mods
    $request2 = db_query("
        SELECT id
        FROM {$db_prefix}garage_modifications
        WHERE vehicle_id = ".$context['user_vehicles'][$count]['veh_id'],__FILE__,__LINE__);
        $context['user_vehicles'][$count]['total_mods'] = mysql_num_rows($request2);
...
{    
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_create_vehicle'];
    $context['linktree'][] = array(
    ...
    if(!isset($_SESSION['added_make'])) $_SESSION['added_make'] = 0;
    if(!isset($_SESSION['added_model'])) $_SESSION['added_model'] = 0;
...
{    
    ...
    if($smfgSettings['enable_vehicle_approval']) $pending = '1';
        else $pending = '0';
    ...
    $request = db_query("
        ...
        WHERE user_id = ".$context['user']['id'],__FILE__,__LINE__);
    $results = mysql_num_rows($request);
    mysql_free_result($request);
    if($results > 0) $main_vehicle = 0;
        else $main_vehicle = 1;
        
    // Clean up the mess
    if(empty($_POST['engine_type'])) $_POST['engine_type'] = "''";
    ...
    if($smfgSettings['enable_vehicle_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_vehicles (user_id, made_year, engine_type, color, mileage, mileage_unit, price, currency, comments, date_created, date_updated, make_id, model_id, main_vehicle, pending) 
                VALUES (".$context['user']['id'].", ".$_POST['made_year'].", ".$_POST['engine_type'].", '".$_POST['color']."', ".$_POST['mileage'].", '".$_POST['mileage_units']."', ".$_POST['price'].", ".$_POST['currency'].", '".$_POST['comments']."', ".$context['date_created'].", ".$context['date_created'].", ".$_POST['make_id'].", ".$_POST['model_id'].", ".$main_vehicle.", '".$pending."')", __FILE__, __LINE__);
            $context['vehicle_id'] = db_insert_id($request);
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_vehicles_gallery (vehicle_id, image_id, hilite)
                VALUES (".$context['vehicle_id'].", ".$context['image_id'].", 1)",__FILE__,__LINE__);
                 
        } 
        
        // Check if a remote image was supplied...then use it
        else if($_POST['url_image'] > 'http://'){  
    ...
    if($smfgSettings['enable_vehicle_video'] && $_POST['video_url'] > 'http://') {
        ...
        // Insert video
        $request = db_query("
            INSERT INTO {$db_prefix}garage_video (vehicle_id, url, title, video_desc)
            VALUES (".$context['vehicle_id'].", '".$_POST['video_url']."', '".$_POST['video_title']."', '".$_POST['video_desc']."')",__FILE__,__LINE__);
            $context['video_id'] = db_insert_id($request);
        
        // Insert table data for video_gallery
        $request = db_query("
            INSERT INTO {$db_prefix}garage_video_gallery (vehicle_id, video_id, type)
            VALUES (".$context['vehicle_id'].", ".$context['video_id'].", 'vehicle')",__FILE__,__LINE__);
...
function G_View_Garage()
{
    ...
    $request = db_query("
        ...
        WHERE u.ID_MEMBER = ". $_GET['UID'], __FILE__, __LINE__);
        list($context['user_vehicles']['memberName']) = mysql_fetch_row($request);
    mysql_free_result($request);
    
    // Now that we have their name, lets set the page title
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $context['user_vehicles']['memberName'] . '\'s ' . $txt['smfg_garage'];
    ...
    $request2 = db_query("
        ...
        WHERE vehicle_id = ".$context['user_vehicles'][$count]['veh_id']."
        GROUP BY vehicle_id",__FILE__,__LINE__);
    list($context['user_vehicles'][$count]['rating'],
         $context['user_vehicles'][$count]['poss_rating']) = mysql_fetch_row($request2);
    mysql_free_result($request2);
    ...
    $request2 = db_query("
        ...
        WHERE vehicle_id = ".$context['user_vehicles'][$count]['veh_id']."
            AND hilite = 1",__FILE__,__LINE__);
        list($context['user_vehicles'][$count]['image_id']) = mysql_fetch_row($request2);
    mysql_free_result($request2);
    ...
    SELECT attach_location, attach_file, attach_thumb_location, attach_thumb_width, attach_thumb_height, attach_desc, is_remote 
    FROM {$db_prefix}garage_images 
    WHERE attach_id = " . $context['user_vehicles'][$count]['image_id'],__FILE__,__LINE__);
        list($context['user_vehicles'][$count]['attach_location'],
            ...
            $context['user_vehicles'][$count]['is_remote']) = mysql_fetch_row($request2);
    mysql_free_result($request2);
    if(empty($context['user_vehicles'][$count]['attach_desc'])) $context['user_vehicles'][$count]['attach_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';    
                
    // Check to see if the image is remote or not and build appropriate links
    if($context['user_vehicles'][$count]['is_remote'] == 1) $context['user_vehicles'][$count]['attach_location'] = urldecode($context['user_vehicles'][$count]['attach_file']);
        else $context['user_vehicles'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['user_vehicles'][$count]['attach_location'];        
                    
        // If there is an image attached, link to it
        if(isset($context['user_vehicles'][$count]['attach_location'])) $context['user_vehicles'][$count]['image'] = "<a href=\"".$context['user_vehicles'][$count]['attach_location']."\" rel=\"shadowbox\" title=\"".$context['user_vehicles'][$count]['vehicle']." :: Owner: ".$context['user_vehicles']['memberName']."\" class=\"smfg_imageTitle\"><img src=\"".$boardurl."/".$smfgSettings['upload_directory'].'cache/'.$context['user_vehicles'][$count]['attach_thumb_location']."\" width=\"".$context['user_vehicles'][$count]['attach_thumb_width']."\" height=\"".$context['user_vehicles'][$count]['attach_thumb_height']."\" /></a><br />";
            
    //No hilight image? Display "no image" place holder image.        
    }else if(!isset($context['user_vehicles'][$count]['image_id'])){
        list($fv_width, $fv_height) = getimagesize($settings['actual_images_url']."/no_image.png");
        $context['user_vehicles'][$count]['image'] = "<img src=\"".$settings['actual_images_url']."/no_image.png\" width=\"".$fv_width."\" height=\"".$fv_height."\" /><br />";
    }    
    ...
    $request = db_query("
        ...
        WHERE user_id = ".$_GET['UID']."
            AND pending != '1'",__FILE__,__LINE__);        
    $context['comments']['total'] = mysql_result($request, 0);
    mysql_free_result($request);    
    
    // Construct the page index
    $context['comments']['display'] = $smfgSettings['comments_per_page'];
    $context['comments']['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=view_garage' . (isset($_REQUEST['UID']) ? ';UID=' . $_REQUEST['UID'] : ''), $_REQUEST['start'], $context['comments']['total'], $context['comments']['display'], false);
    $context['comments']['start'] = $_REQUEST['start'] + 1;
    $context['comments']['end'] = min($_REQUEST['start'] + $context['comments']['display'], $context['comments']['total']);
            
    // Get comment data      
    $request = db_query("
        SELECT u.realName, u.dateRegistered, u.posts, c.id,  c.author_id, c.post_date, c.ip_address, c.post
        FROM {$db_prefix}garage_comments AS c, {$db_prefix}members AS u
        WHERE c.user_id = ".$_GET['UID']."
            AND c.author_id = u.ID_MEMBER
            AND c.pending != '1'
            ORDER BY c.post_date DESC
            LIMIT ".$_REQUEST['start'].", ".$context['comments']['display'],__FILE__,__LINE__);
    $count = 0;
    while($row = mysql_fetch_row($request)) {
        ...
        $context['comments'][$count]['comment'] = str_replace(array("\n","{SEMICOLON}"), array("<br />", ";"),$context['comments'][$count]['comment']);
        $context['comments'][$count]['posts'] = number_format($context['comments'][$count]['posts']);
        // Is BBCode enabled?
        if($smfgSettings['enable_guestbooks_bbcode']) $context['comments'][$count]['comment'] = parse_bbc($context['comments'][$count]['comment']);               
        // Check if author has a vehicle
        $request2 = db_query("
           SELECT id
           FROM {$db_prefix}garage_vehicles
           WHERE user_id = ".$context['comments'][$count]['author_id']." 
               AND main_vehicle = 1",__FILE__,__LINE__);
        list($context['comments'][$count]['author_VID']) = mysql_fetch_row($request2);
        mysql_free_result($request2);
        ...
        if(isset($context['comments'][$count]['author_VID'])) {              
           ...
           list($context['comments'][$count]['made_year'],
                ...
                $context['comments'][$count]['model']) = mysql_fetch_row($request2);
           mysql_free_result($request2);
...
function G_View_Vehicle()
{
    ...
    $matching_vid = mysql_num_rows($request);
    mysql_free_result($request);
    ...
    $request = db_query(" 
        ...
        list ($context['user_vehicles']['id'],
              ...
              $context['user_vehicles']['engine_type']) = mysql_fetch_row($request);
    ...
    else if (isset($_GET['view_as_user']) && $_GET['view_as_user'] == 0)
        $_SESSION['view_as_user'] = 0;
    else if (!isset($_SESSION['view_as_user']))
    ...
    else if ($_SESSION['view_as_user'] == 1) 
    ...
    if(!empty($context['user_vehicles']['engine_type'])) {
        $request = db_query("
            ...
            WHERE id = ".$context['user_vehicles']['engine_type'],__FILE__,__LINE__);
                list($context['user_vehicles']['engine']) = mysql_fetch_row($request);
                mysql_free_result($request);  
    }  else {
    ...
    $request = db_query("
        ...
        WHERE id = ".$context['user_vehicles']['currency_id'],__FILE__,__LINE__);
            list($context['user_vehicles']['currency']) = mysql_fetch_row($request);
            mysql_free_result($request);

    // Build the Page Title and Link Tree after the vehicle information has been obtained
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $context['user_vehicles']['vehicle'];
    $context['linktree'][] = array(
    ...
    $request = db_query("
        SELECT id
        FROM {$db_prefix}garage_modifications
        WHERE vehicle_id = ".$veh_id,__FILE__,__LINE__);
        $context['user_vehicles']['total_mods'] = mysql_num_rows($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        ORDER BY total_spent DESC
        LIMIT 1",__FILE__,__LINE__); 
    list($context['vid'], $context['user_vehicles']['total_spent']) = mysql_fetch_row($request);
    ...
    while($row = mysql_fetch_row($request)) {
        ...
        if(!empty($context['user_vehicles'][$count]['image_id'])) {
            ...
            if($context['user_vehicles'][$count]['hilite'] == 1) {
               if($context['user_vehicles'][$count]['is_remote'] == 1) $context['hilite_image_location'] = urldecode($context['user_vehicles'][$count]['attach_file']);
                   else $context['hilite_image_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['user_vehicles'][$count]['attach_location'];
    ...
    if(!isset($context['hilite_image_location'])) $context['hilite_image_location'] = "";
    if(!isset($context['hilite_thumb_location'])) $context['hilite_thumb_location'] = "";   
    ...
    if($smfgSettings['enable_vehicle_video']) {
        ...
        $request = db_query("
            ...
            WHERE vehicle_id = " . $veh_id . "
                AND type = 'vehicle'", __FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
                ...
                if(!empty($context['user_vehicles'][$count]['video_id'])) {
                    $request2 = db_query("
                        ...
                        WHERE id = " . $context['user_vehicles'][$count]['video_id'],__FILE__,__LINE__);
                            list($context['user_vehicles'][$count]['video_url'],
                                 $context['user_vehicles'][$count]['video_title'],
                                 $context['user_vehicles'][$count]['video_desc']) = mysql_fetch_row($request2);
                            mysql_free_result($request2); 
                    if(empty($context['user_vehicles'][$count]['video_desc'])) $context['user_vehicles'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                    $context['user_vehicles'][$count]['video_thumb'] = displayVideo($context['user_vehicles'][$count]['video_url'], 2);
                    $context['user_vehicles'][$count]['video_height'] = displayVideo($context['user_vehicles'][$count]['video_url'], 'height');
                    $context['user_vehicles'][$count]['video_width'] = displayVideo($context['user_vehicles'][$count]['video_url'], 'width');
                }
                $count++;
            }
    ...
    $request = db_query("
        ...
        WHERE m.vehicle_id = ".$veh_id." 
            ...
            AND p.pending != '1'
            AND b.pending != '1'
            ORDER BY m.date_created DESC",__FILE__,__LINE__);
    $count = 0;
    ...
    while($row = mysql_fetch_row($request)) {
        ...
        $request2 = db_query("
            ...
            WHERE modification_id = ".$context['mods'][$count]['id']."
                AND hilite = 1",__FILE__,__LINE__);
                list($context['mods'][$count]['image_id']) = mysql_fetch_row($request2);
        ...
        if(!empty($context['mods'][$count]['image_id'])) {              
            $request3 = db_query("
                ...
                FROM {$db_prefix}garage_images
                WHERE attach_id = ".$context['mods'][$count]['image_id'],__FILE__,__LINE__);
                    list($context['mods'][$count]['attach_location'],
                         ...
                         $context['mods'][$count]['is_remote']) = mysql_fetch_row($request3);
            mysql_free_result($request3);
            
            if(empty($context['mods'][$count]['attach_desc'])) $context['mods'][$count]['attach_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                    
            // Check to see if the image is remote or not and build appropriate links
            if($context['mods'][$count]['is_remote'] == 1) $context['mods'][$count]['attach_location'] = urldecode($context['mods'][$count]['attach_file']);
                else $context['mods'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['mods'][$count]['attach_location'];        
                
            // If there is an image attached, link to it
            if(!empty($context['mods'][$count]['attach_desc'])) $context['mods'][$count]['is_desc'] = "&lt;BR /&gt;".$txt['smfg_description'].": ".$context['mods'][$count]['attach_desc']; 
            else $context['mods'][$count]['is_desc'] = "";
            if(isset($context['mods'][$count]['attach_location'])) $context['mods'][$count]['image'] = "<a href=\"".$context['mods'][$count]['attach_location']."\" rel=\"shadowbox[mods]\" title=\"".garage_title_clean($context['mods'][$count]['title'].' :: '.$context['mods'][$count]['attach_desc'])."\" class=\"smfg_imageTitle\"><img src=\"". $settings['default_images_url'] . "/garage_camera.gif\" width=\"16\" height=\"16\" /></a>";     
            }
            mysql_free_result($request2);
            ...
            if($smfgSettings['enable_modification_video']) {
                ...
                $request2 = db_query("
                    ...
                    WHERE vehicle_id = ".$veh_id."
                        AND type = 'mod'
                        AND type_id = ".$context['mods'][$count]['id']."
                        ORDER BY video_id ASC
                        LIMIT 1",__FILE__,__LINE__);
                    list($context['mods'][$count]['video_id']) = mysql_fetch_row($request2);
                ...
                if(!empty($context['mods'][$count]['video_id'])) {              
                    $request3 = db_query("
                        SELECT url, title, video_desc
                        FROM {$db_prefix}garage_video
                        WHERE id = ".$context['mods'][$count]['video_id'],__FILE__,__LINE__);
                            list($context['mods'][$count]['video_url'],
                                 $context['mods'][$count]['video_title'],
                                 $context['mods'][$count]['video_desc']) = mysql_fetch_row($request3);
                    mysql_free_result($request3);
                    if(empty($context['mods'][$count]['video_desc'])) $context['mods'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                    ...
                    if(!empty($context['mods'][$count]['image_id']) && !empty($context['mods'][$count]['video_id'])) $context['mods'][$count]['spacer'] = '&nbsp;';   
                }
                mysql_free_result($request2);
            ...
            if(!empty($context['mods'][$count]['manufacturer'])) $context['mods'][$count]['mod_tooltip'] .= "<b>".$txt['smfg_manufacturer'].":</b> ".$context['mods'][$count]['manufacturer'];
            if(!empty($context['mods'][$count]['category'])) $context['mods'][$count]['mod_tooltip'] .= "<br /><b>".$txt['smfg_category'].":</b> ".$context['mods'][$count]['category'];
    ...
    $request = db_query("
        ...
        WHERE ID_MEMBER = " . $context['user_vehicles']['user_id'], __FILE__,__LINE__);
            list($context['user_vehicles']['memberName']) = mysql_fetch_row($request);
            mysql_free_result($request);
    ...
    $request = db_query("
        ...
        WHERE p.vehicle_id = ".$veh_id."
            AND p.business_id = b.id
            AND p.cover_type_id = pt.id",__FILE__,__LINE__);
        $count = 0;
        while($row = mysql_fetch_row($request)) {
    ...
    $request = db_query("
        ...
        WHERE d.vehicle_id = ".$veh_id."
            AND d.dynocenter_id = b.id 
            AND d.pending != '1'
            AND b.pending != '1'
            ORDER BY d.date_created DESC",__FILE__,__LINE__);
    $count = 0;
    while($row = mysql_fetch_row($request)) {
        ...
        $request2 = db_query("
            ...
            WHERE dynorun_id = ".$context['dynoruns'][$count]['id']." 
                AND hilite = 1",__FILE__,__LINE__);
                list($context['dynoruns'][$count]['image_id']) = mysql_fetch_row($request2);
        ...
        if(!empty($context['dynoruns'][$count]['image_id'])) {              
            $request3 = db_query("
                SELECT attach_location, attach_ext, attach_file, attach_desc, is_remote
                FROM {$db_prefix}garage_images
                WHERE attach_id = ".$context['dynoruns'][$count]['image_id'],__FILE__,__LINE__);
                    list($context['dynoruns'][$count]['attach_location'],
                         ...
                         $context['dynoruns'][$count]['is_remote']) = mysql_fetch_row($request3);
            mysql_free_result($request3);    
            if(empty($context['dynoruns'][$count]['attach_desc'])) $context['dynoruns'][$count]['attach_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';        
            
            // Check to see if the image is remote or not and build appropriate links
            if($context['dynoruns'][$count]['is_remote'] == 1) $context['dynoruns'][$count]['attach_location'] = urldecode($context['dynoruns'][$count]['attach_file']);
                else $context['dynoruns'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['dynoruns'][$count]['attach_location'];
                    
            // If there is an image attached, link to it
            if(isset($context['dynoruns'][$count]['attach_location'])) $context['dynoruns'][$count]['image'] = "<a href=\"".$context['dynoruns'][$count]['attach_location']."\" rel=\"shadowbox[dynoruns]\" title=\"".garage_title_clean($context['dynoruns'][$count]['bhp'].' '.$context['dynoruns'][$count]['bhp_unit'].' :: '.$context['dynoruns'][$count]['attach_desc'])."\" class=\"smfg_imageTitle\"><img src=\"". $settings['default_images_url'] . "/garage_camera.gif\" width=\"16\" height=\"16\" /></a>";     
        }
        mysql_free_result($request2);
        ...
        if($smfgSettings['enable_dynorun_video']) {
            ...
            $request2 = db_query("
                ...
                WHERE vehicle_id = ".$veh_id."
                    AND type = 'dynorun'
                    AND type_id = ".$context['dynoruns'][$count]['id']."
                    ORDER BY video_id ASC
                    LIMIT 1",__FILE__,__LINE__);
                list($context['dynoruns'][$count]['video_id']) = mysql_fetch_row($request2);
            // Get video data if there is any
            ...
            if(!empty($context['dynoruns'][$count]['video_id'])) {              
                $request3 = db_query("
                    SELECT url, title, video_desc
                    FROM {$db_prefix}garage_video
                    WHERE id = ".$context['dynoruns'][$count]['video_id'],__FILE__,__LINE__);
                        list($context['dynoruns'][$count]['video_url'],
                             $context['dynoruns'][$count]['video_title'],
                             $context['dynoruns'][$count]['video_desc']) = mysql_fetch_row($request3);
                mysql_free_result($request3);
                if(empty($context['dynoruns'][$count]['video_desc'])) $context['dynoruns'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                $context['dynoruns'][$count]['video_height'] = displayVideo($context['dynoruns'][$count]['video_url'], 'height');
                $context['dynoruns'][$count]['video_width'] = displayVideo($context['dynoruns'][$count]['video_url'], 'width');
                ...
                if(!empty($context['dynoruns'][$count]['image_id']) && !empty($context['dynoruns'][$count]['video_id'])) $context['dynoruns'][$count]['spacer'] = '&nbsp;';   
            }
            mysql_free_result($request2);
    ...
    $request = db_query("
        ...
        WHERE q.vehicle_id = ".$_GET['VID']." 
            AND q.pending != '1'
            ORDER BY q.date_created DESC",__FILE__,__LINE__);
    $count = 0;
    while($row = mysql_fetch_row($request)) {
        ...
        $request2 = db_query("
            ...
            WHERE quartermile_id = ".$context['qmiles'][$count]['id']." 
                AND hilite = 1",__FILE__,__LINE__);
        list($context['qmiles'][$count]['image_id']) = mysql_fetch_row($request2);
        ...
        if(!empty($context['qmiles'][$count]['image_id'])) {              
            $request3 = db_query("
                SELECT attach_location, attach_ext, attach_file, attach_desc, is_remote
                FROM {$db_prefix}garage_images
                WHERE attach_id = ".$context['qmiles'][$count]['image_id'],__FILE__,__LINE__);
            list($context['qmiles'][$count]['attach_location'],
                         ...
                         $context['qmiles'][$count]['is_remote']) = mysql_fetch_row($request3);
            mysql_free_result($request3); 
            if(empty($context['qmiles'][$count]['attach_desc'])) $context['qmiles'][$count]['attach_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';       
            
            // Check to see if the image is remote or not and build appropriate links
            if($context['qmiles'][$count]['is_remote'] == 1) $context['qmiles'][$count]['attach_location'] = urldecode($context['qmiles'][$count]['attach_file']);
                else $context['qmiles'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['qmiles'][$count]['attach_location'];
                
            // If there is an image attached, link to it
            if(isset($context['qmiles'][$count]['attach_location'])) $context['qmiles'][$count]['image'] = "<a href=\"".$context['qmiles'][$count]['attach_location']."\" rel=\"shadowbox[qmiles]\" title=\"".garage_title_clean($context['qmiles'][$count]['quart'].' @ '.$context['qmiles'][$count]['quartmph'].' :: '.$context['qmiles'][$count]['attach_desc'])."\" class=\"smfg_imageTitle\"><img src=\"". $settings['default_images_url'] . "/garage_camera.gif\" width=\"16\" height=\"16\" /></a>";     
        }
        mysql_free_result($request2);
        ...
        if($smfgSettings['enable_quartermile_video']) {
            ...
            $request2 = db_query("
                ...
                WHERE vehicle_id = ".$veh_id."
                    AND type = 'qmile'
                    AND type_id = ".$context['qmiles'][$count]['id']."
                    ORDER BY video_id ASC
                    LIMIT 1",__FILE__,__LINE__);
                list($context['qmiles'][$count]['video_id']) = mysql_fetch_row($request2);
            // Get video data if there is any
            ...
            if(!empty($context['qmiles'][$count]['video_id'])) {              
                $request3 = db_query("
                    SELECT url, title, video_desc
                    FROM {$db_prefix}garage_video
                    WHERE id = ".$context['qmiles'][$count]['video_id'],__FILE__,__LINE__);
                        list($context['qmiles'][$count]['video_url'],
                             $context['qmiles'][$count]['video_title'],
                             $context['qmiles'][$count]['video_desc']) = mysql_fetch_row($request3);
                mysql_free_result($request3);
                if(empty($context['qmiles'][$count]['video_desc'])) $context['qmiles'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                $context['qmiles'][$count]['video_height'] = displayVideo($context['qmiles'][$count]['video_url'], 'height');
                ...
                if(!empty($context['qmiles'][$count]['image_id']) && !empty($context['qmiles'][$count]['video_id'])) $context['qmiles'][$count]['spacer'] = '&nbsp;';   
            }
            mysql_free_result($request2);
    ...
    $request = db_query("
        ...
        WHERE l.vehicle_id = ".$_GET['VID']." 
            AND l.track_id = t.id 
            AND l.condition_id = tc.id 
            AND l.type_id = lt.id
            AND l.pending != '1'
            AND t.pending != '1'",__FILE__,__LINE__);
    $count = 0;
    while($row = mysql_fetch_row($request)) {
        ...
        $request2 = db_query("
            ...
            WHERE lap_id = ".$context['laps'][$count]['id']." 
                AND hilite = 1",__FILE__,__LINE__);
        list($context['laps'][$count]['image_id']) = mysql_fetch_row($request2);
        ...
        if(!empty($context['laps'][$count]['image_id'])) {              
            $request3 = db_query("
                SELECT attach_location, attach_ext, attach_file, attach_desc, is_remote
                FROM {$db_prefix}garage_images
                WHERE attach_id = ".$context['laps'][$count]['image_id'],__FILE__,__LINE__);
            list($context['laps'][$count]['attach_location'],
                         ...
                         $context['laps'][$count]['is_remote']) = mysql_fetch_row($request3);
            mysql_free_result($request3);        
            if(empty($context['laps'][$count]['attach_desc'])) $context['laps'][$count]['attach_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';        
            
            // Check to see if the image is remote or not and build appropriate links
            if($context['laps'][$count]['is_remote'] == 1) $context['laps'][$count]['attach_location'] = urldecode($context['laps'][$count]['attach_file']);
                else $context['laps'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['laps'][$count]['attach_location'];
                
            // If there is an image attached, link to it
            if(isset($context['laps'][$count]['attach_location'])) $context['laps'][$count]['image'] = "<a href=\"".$context['laps'][$count]['attach_location']."\" rel=\"shadowbox[laps]\" title=\"".garage_title_clean($context['laps'][$count]['time'].' @ '.$context['laps'][$count]['track'].' :: '.$context['laps'][$count]['attach_desc'])."\" class=\"smfg_imageTitle\"><img src=\"". $settings['default_images_url'] . "/garage_camera.gif\" width=\"16\" height=\"16\" /></a>";     
        }
        mysql_free_result($request2);
        ...
        if($smfgSettings['enable_laptime_video']) {
            ...
            $request2 = db_query("
                ...
                WHERE vehicle_id = ".$veh_id."
                    AND type = 'lap'
                    AND type_id = ".$context['laps'][$count]['id']."
                    ORDER BY video_id ASC
                    LIMIT 1",__FILE__,__LINE__);
                list($context['laps'][$count]['video_id']) = mysql_fetch_row($request2);
            // Get video data if there is any
            ...
            if(!empty($context['laps'][$count]['video_id'])) {              
                $request3 = db_query("
                    SELECT url, title, video_desc
                    FROM {$db_prefix}garage_video
                    WHERE id = ".$context['laps'][$count]['video_id'],__FILE__,__LINE__);
                        list($context['laps'][$count]['video_url'],
                             $context['laps'][$count]['video_title'],
                             $context['laps'][$count]['video_desc']) = mysql_fetch_row($request3);
                mysql_free_result($request3);
                if(empty($context['laps'][$count]['video_desc'])) $context['laps'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                ...
                if(!empty($context['laps'][$count]['image_id']) && !empty($context['laps'][$count]['video_id'])) $context['laps'][$count]['spacer'] = '&nbsp;';   
            }
            mysql_free_result($request2);
    ...
    $request = db_query("
        ...
        WHERE s.vehicle_id = ".$veh_id."
            AND s.garage_id = b.id
            AND s.type_id = t.id
            AND b.pending != '1'",__FILE__,__LINE__);
    $count = 0;
    ...
    $context['blog']['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=view_vehicle' . (isset($_REQUEST['VID']) ? ';VID=' . $_REQUEST['VID'] : ''), $_REQUEST['blog_start'], $context['blog']['total'], $context['blog']['display'], false, "blog");
    ...
    $request = db_query("
        ...
        FROM {$db_prefix}garage_blog
        WHERE vehicle_id = ".$_GET['VID']." 
        ORDER BY post_date DESC
        LIMIT ".$_REQUEST['blog_start'].", ".$context['blog']['display'],__FILE__,__LINE__);
    $count = 0;
    while($row = mysql_fetch_row($request)) {
        ...
        $context['blog'][$count]['text'] = str_replace(array("\n","{SEMICOLON}"), array("<br />", ";"),$context['blog'][$count]['text']);
        $context['blog'][$count]['title'] = str_replace("{SEMICOLON}", ";", $context['blog'][$count]['title']);
        // Is BBCode enabled?
        if($smfgSettings['enable_blogs_bbcode']) $context['blog'][$count]['text'] = parse_bbc($context['blog'][$count]['text']);
        $count++;
    }
    mysql_free_result($request);
    ...
    $context['gb']['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=view_vehicle' . (isset($_REQUEST['VID']) ? ';VID=' . $_REQUEST['VID'] : ''), $_REQUEST['gb_start'], $context['gb']['total'], $context['gb']['display'], false, "guestbook");
    $context['gb']['start'] = $_REQUEST['gb_start'] + 1;
    $context['gb']['end'] = min($_REQUEST['gb_start'] + $context['gb']['display'], $context['gb']['total']);
            
    // Get comment data      
    $request = db_query("
        SELECT u.realName, u.dateRegistered, u.posts, gb.id,  gb.author_id, gb.post_date, gb.ip_address, gb.post
        FROM {$db_prefix}garage_guestbooks AS gb, {$db_prefix}members AS u
        WHERE gb.vehicle_id = ".$_GET['VID']."
            AND gb.author_id = u.ID_MEMBER
            AND gb.pending != '1'
            ORDER BY gb.post_date DESC
            LIMIT ".$_REQUEST['gb_start'].", ".$context['gb']['display'],__FILE__,__LINE__);
    $count = 0;
    while($row = mysql_fetch_row($request)) {
        ...
        $context['gb'][$count]['comment'] = str_replace(array("\n","{SEMICOLON}"), array("<br />", ";"),$context['gb'][$count]['comment']);
        $context['gb'][$count]['posts'] = number_format($context['gb'][$count]['posts']);
        // Is BBCode enabled?
        if($smfgSettings['enable_guestbooks_bbcode']) $context['gb'][$count]['comment'] = parse_bbc($context['gb'][$count]['comment']);               
        // Check if author has a vehicle
        $request2 = db_query("
           SELECT id
           FROM {$db_prefix}garage_vehicles
           WHERE user_id = ".$context['gb'][$count]['author_id']." 
               AND main_vehicle = 1",__FILE__,__LINE__);
        list($context['gb'][$count]['author_VID']) = mysql_fetch_row($request2);
        mysql_free_result($request2);
        // If there is a vehicle, get its title
        if(isset($context['gb'][$count]['author_VID'])) {              
           ...
           list($context['gb'][$count]['made_year'],
                ...
                $context['gb'][$count]['model']) = mysql_fetch_row($request2);
           mysql_free_result($request2);
    ...
    list($context['user_vehicles']['rating'],
         $context['user_vehicles']['poss_rating']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        FROM {$db_prefix}garage_ratings
        WHERE vehicle_id = ".$veh_id."
            AND user_id = ".$context['user']['id'],__FILE__,__LINE__);
    list($context['user_vehicles']['rid'],
         $context['user_vehicles']['veh_rating'],
         $context['user_vehicles']['rate_date']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        WHERE vid = ".$context['user_vehicles']['id']."
            AND ip = '".$client_ip."'",__FILE__,__LINE__);
    ...
    if($num_rows == 0) {
        ...
        $request = db_query("
            ...
            SET views = ".$updated_views."
            WHERE id = ".$veh_id,__FILE__,__LINE__);
        $request = db_query("
            INSERT INTO {$db_prefix}garage_views (vid, ip)
            VALUES (".$context['user_vehicles']['id'].",'".$client_ip."')",__FILE__,__LINE__);
    }
...
function G_Edit_Vehicle()
{
    ...
    $request = db_query(" 
        ...
        list ($context['user_vehicles']['id'],
              ...
              $context['user_vehicles']['main_vehicle']) = mysql_fetch_row($request); 
        mysql_free_result($request);
    ...
    $request = db_query(" 
        ...
        WHERE id = " . $context['user_vehicles']['make_id'], __FILE__, __LINE__); 
            list ($context['user_vehicles']['make']) = mysql_fetch_row($request);
            mysql_free_result($request); 
    ...
    $request = db_query(" 
        ...
        WHERE id = " . $context['user_vehicles']['model_id'], __FILE__, __LINE__); 
            list($context['user_vehicles']['model']) = mysql_fetch_row($request); 
            mysql_free_result($request);

    // Build the Page Title and Link Tree after the vehicle information has been obtained
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $context['user_vehicles']['made_year'] . ' ' . $context['user_vehicles']['make'] . ' ' . $context['user_vehicles']['model'] . ' &gt; ' . $txt['smfg_edit_vehicle'];
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=view_vehicle;VID='.$context['user_vehicles']['id'],
    ...
    if($context['user_vehicles']['mileage_unit'] == "Miles") $context['miles'] = " selected=\"selected\""; 
    else if($context['user_vehicles']['mileage_unit'] == "Kilometers") $context['kilometers'] = " selected=\"selected\""; 
...
function G_Update_Vehicle()
{
    ...
    $request = db_query("
    UPDATE {$db_prefix}garage_vehicles 
    SET made_year = ".$_POST['made_year'].", engine_type = ".$_POST['engine_type'].", color = '".$_POST['color']."', mileage = ".$_POST['mileage'].", mileage_unit = '".$_POST['mileage_unit']."', price = ".$_POST['price'].", currency = ".$_POST['currency'].", comments = '".$_POST['comments']."', date_updated = ".$date_updated.", make_id = ".$_POST['make_id'].", model_id = ".$_POST['model_id']."
    WHERE id = ".$_POST['VID'], __FILE__, __LINE__);
...
{
    global $txt, $scripturl, $db_prefix, $user_info, $settings, $boarddir;
    global $modSettings, $smfgSettings, $context, $func, $ext;
    ...
    $request = db_query("
        SELECT image_id
        FROM {$db_prefix}garage_vehicles_gallery
        WHERE vehicle_id = ".$_GET['VID'],__FILE__,__LINE__);
    while($row = mysql_fetch_row($request)) {
        $images['id'] = $row[0];
        // Get image filenames
        $request2 = db_query("
...
function G_Add_Modification()
{
    ...
    // Session variable set?
    if(!isset($_SESSION['added_man'])) $_SESSION['added_man'] = 0;
    if(!isset($_SESSION['added_product'])) $_SESSION['added_product'] = 0;
    if(!isset($_SESSION['added_shop'])) $_SESSION['added_shop'] = 0;
    if(!isset($_SESSION['added_garage'])) $_SESSION['added_garage'] = 0;
    ...
    $request = db_query("
        ...
        list($context['user_vehicles']['user_id'],
             $context['user_vehicles']['vehicle']) = mysql_fetch_row($request);
    mysql_free_result($request);

    // Build link tree
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_add_modification'];
    $context['linktree'][] = array(
...
function G_Insert_Modification()
{
    ...
    if(!$smfgSettings['enable_modification']) {
     ...
     // Check if approval is required
     if($smfgSettings['enable_modification_approval']) $pending = '1';
        else $pending = '0';
    ...
    $request = db_query("
        SELECT user_id
        FROM {$db_prefix}garage_vehicles
        WHERE id = ".$context['vehicle_id'],__FILE__,__LINE__);
    list($context['owner_id']) = mysql_fetch_array($request);
    mysql_free_result($request);
    
    // Did they enter prices or leave em blank?
    if(empty($_POST['price'])) $_POST['price'] = 0;
    if(empty($_POST['install_price'])) $_POST['install_price'] = 0;
    
    if(empty($_POST['shop_id'])) $_POST['shop_id'] = "''";
    if(empty($_POST['installer_id'])) $_POST['installer_id'] = "''";
    ...
    if($smfgSettings['enable_modification_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_modifications (vehicle_id, user_id, category_id, manufacturer_id, product_id, price, install_price, product_rating, purchase_rating, install_rating, shop_id, installer_id, comments, install_comments, date_created, date_updated, pending)
                VALUES (".$context['vehicle_id'].", ".$context['owner_id'].", ".$_POST['category_id'].", ".$_POST['manufacturer_id'].", ".$_POST['product_id'].", ".$_POST['price'].", ".$_POST['install_price'].", ".$_POST['product_rating'].", ".$_POST['purchase_rating'].", ".$_POST['install_rating'].", ".$_POST['shop_id'].", ".$_POST['installer_id'].", '".$_POST['comments']."', '".$_POST['install_comments']."', ".$context['date_created'].", ".$context['date_created'].", '".$pending."')",__FILE__,__LINE__);
            $context['mod_id'] = db_insert_id($request);      
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_modifications_gallery (vehicle_id, modification_id, image_id, hilite)
                VALUES (".$context['vehicle_id'].", ".$context['mod_id'].", ".$context['image_id'].", 1)",__FILE__,__LINE__);         
    ...
    if($smfgSettings['enable_modification_video'] && $_POST['video_url'] > 'http://') {
        ...
        // Insert table data for video_gallery
        $request = db_query("
            INSERT INTO {$db_prefix}garage_video_gallery (vehicle_id, video_id, type, type_id)
            VALUES (".$context['vehicle_id'].", ".$context['video_id'].", 'mod', ".$context['mod_id'].")",__FILE__,__LINE__);
...
function G_Edit_Modification()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $context['user_vehicles']['vehicle'] . ' &gt; ' . $txt['smfg_edit_modification']; 
    $context['linktree'][] = array(
    ...
    $request = db_query("
        ...
        list($context['mods']['vehicle_id'],
             ...
             $context['mods']['install_comments']) = mysql_fetch_row($request);
    mysql_free_result($request);
    
    if($context['mods']['product_rating'] == 10) $context['prod_rat_10'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 9) $context['prod_rat_9'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 8) $context['prod_rat_8'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 7) $context['prod_rat_7'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 6) $context['prod_rat_6'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 5) $context['prod_rat_5'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 4) $context['prod_rat_4'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 3) $context['prod_rat_3'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 2) $context['prod_rat_2'] = "selected=\"selected\"";
    else if ($context['mods']['product_rating'] == 1) $context['prod_rat_1'] = "selected=\"selected\"";
    
    if(!isset($context['prod_rat_10'])) $context['prod_rat_10'] = "";
    if(!isset($context['prod_rat_9'])) $context['prod_rat_9'] = "";
    if(!isset($context['prod_rat_8'])) $context['prod_rat_8'] = "";
    if(!isset($context['prod_rat_7'])) $context['prod_rat_7'] = "";
    if(!isset($context['prod_rat_6'])) $context['prod_rat_6'] = "";
    if(!isset($context['prod_rat_5'])) $context['prod_rat_5'] = "";
    if(!isset($context['prod_rat_4'])) $context['prod_rat_4'] = "";
    if(!isset($context['prod_rat_3'])) $context['prod_rat_3'] = "";
    if(!isset($context['prod_rat_2'])) $context['prod_rat_2'] = "";
    if(!isset($context['prod_rat_1'])) $context['prod_rat_1'] = "";
    
    if($context['mods']['purchase_rating'] == 10) $context['purch_rat_10'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 9) $context['purch_rat_9'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 8) $context['purch_rat_8'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 7) $context['purch_rat_7'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 6) $context['purch_rat_6'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 5) $context['purch_rat_5'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 4) $context['purch_rat_4'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 3) $context['purch_rat_3'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 2) $context['purch_rat_2'] = "selected=\"selected\"";
    else if ($context['mods']['purchase_rating'] == 1) $context['purch_rat_1'] = "selected=\"selected\"";    
    
    if(!isset($context['purch_rat_10'])) $context['purch_rat_10'] = "";
    if(!isset($context['purch_rat_9'])) $context['purch_rat_9'] = "";
    if(!isset($context['purch_rat_8'])) $context['purch_rat_8'] = "";
    if(!isset($context['purch_rat_7'])) $context['purch_rat_7'] = "";
    if(!isset($context['purch_rat_6'])) $context['purch_rat_6'] = "";
    if(!isset($context['purch_rat_5'])) $context['purch_rat_5'] = "";
    if(!isset($context['purch_rat_4'])) $context['purch_rat_4'] = "";
    if(!isset($context['purch_rat_3'])) $context['purch_rat_3'] = "";
    if(!isset($context['purch_rat_2'])) $context['purch_rat_2'] = "";
    if(!isset($context['purch_rat_1'])) $context['purch_rat_1'] = "";
    
    if($context['mods']['install_rating'] == 10) $context['ins_rat_10'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 9) $context['ins_rat_9'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 8) $context['ins_rat_8'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 7) $context['ins_rat_7'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 6) $context['ins_rat_6'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 5) $context['ins_rat_5'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 4) $context['ins_rat_4'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 3) $context['ins_rat_3'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 2) $context['ins_rat_2'] = "selected=\"selected\"";
    else if ($context['mods']['install_rating'] == 1) $context['ins_rat_1'] = "selected=\"selected\"";    
    
    if(!isset($context['ins_rat_10'])) $context['ins_rat_10'] = "";
    if(!isset($context['ins_rat_9'])) $context['ins_rat_9'] = "";
    if(!isset($context['ins_rat_8'])) $context['ins_rat_8'] = "";
    if(!isset($context['ins_rat_7'])) $context['ins_rat_7'] = "";
    if(!isset($context['ins_rat_6'])) $context['ins_rat_6'] = "";
    if(!isset($context['ins_rat_5'])) $context['ins_rat_5'] = "";
    if(!isset($context['ins_rat_4'])) $context['ins_rat_4'] = "";
    if(!isset($context['ins_rat_3'])) $context['ins_rat_3'] = "";
    if(!isset($context['ins_rat_2'])) $context['ins_rat_2'] = "";
    if(!isset($context['ins_rat_1'])) $context['ins_rat_1'] = "";
        
    // Select image data
    $request = db_query("
        SELECT image_id, hilite
        FROM {$db_prefix}garage_modifications_gallery
        WHERE modification_id = ".$_GET['MID'],__FILE__,__LINE__);
        $count = 0;
        while($row = mysql_fetch_row($request)) {
            ...
            $request2 = db_query("
                ...
                list($context['mods'][$count]['attach_location'],
                     ...
                     $context['mods'][$count]['attach_desc'],
                     $context['mods'][$count]['is_remote']) = mysql_fetch_row($request2);
            mysql_free_result($request2);
            ...
            $request2 = db_query("
                ...
                WHERE {$db_prefix}garage_modifications.product_id = {$db_prefix}garage_products.id
                    AND {$db_prefix}garage_modifications.id = ".$_GET['MID'],__FILE__,__LINE__);
                list($context['mods'][$count]['title']) = mysql_fetch_row($request2);
            mysql_free_result($request2);
    ...
    $request = db_query("
        ...
        WHERE vehicle_id = " . $_GET['VID'] . "
            AND type = 'mod'
            AND type_id = ".$_GET['MID'], __FILE__,__LINE__);
        $count = 0;
        while($row = mysql_fetch_row($request)) {
            ...
            if(!empty($context['mods'][$count]['video_id'])) {
                $request2 = db_query("
                    ...
                    WHERE id = " . $context['mods'][$count]['video_id'],__FILE__,__LINE__);
                        list($context['mods'][$count]['video_url'],
                             $context['mods'][$count]['video_title'],
                             $context['mods'][$count]['video_desc']) = mysql_fetch_row($request2);
                        mysql_free_result($request2); 
                if(empty($context['mods'][$count]['video_desc'])) $context['mods'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
...
function G_Update_Modification()
{
    ...
    $request = db_query("
        ...
        SET category_id = ".$_POST['category_id'].", manufacturer_id = ".$_POST['manufacturer_id'].", product_id = ".$_POST['product_id'].", price= ".$_POST['price'].", install_price = ".$_POST['install_price'].", product_rating = ".$_POST['product_rating'].", purchase_rating = ".$_POST['purchase_rating'].", install_rating = ".$_POST['install_rating'].", shop_id = ".$_POST['shop_id'].", installer_id = ".$_POST['installer_id'].", comments = '".$_POST['comments']."', install_comments = '".$_POST['install_comments']."', date_updated = ".$date_updated."
        WHERE id = ".$_POST['MID'], __FILE__, __LINE__);
...
function G_Add_Insurance()
{
    ...
    // Session variable set?
    if(!isset($_SESSION['added_insurance'])) $_SESSION['added_insurance'] = 0;
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_add_insurance'];
    $context['linktree'][] = array(
...
function G_Insert_Insurance()
{
    ...
    // Insert the premium
    $request = db_query("
        INSERT INTO {$db_prefix}garage_premiums (vehicle_id, business_id, premium, cover_type_id, comments)
        VALUES (".$_POST['VID'].", ".$_POST['business_id'].", ".$_POST['premium'].", ".$_POST['cover_type'].", '".$_POST['comments']."')",__FILE__,__LINE__);
...
function G_Edit_Insurance()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_edit_insurance'];
...
function G_Update_Insurance()
{
    ...
    $request = db_query("
        ...
        SET business_id = ".$_POST['business_id'].", premium = ".$_POST['premium'].", cover_type_id = ".$_POST['cover_type'].", comments = '".$_POST['comments']."'
        WHERE id = ".$_POST['INS_ID'],__FILE__,__LINE__);
...
function G_Delete_Insurance()
{
    ...
    $request = db_query("
        DELETE FROM {$db_prefix}garage_premiums
        WHERE id = ".$_GET['INS_ID'], __FILE__, __LINE__);
...
function G_Add_Quartermile()
{
    ...
    // Build link tree
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_add_quartermile'];
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=view_vehicle;VID='.$_GET['VID'],
        'name' => $context['user_vehicles']['vehicle']
    ); 
...
function G_Insert_Quartermile()
{
    ...
    if(!$smfgSettings['enable_quartermile']) {
     ...
     // Check if approval is required
     if($smfgSettings['enable_quartermile_approval']) $pending = '1';
        else $pending = '0';
     
     if(empty($_POST['dynorun_id'])) $_POST['dynorun_id'] = "''";
    ...
    if($smfgSettings['enable_quartermile_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_quartermiles (vehicle_id, rt, sixty, three, eighth, eighthmph, thou, quart, quartmph, dynorun_id, date_created, date_updated, pending)
                VALUES (".$context['vehicle_id'].", '".$_POST['rt']."', '".$_POST['sixty']."', '".$_POST['three']."', '".$_POST['eighth']."', '".$_POST['eighthmph']."', '".$_POST['thou']."', '".$_POST['quart']."', '".$_POST['quartmph']."', ".$_POST['dynorun_id'].", ".$context['date_created'].", ".$context['date_created'].", '".$pending."')",__FILE__,__LINE__);
            $context['qmile_id'] = db_insert_id($request);  
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_quartermiles_gallery (vehicle_id, quartermile_id, image_id, hilite)
                VALUES (".$context['vehicle_id'].", ".$context['qmile_id'].", ".$context['image_id'].", 1)",__FILE__,__LINE__);        
    ...
    if($smfgSettings['enable_quartermile_video'] && $_POST['video_url'] > 'http://') {
        ...
        $request = db_query("
            INSERT INTO {$db_prefix}garage_video_gallery (vehicle_id, video_id, type, type_id)
            VALUES (".$context['vehicle_id'].", ".$context['video_id'].", 'qmile', ".$context['qmile_id'].")",__FILE__,__LINE__);
...
function G_Edit_Quartermile()
{
    ...
    $context['max_image_bytes'] = $smfgSettings['max_image_kbytes'] * 1024;
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_edit_quartermile'];
    ...
    $request = db_query("
        ...
        list($context['qmiles']['rt'],
             ...
             $context['qmiles']['dynorun_id']) = mysql_fetch_row($request);
    mysql_free_result($request);  
    ...
    $request = db_query("
        SELECT image_id, hilite
        FROM {$db_prefix}garage_quartermiles_gallery
        WHERE quartermile_id = ".$_GET['QID'],__FILE__,__LINE__);
        $count = 0;
        //$tempArray = array();
        while($row = mysql_fetch_row($request)) {
            ...
            $request2 = db_query("
                ...
                list($context['qmiles'][$count]['attach_location'],
                     ...
                     $context['qmiles'][$count]['attach_desc'],
                     $context['qmiles'][$count]['is_remote']) = mysql_fetch_row($request2);
                /*list($tempArray['attach_location'],
                     ...
                     $tempArray['is_remote']) = mysql_fetch_row($request2);*/
            mysql_free_result($request2);
        ...
        $request = db_query("
            ...
            WHERE vehicle_id = " . $_GET['VID'] . "
                AND type = 'qmile'
                AND type_id = ".$_GET['QID'], __FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
                ...
                if(!empty($context['qmiles'][$count]['video_id'])) {
                    $request2 = db_query("
                        ...
                        WHERE id = " . $context['qmiles'][$count]['video_id'],__FILE__,__LINE__);
                            list($context['qmiles'][$count]['video_url'],
                                 $context['qmiles'][$count]['video_title'],
                                 $context['qmiles'][$count]['video_desc']) = mysql_fetch_row($request2);
                            mysql_free_result($request2); 
                    if(empty($context['qmiles'][$count]['video_desc'])) $context['qmiles'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
...
function G_Update_Quartermile()
{
    ...
    $request = db_query("
        ...
        SET rt = '".$_POST['rt']."', sixty = '".$_POST['sixty']."', three = '".$_POST['three']."', eighth = '".$_POST['eighth']."', eighthmph = '".$_POST['eighthmph']."', thou = '".$_POST['thou']."', quart = '".$_POST['quart']."', quartmph = '".$_POST['quartmph']."', dynorun_id = ".$_POST['dynorun_id'].", date_updated = ".$date_updated."
        WHERE id = ".$_POST['QID'],__FILE__,__LINE__);
...
function G_Add_Dynorun()
{
    ...
    // Session variable set?
    if(!isset($_SESSION['added_dynocenter'])) $_SESSION['added_dynocenter'] = 0;
    ...
    // Build link tree
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_add_dynorun'];
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=view_vehicle;VID='.$_GET['VID'],
        'name' => $context['user_vehicles']['vehicle']
    );
...
function G_Insert_Dynorun()
{
    ...
    // Check if approval is required
    if($smfgSettings['enable_dynorun_approval']) $pending = '1';
        else $pending = '0';
    ...
    if($smfgSettings['enable_dynorun_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_dynoruns (vehicle_id, dynocenter_id, bhp, bhp_unit, torque, torque_unit, boost, boost_unit, nitrous, peakpoint, date_created, date_updated, pending)
                VALUES (".$context['vehicle_id'].", ".$_POST['dynocenter_id'].", '".$_POST['bhp']."', '".$_POST['bhp_unit']."', '".$_POST['torque']."', '".$_POST['torque_unit']."', '".$_POST['boost']."', '".$_POST['boost_unit']."', '".$_POST['nitrous']."', '".$_POST['peakpoint']."', ".$context['date_created'].", ".$context['date_created'].", '".$pending."')",__FILE__,__LINE__);
            $context['dynorun_id'] = db_insert_id($request);  
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_dynoruns_gallery (vehicle_id, dynorun_id, image_id, hilite)
                VALUES (".$context['vehicle_id'].", ".$context['dynorun_id'].", ".$context['image_id'].", 1)",__FILE__,__LINE__);         
    ...
    if($smfgSettings['enable_dynorun_video'] && $_POST['video_url'] > 'http://') {
        ...
        $request = db_query("
            INSERT INTO {$db_prefix}garage_video_gallery (vehicle_id, video_id, type, type_id)
            VALUES (".$context['vehicle_id'].", ".$context['video_id'].", 'dynorun', ".$context['dynorun_id'].")",__FILE__,__LINE__);
...
function G_Edit_Dynorun()
{
    ...
    $context['max_image_bytes'] = $smfgSettings['max_image_kbytes'] * 1024;
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_edit_dynorun'];
    ...
    $request = db_query("
        ...
        list($context['dynoruns']['dynocenter_id'],
             ...
             $context['dynoruns']['peakpoint']) = mysql_fetch_row($request);
    mysql_free_result($request);    
    
    if($context['dynoruns']['bhp_unit'] == "wheel") $context['bhp_wheel'] = "selected=\"selected\"";
    else if($context['dynoruns']['bhp_unit'] == "hub") $context['bhp_hub'] = "selected=\"selected\"";
    else if($context['dynoruns']['bhp_unit'] == "flywheel") $context['bhp_fly'] = "selected=\"selected\"";
    
    if(!isset($context['bhp_wheel'])) $context['bhp_wheel'] = "";
    if(!isset($context['bhp_hub'])) $context['bhp_hub'] = "";
    if(!isset($context['bhp_fly'])) $context['bhp_fly'] = "";
    
    if($context['dynoruns']['torque_unit'] == "wheel") $context['torque_wheel'] = "selected=\"selected\"";
    else if($context['dynoruns']['torque_unit'] == "hub") $context['torque_hub'] = "selected=\"selected\"";
    else if($context['dynoruns']['torque_unit'] == "flywheel") $context['torque_fly'] = "selected=\"selected\"";
    
    if(!isset($context['torque_wheel'])) $context['torque_wheel'] = "";
    if(!isset($context['torque_hub'])) $context['torque_hub'] = "";
    if(!isset($context['torque_fly'])) $context['torque_fly'] = "";
    
    if($context['dynoruns']['boost_unit'] == "PSI") $context['psi'] = "selected=\"selected\"";
    else if($context['dynoruns']['boost_unit'] == "BAR") $context['bar'] = "selected=\"selected\"";
    
    if(!isset($context['psi'])) $context['psi'] = "";
    if(!isset($context['bar'])) $context['bar'] = "";
    
    if($context['dynoruns']['nitrous'] == "0") $context['n0'] = "selected=\"selected\"";
    else if($context['dynoruns']['nitrous'] == "25") $context['n25'] = "selected=\"selected\"";
    else if($context['dynoruns']['nitrous'] == "50") $context['n50'] = "selected=\"selected\"";
    else if($context['dynoruns']['nitrous'] == "75") $context['n75'] = "selected=\"selected\"";
    else if($context['dynoruns']['nitrous'] == "100") $context['n100'] = "selected=\"selected\"";
    
    if(!isset($context['n0'])) $context['n0'] = "";
    if(!isset($context['n25'])) $context['n25'] = "";
    if(!isset($context['n50'])) $context['n50'] = "";
    if(!isset($context['n75'])) $context['n75'] = "";
    if(!isset($context['n100'])) $context['n100'] = "";

    // Select image data
    $request = db_query("
        SELECT image_id, hilite
        FROM {$db_prefix}garage_dynoruns_gallery
        WHERE dynorun_id = ".$_GET['DID'],__FILE__,__LINE__);
        $count = 0;
        while($row = mysql_fetch_row($request)) {
            ...
            $request2 = db_query("
                ...
                list($context['dynoruns'][$count]['attach_location'],
                     ...
                     $context['dynoruns'][$count]['attach_desc'],
                     $context['dynoruns'][$count]['is_remote']) = mysql_fetch_row($request2);
            mysql_free_result($request2);
        ...
        $request = db_query("
            ...
            WHERE vehicle_id = " . $_GET['VID'] . "
                AND type = 'dynorun'
                AND type_id = ".$_GET['DID'], __FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
                ...
                if(!empty($context['dynoruns'][$count]['video_id'])) {
                    $request2 = db_query("
                        ...
                        WHERE id = " . $context['dynoruns'][$count]['video_id'],__FILE__,__LINE__);
                            list($context['dynoruns'][$count]['video_url'],
                                 $context['dynoruns'][$count]['video_title'],
                                 $context['dynoruns'][$count]['video_desc']) = mysql_fetch_row($request2);
                            mysql_free_result($request2); 
                    if(empty($context['dynoruns'][$count]['video_desc'])) $context['dynoruns'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
...
function G_Update_Dynorun()
{
    ...
    $request = db_query("
        ...
        SET dynocenter_id = ".$_POST['dynocenter_id'].", bhp = '".$_POST['bhp']."', bhp_unit = '".$_POST['bhp_unit']."', torque = '".$_POST['torque']."', torque_unit = '".$_POST['torque_unit']."', boost = '".$_POST['boost']."', boost_unit = '".$_POST['boost_unit']."', nitrous = '".$_POST['nitrous']."', peakpoint = '".$_POST['peakpoint']."', date_updated = ".$date_updated."
        WHERE id = ".$_POST['DID'],__FILE__,__LINE__); 
...
function G_Add_Laptime()
{
    ...
    $context['max_image_bytes'] = $smfgSettings['max_image_kbytes'] * 1024;
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_add_laptime'];
    
    // Validate Owner
    checkOwner($_GET['VID']);
    
    // Session variable set?
    if(!isset($_SESSION['added_track'])) $_SESSION['added_track'] = 0;
...
function G_Insert_Laptime()
{
    ...
    if(!$smfgSettings['enable_laptimes']) {
     ...
     // Check if approval is required
     if($smfgSettings['enable_lap_approval']) $pending = '1';
        else $pending = '0';
    ...
    if($smfgSettings['enable_lap_images']) {
        ...
        if ($_FILES['FILE_UPLOAD']['error'] == 0) {           
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_laps (vehicle_id, track_id, condition_id, type_id, minute, second, millisecond, pending)
                VALUES (".$context['vehicle_id'].", ".$_POST['track_id'].", ".$_POST['condition'].", ".$_POST['type'].", ".$_POST['minute'].", ".$_POST['second'].", ".$_POST['millisecond'].", ".$pending.")",__FILE__,__LINE__);
            $context['lap_id'] = db_insert_id($request);  
            ...
            $request = db_query("
                INSERT INTO {$db_prefix}garage_laps_gallery (vehicle_id, lap_id, image_id, hilite)
                VALUES (".$context['vehicle_id'].", ".$context['lap_id'].", ".$context['image_id'].", 1)",__FILE__,__LINE__);           
    ...
    if($smfgSettings['enable_laptime_video'] && $_POST['video_url'] > 'http://') {
        ...
        $request = db_query("
            INSERT INTO {$db_prefix}garage_video_gallery (vehicle_id, video_id, type, type_id)
            VALUES (".$context['vehicle_id'].", ".$context['video_id'].", 'lap', ".$context['lap_id'].")",__FILE__,__LINE__);
...
function G_Edit_Laptime()
{
    ...
    $context['max_image_bytes'] = $smfgSettings['max_image_kbytes'] * 1024;
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_edit_laptime'];
    ...
    $request = db_query("
        ...
        list($context['laps']['track_id'],
             ...
             $context['laps']['minute'],
             $context['laps']['second'],
             $context['laps']['millisecond']) = mysql_fetch_row($request);
    mysql_free_result($request);  
    ...
    $request = db_query("
        SELECT image_id, hilite
        FROM {$db_prefix}garage_laps_gallery
        WHERE lap_id = ".$_GET['LID'],__FILE__,__LINE__);
        $count = 0;
        while($row = mysql_fetch_row($request)) {
            ...
            $request2 = db_query("
                ...
                list($context['laps'][$count]['attach_location'],
                     ...
                     $context['laps'][$count]['attach_desc'],
                     $context['laps'][$count]['is_remote']) = mysql_fetch_row($request2);
            mysql_free_result($request2);
            ...
            $request2 = db_query("
                ...
                WHERE {$db_prefix}garage_laps.track_id = {$db_prefix}garage_tracks.id
                    AND {$db_prefix}garage_laps.id = ".$_GET['LID'],__FILE__,__LINE__);
                list($context['laps'][$count]['title']) = mysql_fetch_row($request2);
            mysql_free_result($request2);            
        ...
        $request = db_query("
            ...
            WHERE vehicle_id = " . $_GET['VID'] . "
                AND type = 'lap'
                AND type_id = ".$_GET['LID'], __FILE__,__LINE__);
            $count = 0;
            while($row = mysql_fetch_row($request)) {
                ...
                if(!empty($context['laps'][$count]['video_id'])) {
                    $request2 = db_query("
                        ...
                        WHERE id = " . $context['laps'][$count]['video_id'],__FILE__,__LINE__);
                            list($context['laps'][$count]['video_url'],
                                 $context['laps'][$count]['video_title'],
                                 $context['laps'][$count]['video_desc']) = mysql_fetch_row($request2);
                            mysql_free_result($request2); 
                    if(empty($context['laps'][$count]['video_desc'])) $context['laps'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
...
function G_Update_Laptime()
{
    ...
    $request = db_query("
        ...
        SET track_id = ".$_POST['track_id'].", condition_id = ".$_POST['condition'].", type_id = ".$_POST['type'].", minute = ".$_POST['minute'].", second = ".$_POST['second'].", millisecond = ".$_POST['millisecond']."
        WHERE id = ".$_POST['LID'],__FILE__,__LINE__); 
...
function G_Add_Service()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_add_service'];
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=view_vehicle;VID='.$_GET['VID'],
        'name' => $context['user_vehicles']['vehicle']
    ); 
...
function G_Insert_Service()
{
    ...
    $request = db_query("
        INSERT INTO {$db_prefix}garage_service_history (vehicle_id, garage_id, type_id, price, rating, mileage, date_created, date_updated)
        VALUES (".$_POST['VID'].", ".$_POST['garage_id'].", ".$_POST['type_id'].", ".$_POST['price'].", ".$_POST['rating'].", ".$_POST['mileage'].", ".$date_created.", ".$date_created.")",__FILE__,__LINE__);
...
function G_Edit_Service()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_edit_service'];
    ...
    $request = db_query("
        ...
        WHERE id = ".$_GET['SID'],__FILE__,__LINE__);
        list($context['services']['id'],
             $context['services']['garage_id'],
             $context['services']['type_id'],
             $context['services']['price'],
             $context['services']['rating'],
             $context['services']['mileage']) = mysql_fetch_row($request);
    mysql_free_result($request);
    
    if($context['services']['rating'] == 10) $context['rat_10'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 9) $context['rat_9'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 8) $context['rat_8'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 7) $context['rat_7'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 6) $context['rat_6'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 5) $context['rat_5'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 4) $context['rat_4'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 3) $context['rat_3'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 2) $context['rat_2'] = "selected=\"selected\"";
    else if($context['services']['rating'] == 1) $context['rat_1'] = "selected=\"selected\"";
    
    if(!isset($context['rat_10'])) $context['rat_10'] = "";
    if(!isset($context['rat_9'])) $context['rat_9'] = "";
    if(!isset($context['rat_8'])) $context['rat_8'] = "";
    if(!isset($context['rat_7'])) $context['rat_7'] = "";
    if(!isset($context['rat_6'])) $context['rat_6'] = "";
    if(!isset($context['rat_5'])) $context['rat_5'] = "";
    if(!isset($context['rat_4'])) $context['rat_4'] = "";
    if(!isset($context['rat_3'])) $context['rat_3'] = "";
    if(!isset($context['rat_2'])) $context['rat_2'] = "";
    if(!isset($context['rat_1'])) $context['rat_1'] = "";
...
function G_Update_Service()
{
    ...
    $request = db_query("
        ...
        SET garage_id = ".$_POST['garage_id'].", type_id = ".$_POST['type_id'].", price = ".$_POST['price'].", rating = ".$_POST['rating'].", mileage = ".$_POST['mileage'].", date_updated = ".$date_updated."
        WHERE id = ".$_POST['SID'],__FILE__,__LINE__); 
...
function G_Insert_Blog()
{
    ...
    $request = db_query("
        INSERT INTO {$db_prefix}garage_blog (vehicle_id, user_id, blog_title, blog_text, post_date)
        VALUES (".$_POST['VID'].", ".$_POST['user_id'].", '".$blog_title."', '".$blog_text."', ".$date_created.")",__FILE__,__LINE__);
...
function G_Edit_Blog()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_edit_blog'];
    ...
    $request = db_query("
        ...
        list($context['blog']['title'],
             $context['blog']['text'],
             $context['blog']['post_date']) = mysql_fetch_row($request);
...
function G_Update_Blog()
{
    ...
    $request = db_query("
        ...
        SET blog_title = '".$blog_title."', blog_text = '".$blog_text."'
...
function G_Insert_Garage_Comment()
{
    ...
    // Check if approval is required
    if($smfgSettings['enable_guestbooks_comment_approval']) $pending = '1';
        else $pending = '0';
    
    $request = db_query("
        INSERT INTO {$db_prefix}garage_comments (user_id, author_id, post_date, ip_address, pending, post)
        VALUES (".$_POST['UID'].", ".$_POST['user_id'].", ".$date_created.", '".$client_ip."', '".$pending."', '".$comment."')",__FILE__,__LINE__);    
    ...
    $request = db_query("
        SELECT user_id
        FROM {$db_prefix}garage_vehicles
        WHERE user_id = ".$_POST['UID'],__FILE__,__LINE__);
    list($ownerId) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        WHERE user_id = ".$ownerId."
            AND gb_opt_out = 1",__FILE__,__LINE__);
    ...
    if($numResults == 0)  {
        ...
        $request = db_query("
            SELECT realName
            FROM {$db_prefix}members
            WHERE ID_MEMBER = '".$_POST['user_id']."'",__FILE__,__LINE__);
        list($authorName) = mysql_fetch_row($request);
        mysql_free_result($request);
        sendOtherNotifications($ownerId, str_replace('@AUTHOR@', $authorName, $txt['smfg_comment_notification']), str_replace(array('@AUTHOR@', '@UID@'), array($authorName, $_POST['UID']), $txt['smfg_comment_pm']));
    }
...
function G_Edit_Garage_Comment()
{
    ...
    $request = db_query("
        ...
        list($context['author_id']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    // Build the link tree
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_edit_comment'];
    $context['linktree'][] = array(
    ...
    $request = db_query("
        ...
        FROM {$db_prefix}garage_comments
        WHERE id = ".$_GET['CID'],__FILE__,__LINE__);
        list($context['comments']['post']) = mysql_fetch_row($request);
...
function G_Insert_Comment()
{
    ...
    $request = db_query("
        INSERT INTO {$db_prefix}garage_guestbooks (vehicle_id, author_id, post_date, ip_address, pending, post)
        VALUES (".$_POST['VID'].", ".$_POST['user_id'].", ".$date_created.", '".$client_ip."', '".$pending."', '".$comment."')",__FILE__,__LINE__);    
    ...
    if($numResults == 0)  {
        ...
        list($authorName) = mysql_fetch_row($request);
        mysql_free_result($request);
        sendOtherNotifications($ownerId, str_replace('@AUTHOR@', $authorName, $txt['smfg_gb_notification']), str_replace(array('@AUTHOR@', '@VID@'), array($authorName, $_POST['VID']), $txt['smfg_gb_pm']));
    }
...
function G_Edit_Comment()
{
    ...
    $request = db_query("
        ...
        FROM {$db_prefix}garage_guestbooks
        WHERE id = ".$_GET['CID'],__FILE__,__LINE__);
        list($context['gb']['comment']) = mysql_fetch_row($request);
...
function G_View_Modification()
{
    ...
    $request = db_query( "
        ...
        WHERE m.id = " . $_GET['MID'] . "
        LIMIT 1", __FILE__, __LINE__);
    $matching_mid = mysql_num_rows($request);
    mysql_free_result($request);
    ...
    // Gather vehicle data
    $request = db_query("
        SELECT v.user_id, CONCAT_WS(' ', v.made_year, mk.make, md.model) as title, c.title, u.realName, v.pending
        ...
        WHERE v.id = ".$_GET['VID']." 
            ...
            AND v.model_id = md.id
            AND v.currency = c.id
            AND ID_MEMBER = v.user_id",__FILE__,__LINE__);
    list($context['user_vehicles']['user_id'],
         $context['user_vehicles']['title'],
         $context['user_vehicles']['currency'],
         $context['mods']['owner'],
         $context['user_vehicles']['pending']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        WHERE m.manufacturer_id = b.id
            AND m.category_id = c.id
            AND m.product_id = p.id
            AND m.id = ".$_GET['MID'],__FILE__,__LINE__);
        list($context['mods']['manufacturer'],
             $context['mods']['manufacturer_id'],
             $context['mods']['category'],
             $context['mods']['product']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $context['user_vehicles']['title'] . ' &gt; '.$context['mods']['product']; 
    $context['linktree'][] = array(
    ...
    $request = db_query("
        ...
        WHERE m.id = ".$_GET['MID']."
            AND m.manufacturer_id = b.id",__FILE__,__LINE__);
        list($context['mods']['price'],
             ...
             $context['mods']['pending']) = mysql_fetch_row($request);
    ...
    if(!empty($context['mods']['shop_id'])) {
        ...
        $request = db_query("
            ...
            WHERE id = ".$context['mods']['shop_id'],__FILE__,__LINE__);
            list($context['mods']['shop'],
                 $context['mods']['shop_pending']) = mysql_fetch_row($request);
        mysql_free_result($request);
    ...
    if(!empty($context['mods']['installer_id'])) {
        ...
        $request = db_query("
            SELECT title, pending
            FROM {$db_prefix}garage_business
            WHERE id = ".$context['mods']['installer_id'],__FILE__,__LINE__);
            list($context['mods']['installer'],
                 $context['mods']['installer_pending']) = mysql_fetch_row($request);
        mysql_free_result($request);
            ...
            if(!empty($context['mods'][$count]['image_id'])) {
                ...
                WHERE attach_id = " . $context['mods'][$count]['image_id'],__FILE__,__LINE__);
                    ...
                    if($context['mods'][$count]['hilite'] == 1) {
                       if($context['mods'][$count]['is_remote'] == 1) $context['hilite_image_location'] = urldecode($context['mods'][$count]['attach_location']);
                           else $context['hilite_image_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['mods'][$count]['attach_location'];
                    ...
                    if($context['mods'][$count]['is_remote'] == 1) $context['mods'][$count]['attach_location'] = urldecode($context['mods'][$count]['attach_location']);
                        else $context['mods'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['mods'][$count]['attach_location'];                     
...
function G_View_Quartermile()
{
    ...
    $context['date_format'] = $smfgSettings['dateformat'];  
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_view_quartermile'];
    ...
    $request = db_query( "
        ...
        WHERE q.id = " . $_GET['QID'] . "
        LIMIT 1", __FILE__, __LINE__);
    $matching_qid = mysql_num_rows($request);
    mysql_free_result($request);
    ...
    // Gather vehicle data
    $request = db_query("
        SELECT v.user_id, CONCAT_WS(' ', v.made_year, mk.make, md.model) as title, v.pending, u.realName
        FROM {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}members AS u
        WHERE v.id = ".$_GET['VID']." 
            AND v.make_id = mk.id
            AND v.model_id = md.id
    ...
    list($context['user_vehicles']['user_id'],
         $context['user_vehicles']['title'],
         $context['user_vehicles']['pending'],
         $context['qmiles']['owner']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        list($context['qmiles']['rt'],
             ...
             $context['qmiles']['pending']) = mysql_fetch_row($request);
    mysql_free_result($request);  
    ...
    if(!empty($context['qmiles'][$count]['image_id'])) {
        ...
        WHERE attach_id = " . $context['qmiles'][$count]['image_id'],__FILE__,__LINE__);
            ...
            if($context['qmiles'][$count]['hilite'] == 1) {
               if($context['qmiles'][$count]['is_remote'] == 1) $context['hilite_image_location'] = urldecode($context['qmiles'][$count]['attach_location']);
                   else $context['hilite_image_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['qmiles'][$count]['attach_location'];
            ...
            if($context['qmiles'][$count]['is_remote'] == 1) $context['qmiles'][$count]['attach_location'] = urldecode($context['qmiles'][$count]['attach_location']);
                else $context['qmiles'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['qmiles'][$count]['attach_location'];                     
...
function G_View_Dynorun()
{
    ...
    $context['date_format'] = $smfgSettings['dateformat'];        
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_view_dynorun'];
    ...
    $request = db_query( "
        ...
        WHERE d.id = " . $_GET['DID'] . "
        LIMIT 1", __FILE__, __LINE__);
    $matching_did = mysql_num_rows($request);
    mysql_free_result($request);
    ...
    list($context['user_vehicles']['user_id'],
         $context['user_vehicles']['title'],
         $context['user_vehicles']['pending'],
         $context['dynoruns']['owner']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        FROM {$db_prefix}garage_dynoruns AS d, {$db_prefix}garage_business AS b
        WHERE d.id = ".$_GET['DID']." 
            AND d.dynocenter_id = b.id",__FILE__,__LINE__);
        list($context['dynoruns']['dynocenter_id'],
             $context['dynoruns']['bhp'],
             $context['dynoruns']['bhp_unit'],
             $context['dynoruns']['torque'],
             ...
             $context['dynoruns']['pending']) = mysql_fetch_row($request);
    mysql_free_result($request);
            ...
            if(!empty($context['dynoruns'][$count]['image_id'])) {
                ...
                WHERE attach_id = " . $context['dynoruns'][$count]['image_id'],__FILE__,__LINE__);
                    ...
                    if($context['dynoruns'][$count]['hilite'] == 1) {
                       if($context['dynoruns'][$count]['is_remote'] == 1) $context['hilite_image_location'] = urldecode($context['dynoruns'][$count]['attach_location']);
                           else $context['hilite_image_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['dynoruns'][$count]['attach_location'];
                    ...
                    if($context['dynoruns'][$count]['is_remote'] == 1) $context['dynoruns'][$count]['attach_location'] = urldecode($context['dynoruns'][$count]['attach_location']);
                        else $context['dynoruns'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['dynoruns'][$count]['attach_location'];                     
...
function G_View_Laptime()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_view_laptime'];
    ...
    $request = db_query( "
        ...
        WHERE l.id = " . $_GET['LID'] . "
        LIMIT 1", __FILE__, __LINE__);
    $matching_lid = mysql_num_rows($request);
    mysql_free_result($request);
    ...
    list($context['user_vehicles']['user_id'],
         $context['user_vehicles']['title'],
         $context['user_vehicles']['pending'],
         $context['laps']['owner']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        FROM {$db_prefix}garage_laps AS l, {$db_prefix}garage_tracks AS t, {$db_prefix}garage_track_conditions AS tc, {$db_prefix}garage_lap_types AS lt 
        WHERE l.id = ".$_GET['LID']." 
            AND l.vehicle_id = ".$_GET['VID']." 
            AND l.track_id = t.id 
            AND l.condition_id = tc.id 
            AND l.type_id = lt.id",__FILE__,__LINE__);
        list($context['laps']['track_id'],
             ...
             $context['laps']['track'],
             $context['laps']['pending']) = mysql_fetch_row($request);
            ...
            if(!empty($context['laps'][$count]['image_id'])) {
                ...
                WHERE attach_id = " . $context['laps'][$count]['image_id'],__FILE__,__LINE__);
                    ...
                    if($context['laps'][$count]['hilite'] == 1) {
                       if($context['laps'][$count]['is_remote'] == 1) $context['hilite_image_location'] = urldecode($context['laps'][$count]['attach_location']);
                           else $context['hilite_image_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['laps'][$count]['attach_location'];
                    ...
                    if($context['laps'][$count]['is_remote'] == 1) $context['laps'][$count]['attach_location'] = urldecode($context['laps'][$count]['attach_location']);
                        else $context['laps'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['laps'][$count]['attach_location'];                     
...
function G_View_Track()
{
    ...
    $request = db_query( "
        ...
        WHERE t.id = " . $_GET['TID'] . "
        LIMIT 1", __FILE__, __LINE__);
    $matching_tid = mysql_num_rows($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        ...
        list($context['track']['title'],
             ...
             $context['track']['pending']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    $request = db_query("
        SELECT l.id, l.vehicle_id, tc.title, lt.title, CONCAT_WS(':', l.minute, l.second, l.millisecond), v.user_id, u.realName, CONCAT_WS( ' ', v.made_year, mk.make, md.model)
    ...
    $request3 = db_query("
        ...
        WHERE lap_id = " . $context['laps'][$count]['id'] . "
            AND hilite = 1", __FILE__,__LINE__);
        list($context['laps'][$count]['image_id'],
             $context['laps'][$count]['hilite']) = mysql_fetch_row($request3);
            ...
            if(!empty($context['laps'][$count]['image_id'])) {
                ...
                $context['laps'][$count]['attach_thumb_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['laps'][$count]['attach_thumb_location'];           
                // If there is an image attached, link to it
                if(isset($context['laps'][$count]['attach_location'])) $context['laps'][$count]['image'] = "<a href=\"".$context['laps'][$count]['attach_location']."\" rel=\"shadowbox[laps]\" title=\"".garage_title_clean($context['laps'][$count]['time'].' @ '.$context['track']['title'].' :: '.$context['laps'][$count]['attach_desc'])."\" class=\"smfg_imageTitle\"><img src=\"". $settings['default_images_url'] . "/garage_camera.gif\" width=\"16\" height=\"16\" /></a>";                
            }
            ...
            if($smfgSettings['enable_laptime_video']) {
                ...
                $request2 = db_query("
                    SELECT video_id
                    FROM {$db_prefix}garage_video_gallery
                    WHERE type_id = " . $context['laps'][$count]['id'] . "
                        AND type = 'lap'
                        ORDER BY id ASC
                        LIMIT 1",__FILE__,__LINE__);
                list($context['laps'][$count]['video_id']) = mysql_fetch_row($request2);
                ...
                if(isset($context['laps'][$count]['video_id'])) {
                    ...
                    if(isset($context['laps'][$count]['video_url'])) $context['laps'][$count]['video'] = "<a href=\"".$scripturl."?action=garage;sa=video;id=".$context['laps'][$count]['video_id']."\" rel=\"shadowbox;width=".$context['laps'][$count]['video_width'].";height=".$context['laps'][$count]['video_height']."\" title=\"".garage_title_clean('<b>'.$context['laps'][$count]['video_title'].'</b> :: '.$context['laps'][$count]['video_desc'])."\" class=\"smfg_videoTitle\"><img src=\"". $settings['default_images_url'] . "/garage_video.gif\" width=\"16\" height=\"16\" /></a>";
                }        
            }
            $count++;
        }
    ...
    // Build the link tree
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_view_track'] . ' &gt; ' .$context['track']['title'];
    $context['linktree'][] = array(
...
function G_Search()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_search'];
    $context['linktree'][] = array(
...
function G_Search_Results()
{
    ...
    // store session data
    if(!empty($_POST['made_year']) && isset($_POST['made_year'])) $_SESSION['smfg']['made_year'] = $_POST['made_year']; 
    if(!empty($_POST['make_id']) && isset($_POST['make_id'])) $_SESSION['smfg']['make_id'] = $_POST['make_id'];
    if(!empty($_POST['model_id']) && isset($_POST['model_id'])) $_SESSION['smfg']['model_id'] = $_POST['model_id']; 
    if(!empty($_POST['category_id']) && isset($_POST['category_id'])) $_SESSION['smfg']['category_id'] = $_POST['category_id']; 
    if(!empty($_POST['manufacturer_id']) && isset($_POST['manufacturer_id'])) $_SESSION['smfg']['manufacturer_id'] = $_POST['manufacturer_id'];  
    if(!empty($_POST['product_id']) && isset($_POST['product_id'])) $_SESSION['smfg']['product_id'] = $_POST['product_id']; 
    if(!empty($_POST['username']) && isset($_POST['username'])) $_SESSION['smfg']['username'] = $_POST['username']; 
    if(!empty($_POST['search_logic']) && isset($_POST['search_logic'])) $_SESSION['smfg']['search_logic'] = $_POST['search_logic']; 
    if(!empty($_POST['display_as']) && isset($_POST['display_as'])) $_SESSION['smfg']['display_as'] = $_POST['display_as'];
    if(!empty($_POST['search_year']) && isset($_POST['search_year'])) $_SESSION['smfg']['search_year'] = $_POST['search_year'];
    if(!empty($_POST['search_make']) && isset($_POST['search_make'])) $_SESSION['smfg']['search_make'] = $_POST['search_make'];  
    if(!empty($_POST['search_model']) && isset($_POST['search_model'])) $_SESSION['smfg']['search_model'] = $_POST['search_model'];    
    if(!empty($_POST['search_category']) && isset($_POST['search_category'])) $_SESSION['smfg']['search_category'] = $_POST['search_category'];  
    if(!empty($_POST['search_manufacturer']) && isset($_POST['search_manufacturer'])) $_SESSION['smfg']['search_manufacturer'] = $_POST['search_manufacturer'];
    if(!empty($_POST['search_product']) && isset($_POST['search_product'])) $_SESSION['smfg']['search_product'] = $_POST['search_product'];
    if(!empty($_POST['search_username']) && isset($_POST['search_username'])) $_SESSION['smfg']['search_username'] = $_POST['search_username'];
    
    // Define anything we are not searching for
    if(empty($_SESSION['smfg']['made_year'])) $_SESSION['smfg']['made_year'] = "";
    if(empty($_SESSION['smfg']['make_id'])) $_SESSION['smfg']['make_id'] = "";
    if(empty($_SESSION['smfg']['model_id'])) $_SESSION['smfg']['model_id'] = "";
    if(empty($_SESSION['smfg']['category_id'])) $_SESSION['smfg']['category_id'] = "";
    if(empty($_SESSION['smfg']['manufacturer_id'])) $_SESSION['smfg']['manufacturer_id'] = "";
    if(empty($_SESSION['smfg']['product_id'])) $_SESSION['smfg']['product_id'] = "";
    if(empty($_SESSION['smfg']['username'])) $_SESSION['smfg']['username'] = "";
    if(empty($_SESSION['smfg']['search_logic'])) $_SESSION['smfg']['search_logic'] = "";
    if(empty($_SESSION['smfg']['display_as'])) $_SESSION['smfg']['display_as'] = "";
    if(empty($_SESSION['smfg']['search_year'])) $_SESSION['smfg']['search_year'] = "";
    if(empty($_SESSION['smfg']['search_make'])) $_SESSION['smfg']['search_make'] = "";
    if(empty($_SESSION['smfg']['search_model'])) $_SESSION['smfg']['search_model'] = "";
    if(empty($_SESSION['smfg']['search_category'])) $_SESSION['smfg']['search_category'] = "";
    if(empty($_SESSION['smfg']['search_manufacturer'])) $_SESSION['smfg']['search_manufacturer'] = "";
    if(empty($_SESSION['smfg']['search_product'])) $_SESSION['smfg']['search_product'] = "";
    if(empty($_SESSION['smfg']['search_username'])) $_SESSION['smfg']['search_username'] = "";
    ...
    if($_SESSION['smfg']['display_as'] == 'modifications') {  
        ...
        } else if($_GET['sort'] == "modification") {
            $sort = "p.title";
            // Set order options for each sort type
            if(empty($_GET['order']) || $_GET['order'] == "DESC") {     
    ...
    if($_SESSION['smfg']['display_as'] == "vehicles") {
        ...
        $search_selects .= "v.id, v.made_year, mk.make, md.model, v.color, v.user_id, u.realName, v.views, COUNT(m.id) as total_mods, v.date_updated";
    ...
    } else if ($_SESSION['smfg']['display_as'] == "modifications") {
        
        $search_selects .= "v.id, v.made_year, mk.make, md.model, v.user_id, u.realName, m.id, p.title, m.date_updated";
    ...
    } else if ($_SESSION['smfg']['display_as'] == "premiums") {
        
        $search_selects .= "v.id, CONCAT_WS( ' ', v.made_year, mk.make, md.model) AS vehicle, v.user_id, u.realName, p.premium AS price, b.id, b.title, pt.title";
    ...
    } else if ($_SESSION['smfg']['display_as'] == "quartermiles") {
        
        $search_selects .= "q.id, v.id, CONCAT_WS( ' ', v.made_year, mk.make, md.model) AS vehicle, v.user_id, u.realName, q.rt, q.sixty, q.three, q.eighth, q.eighthmph, q.thou, q.quart, q.quartmph";
    ...
    } else if ($_SESSION['smfg']['display_as'] == "dynoruns") {
        
        $search_selects .= "v.id, d.id, CONCAT_WS( ' ', v.made_year, mk.make, md.model) AS vehicle, v.user_id, u.realName, d.bhp, d.bhp_unit, d.torque, d.torque_unit, d.boost, d.boost_unit, d.nitrous, d.peakpoint, b.title, b.id";
    ...
    } else if ($_SESSION['smfg']['display_as'] == "laps") {
        
        $search_selects .= "v.id, CONCAT_WS( ' ', v.made_year, mk.make, md.model) AS vehicle, v.user_id, u.realName, l.track_id, t.title, tc.title, lt.title, l.id, CONCAT_WS(':',l.minute, l.second, l.millisecond) AS time";
    ...
    if($_SESSION['smfg']['search_make'] == 1) {
        ...
        if($count > 0) $separator = " ".$_SESSION['smfg']['search_logic']." ";
            else $separator = "";
    ...
    if($_SESSION['smfg']['search_username'] == 1) {
        ...
        $search_logic .= $separator."u.realName = '".$_SESSION['smfg']['username']."'";
        $count++;
    ...
    if($_SESSION['smfg']['display_as'] == "vehicles") $group_by = "GROUP BY v.id";
        else $group_by = "";
    ...
    $request = db_query("
        ...
        ORDER BY ".$sort." ".$order,__FILE__,__LINE__);
        $context['total'] = mysql_num_rows($request);
    
    // Set pagination variables
    $context['display'] = $smfgSettings['results_per_page'];
    $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=search_results' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
    $context['start'] = $_REQUEST['start'] + 1;
    $context['end'] = min($_REQUEST['start'] + $context['display'], $context['total']);
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_viewing_results'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
    $context['linktree'][] = array(
        ...
        'name' => $txt['smfg_viewing_results'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
        'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_results'] . ')'
    );
    ...
    $request = db_query("
        ...
        FROM ".$search_tables." ".$search_logic." ".$group_by."
        ORDER BY ".$sort." ".$order."
        LIMIT ".$_REQUEST['start'].", ".$context['display'],__FILE__,__LINE__);
        $count = 0;
        while($row = mysql_fetch_row($request)) {       
            ...
            if($_SESSION['smfg']['display_as'] == "vehicles") {
                ...
                $context['search_results'][$count]['views'] = number_format($context['search_results'][$count]['views'], 0, '.', ',');
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_vehicles_gallery
                        WHERE vehicle_id = ".$context['search_results'][$count]['vid']."
                            AND hilite = 1",__FILE__,__LINE__);
                    list($context['search_results'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    ...
                    if(isset($context['search_results'][$count]['image_id'])) {
                        $request2 = db_query("
                            SELECT attach_location, attach_ext, attach_file, attach_desc, is_remote
                            FROM {$db_prefix}garage_images
                            WHERE attach_id = ".$context['search_results'][$count]['image_id'],__FILE__,__LINE__);
                        list($context['search_results'][$count]['attach_location'],
                             ...
                             $context['search_results'][$count]['is_remote']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                        if(empty($context['search_results'][$count]['attach_desc'])) $context['search_results'][$count]['attach_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                        
                        // Build appropriate links for remote images
                        if(isset($context['search_results'][$count]['attach_location']))
                        {
                            if($context['search_results'][$count]['is_remote'] == 1) $context['search_results'][$count]['attach_location'] = urldecode($context['search_results'][$count]['attach_location']);
                                else $context['search_results'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['search_results'][$count]['attach_location'];
                        }
                        // If there is an image attached, link to it
                        if(isset($context['search_results'][$count]['attach_location'])) $context['search_results'][$count]['image'] = "<a href=\"".$context['search_results'][$count]['attach_location']."\" rel=\"shadowbox\" title=\"".garage_title_clean($context['search_results'][$count]['made_year'].' '.$context['search_results'][$count]['make'].' '.$context['search_results'][$count]['model'].' :: '.$context['search_results'][$count]['attach_desc'])."\" class=\"smfg_imageTitle\"><img src=\"". $settings['default_images_url'] . "/garage_camera.gif\" width=\"16\" height=\"16\" /></a>";
                    }
                    ...
                    if($smfgSettings['enable_vehicle_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['search_results'][$count]['vid']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['search_results'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                        ...
                        if(isset($context['search_results'][$count]['video_id'])) {
                                ...
                                SELECT url, title, video_desc
                                FROM {$db_prefix}garage_video
                                WHERE id = ".$context['search_results'][$count]['video_id'],__FILE__,__LINE__);
                        list($context['search_results'][$count]['video_url'],
                         $context['search_results'][$count]['video_title'],
                         $context['search_results'][$count]['video_desc']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                         if(empty($context['search_results'][$count]['video_desc'])) $context['search_results'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                         $context['search_results'][$count]['video_height'] = displayVideo($context['search_results'][$count]['video_url'], 'height');
                         $context['search_results'][$count]['video_width'] = displayVideo($context['search_results'][$count]['video_url'], 'width');
                         if(!empty($context['search_results'][$count]['image_id']) && !empty($context['search_results'][$count]['video_id'])) $context['search_results'][$count]['spacer'] = '&nbsp;';
                    
                        // If there is an video attached, link to it
                        if(isset($context['search_results'][$count]['video_url'])) $context['search_results'][$count]['video'] = "<a href=\"".$scripturl."?action=garage;sa=video;id=".$context['search_results'][$count]['video_id']."\" rel=\"shadowbox;width=".$context['search_results'][$count]['video_width'].";height=".$context['search_results'][$count]['video_height']."\" title=\"".garage_title_clean('<b>'.$context['search_results'][$count]['video_title'].'</b> :: '.$context['search_results'][$count]['video_desc'])."\" class=\"smfg_videoTitle\"><img src=\"". $settings['default_images_url'] . "/garage_video.gif\" width=\"16\" height=\"16\" /></a>";
                        }
                ...
                list($context['search_results'][$count]['vid'],
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_modifications_gallery
                        WHERE modification_id = ".$context['search_results'][$count]['mid'],__FILE__,__LINE__);
                    list($context['search_results'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    // If there is an image, lets find its attributes
                    $context['search_results'][$count]['image'] = '';
                    ...
                    if($smfgSettings['enable_modification_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['search_results'][$count]['vid']."
                                    AND type = 'mod'
                                    AND type_id = ".$context['search_results'][$count]['mid']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['search_results'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                ...
                list($context['search_results'][$count]['qmid'],
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_quartermiles_gallery
                        WHERE quartermile_id = ".$context['search_results'][$count]['qmid'],__FILE__,__LINE__);
                    list($context['search_results'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    // If there is an image, lets find its attributes
                    $context['search_results'][$count]['image'] = '';
                    ...
                    if($smfgSettings['enable_quartermile_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['search_results'][$count]['vid']."
                                    AND type = 'qmile'
                                    AND type_id = ".$context['search_results'][$count]['qmid']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['search_results'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                ...
                list($context['search_results'][$count]['vid'],
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_dynoruns_gallery
                        WHERE dynorun_id = ".$context['search_results'][$count]['did'],__FILE__,__LINE__);
                    list($context['search_results'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    // If there is an image, lets find its attributes
                    $context['search_results'][$count]['image'] = '';
                    ...
                    if($smfgSettings['enable_dynorun_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['search_results'][$count]['vid']."
                                    AND type = 'dynorun'
                                    AND type_id = ".$context['search_results'][$count]['did']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['search_results'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                ...
                list($context['search_results'][$count]['vid'],
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_laps_gallery
                        WHERE lap_id = ".$context['search_results'][$count]['lid'],__FILE__,__LINE__);
                    list($context['search_results'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    // If there is an image, lets find its attributes
                    $context['search_results'][$count]['image'] = '';
                    ...
                    if($smfgSettings['enable_laptime_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['search_results'][$count]['vid']."
                                    AND type = 'lap'
                                    AND type_id = ".$context['search_results'][$count]['lid']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['search_results'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
...
function G_Insurance()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_insurance_reviews'];
    $context['linktree'][] = array(
    ...
    $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=insurance', $_REQUEST['start'], $context['total'], $context['display']);
    $context['start'] = $_REQUEST['start'] + 1;
    $context['end'] = min($_REQUEST['start'] + $context['display'], $context['total']);
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_insurance_reviews'] .  ' &gt; ' . $txt['smfg_viewing_insurance'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=insurance' . (isset($_REQUEST['start']) ? ';start=' . $_REQUEST['start'] : ';start=0'),
        'name' => $txt['smfg_viewing_insurance'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
        'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_businesses'] . ')'
    );
    ...
    $request = db_query("
        ...
        while($row = mysql_fetch_row($request)) {
            ...
            if(!empty($context['insurance'][$count]['email'])) $context['insurance'][$count]['email'] = "<a href=\"mailto:".$context['insurance'][$count]['email']."\">".$context['insurance'][$count]['email']."</a>";
            ...
            $request2 = db_query("
                ...
                LEFT OUTER JOIN {$db_prefix}garage_premiums AS p ON p.business_id = ".$context['insurance'][$count]['bid']."
                ...
                while($row = mysql_fetch_row($request2)) {
                    ...
                    if(!empty($context['insurance'][$count][$count2]['min'])) $context['insurance'][$count][$count2]['min'] = number_format($context['insurance'][$count][$count2]['min'], 2, '.', ',');
                    if(!empty($context['insurance'][$count][$count2]['avg'])) $context['insurance'][$count][$count2]['avg'] = number_format($context['insurance'][$count][$count2]['avg'], 2, '.', ',');
                    if(!empty($context['insurance'][$count][$count2]['max'])) $context['insurance'][$count][$count2]['max'] = number_format($context['insurance'][$count][$count2]['max'], 2, '.', ',');
                    $count2++;
                }
            mysql_free_result($request2);            
            $count++;
...
function G_Insurance_Review()
{
    ...
    $request = db_query("
        ...
        list($context['insurance']['bid'],
             ...
             $context['insurance']['pending']) = mysql_fetch_row($request);
    mysql_free_result($request);
    ...
    // Build 'mailto' link if there is an address
    if(!empty($context['insurance']['email'])) $context['insurance']['email'] = "<a href=\"mailto:".$context['insurance']['email']."\">".$context['insurance']['email']."</a>";
    
    // Add to linktree
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_insurance_reviews'] . ' &gt; ' . $context['insurance']['title'];
    $context['linktree'][] = array(
    ...
    $request = db_query("
        SELECT pt.id, pt.title, MIN( p.premium ) AS min, AVG( p.premium ) AS avg, MAX( p.premium ) AS max
        FROM {$db_prefix}garage_premium_types AS pt
        LEFT OUTER JOIN {$db_prefix}garage_premiums AS p ON p.business_id = ".$context['insurance']['bid']."
            AND p.cover_type_id = pt.id
            GROUP BY pt.id
            ORDER BY field_order ASC",__FILE__,__LINE__);
    $count = 0;
    while($row = mysql_fetch_row($request)) {
        ...
        if(!empty($context['insurance'][$count]['min'])) $context['insurance'][$count]['min'] = number_format($context['insurance'][$count]['min'], 2, '.', ',');
        if(!empty($context['insurance'][$count]['avg'])) $context['insurance'][$count]['avg'] = number_format($context['insurance'][$count]['avg'], 2, '.', ',');
        if(!empty($context['insurance'][$count]['max'])) $context['insurance'][$count]['max'] = number_format($context['insurance'][$count]['max'], 2, '.', ',');
        $count++;
        }
    mysql_free_result($request);
    
    $request = db_query("
        SELECT u.realName, v.user_id, v.id, CONCAT_WS(' ', v.made_year, mk.make, md.model), p.id, p.premium, pt.title
        ...
        WHERE p.business_id = ".$context['insurance']['bid']."
...
function G_Shops()
{
    ...
    $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=shops', $_REQUEST['start'], $context['total'], $context['display']);
    $context['start'] = $_REQUEST['start'] + 1;
    $context['end'] = min($_REQUEST['start'] + $context['display'], $context['total']);
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_shop_reviews'] .  ' &gt; ' . $txt['smfg_viewing_shops'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=shops' . (isset($_REQUEST['start']) ? ';start=' . $_REQUEST['start'] : ''),
        'name' => $txt['smfg_viewing_shops'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
        'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_businesses'] . ')'
    );
    ...
    $request = db_query("
        ...
        while($row = mysql_fetch_row($request)) {
            ...
            // Build 'mailto' link if there is an address
            if(!empty($context['shops'][$count]['email'])) $context['shops'][$count]['email'] = "<a href=\"mailto:".$context['shops'][$count]['email']."\">".$context['shops'][$count]['email']."</a>";
            ...
            $request2 = db_query("
                ...
                FROM {$db_prefix}garage_modifications
                WHERE shop_id = ".$context['shops'][$count]['bid']."
                    AND pending != '1'",__FILE__,__LINE__);
            list($context['shops'][$count]['total_rating'],
                 $context['shops'][$count]['total_poss_rating']) = mysql_fetch_row($request2);
            ...
            if($context['shops'][$count]['total_poss_rating'] > 0)
                $context['shops'][$count]['total_poss_rating'] = number_format($context['shops'][$count]['total_poss_rating'], 2, '.', ',');
            
            $request2 = db_query("
                SELECT u.realName, v.id, v.user_id, CONCAT_WS(' ', v.made_year, mk.make, md.model), m.id, m.price, m.product_rating, m.purchase_rating, p.title
                ...
                WHERE m.shop_id = ".$context['shops'][$count]['bid']."
                    AND m.product_id = p.id
...
function G_Shop_Review()
{
    ...
    $request = db_query("
        ...
        FROM {$db_prefix}garage_business
        WHERE retail = 1
        AND id = ".$_GET['BID'],__FILE__,__LINE__);
        list($context['shops']['bid'],
             ...
             $context['shops']['pending']) = mysql_fetch_row($request);
        mysql_free_result($request);
    ...
    if($context['shops']['pending'] == '1' && !allowedTo('manage_garage_pending')) {
        ...
        // Build 'mailto' link if there is an address
        if(!empty($context['shops']['email'])) $context['shops']['email'] = "<a href=\"mailto:".$context['shops']['email']."\">".$context['shops']['email']."</a>";
        // Add to linktree
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_shop_reviews'] . ' &gt; ' . $context['shops']['title'];
        $context['linktree'][] = array(
        ...
        $request = db_query("
            SELECT ".$ratingfunc."( purchase_rating ), COUNT( id )
            FROM {$db_prefix}garage_modifications
            WHERE shop_id = ".$context['shops']['bid']."
                AND pending != '1'",__FILE__,__LINE__);
        list($context['shops']['total_rating'],
             $context['shops']['total_poss_rating']) = mysql_fetch_row($request);
        ...
        $request = db_query("
            SELECT u.realName, v.id, v.user_id, CONCAT_WS(' ', v.made_year, mk.make, md.model), m.id, m.price, m.product_rating, m.purchase_rating, m.comments, p.title
            FROM {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}garage_modifications AS m, {$db_prefix}garage_products AS p, {$db_prefix}members AS u
            WHERE m.shop_id = ".$context['shops']['bid']."
                AND m.product_id = p.id
                AND m.vehicle_id = v.id
                AND v.make_id = mk.id
                AND v.model_id = md.id
...
function G_Garages()
{
    ...
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_garage_reviews'];
    $context['linktree'][] = array(
    ...
    $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=garages', $_REQUEST['start'], $context['total'], $context['display']);
    $context['start'] = $_REQUEST['start'] + 1;
    $context['end'] = min($_REQUEST['start'] + $context['display'], $context['total']);
    $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_garage_reviews'] .  ' &gt; ' . $txt['smfg_viewing_garages'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=garages' . (isset($_REQUEST['start']) ? ';start=' . $_REQUEST['start'] : ''),
        'name' => $txt['smfg_viewing_garages'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
        'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_businesses'] . ')'
    );
    ...
    $request = db_query("
        ...
        while($row = mysql_fetch_row($request)) {
            ...
            // Build 'mailto' link if there is an address
            if(!empty($context['garages'][$count]['email'])) $context['garages'][$count]['email'] = "<a href=\"mailto:".$context['garages'][$count]['email']."\">".$context['garages'][$count]['email']."</a>";
            
            // Get the total rating of the garage from mod installations
            $request2 = db_query("
                SELECT SUM( install_rating ), COUNT( id )*10, COUNT( id )
                FROM {$db_prefix}garage_modifications
                WHERE installer_id = ".$context['garages'][$count]['bid']."
                    AND pending != '1'
                    GROUP BY installer_id",__FILE__,__LINE__);
            list($context['garages'][$count]['total_install_rating'],
                 $context['garages'][$count]['total_install_poss_rating'],
                 $context['garages'][$count]['total_install_ratings']) = mysql_fetch_row($request2);
            mysql_free_result($request2);
            ...
            $request2 = db_query("
                ...
                FROM {$db_prefix}garage_service_history
                WHERE garage_id = ".$context['garages'][$count]['bid']."
                    GROUP BY garage_id",__FILE__,__LINE__);
            list($context['garages'][$count]['total_service_rating'],
                 $context['garages'][$count]['total_service_poss_rating'],
                 $context['garages'][$count]['total_service_ratings']) = mysql_fetch_row($request2);
            mysql_free_result($request2);
            ...
            if ($context['garages'][$count]['total_poss_rating'] > 0)
                $context['garages'][$count]['total_poss_rating'] = number_format($context['garages'][$count]['total_poss_rating'], 2, '.', ',');      
            else
                $context['garages'][$count]['total_poss_rating'] = 0;
            
            // Get mods that used this garage
            $request2 = db_query("
                SELECT u.realName, v.id, v.user_id, CONCAT_WS(' ', v.made_year, mk.make, md.model), m.id, m.install_rating, p.title, m.comments
                FROM {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}garage_modifications AS m, {$db_prefix}garage_products AS p, {$db_prefix}members AS u
                WHERE m.installer_id = ".$context['garages'][$count]['bid']."
                    AND m.product_id = p.id
                    AND m.vehicle_id = v.id
                    AND v.make_id = mk.id
                    AND v.model_id = md.id
            ...
            $request2 = db_query("
            SELECT u.realName, v.id AS vid, s.id, v.user_id, CONCAT_WS(' ', v.made_year, mk.make, md.model), s.rating, st.title
                ...
                WHERE s.garage_id = ".$context['garages'][$count]['bid']."
                    AND s.garage_id = ".$context['garages'][$count]['bid']."
                    AND s.type_id = st.id
...
function G_Garage_Review()
{
    ...
    $request = db_query("
        ...
        list($context['garages']['title'],
             ...
             $context['garages']['pending']) = mysql_fetch_row($request);
        mysql_free_result($request);
    ...
    if($context['garages']['pending'] == '1' && !allowedTo('manage_garage_pending')) {
        ...
        // Build 'mailto' link if there is an address
        if(!empty($context['garages']['email'])) $context['garages']['email'] = "<a href=\"mailto:".$context['garages']['email']."\">".$context['garages']['email']."</a>";
        ...
        // Get the total rating of the garage from mod installations
            $request2 = db_query("
                SELECT SUM( install_rating ), COUNT( id )*10, COUNT( id )
                FROM {$db_prefix}garage_modifications
                WHERE installer_id = ".$_GET['BID']."
                    AND pending != '1'
                    GROUP BY installer_id",__FILE__,__LINE__);
            list($context['garages']['total_install_rating'],
                 $context['garages']['total_install_poss_rating'],
                 $context['garages']['total_install_ratings']) = mysql_fetch_row($request2);
            mysql_free_result($request2);
            ...
            $request2 = db_query("
                SELECT SUM( rating ), COUNT( id )*10, COUNT( id )
                FROM {$db_prefix}garage_service_history
                WHERE garage_id = ".$_GET['BID']."
                    GROUP BY garage_id",__FILE__,__LINE__);
            list($context['garages']['total_service_rating'],
                 $context['garages']['total_service_poss_rating'],
                 $context['garages']['total_service_ratings']) = mysql_fetch_row($request2);
            mysql_free_result($request2);
        ...
        // Get mods that used this garage
        $request = db_query("
            SELECT u.realName, v.id, v.user_id, CONCAT_WS(' ', v.made_year, mk.make, md.model), m.id, m.install_rating, p.title, m.install_comments
            FROM {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}garage_modifications AS m, {$db_prefix}garage_products AS p, {$db_prefix}members AS u
            WHERE m.installer_id = ".$_GET['BID']."
                AND m.product_id = p.id
                AND m.vehicle_id = v.id
                AND v.make_id = mk.id
                AND v.model_id = md.id
        ...
        $context['garages']['mods']['total'] = mysql_num_rows($request);
        mysql_free_result($request);
...
function G_Manufacturer_Review()
{
    ...
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=mfg_review'.$_GET['BID'],
    ...
    $request = db_query("
        ...
        list($context['mfg']['bid'],
             ...
             $context['mfg']['pending']) = mysql_fetch_row($request);
        mysql_free_result($request);
    ...
    if($context['mfg']['pending'] == '1' && !allowedTo('manage_garage_pending')) {
        ...
        // Build 'mailto' link if there is an address
        if(!empty($context['mfg']['email'])) $context['shops']['email'] = "<a href=\"mailto:".$context['shops']['email']."\">".$context['mfg']['email']."</a>";
        // Add to linktree
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_manufacturer_reviews'] . ' &gt; ' . $context['mfg']['title'];
        $context['linktree'][] = array(
        ...
        $request = db_query("
            ...
            FROM {$db_prefix}garage_modifications
            WHERE manufacturer_id = ".$context['mfg']['bid']."
                AND pending != '1'",__FILE__,__LINE__);
        list($context['mfg']['total_rating'],
             $context['mfg']['total_poss_rating']) = mysql_fetch_row($request);
        ...
        $request = db_query("
            SELECT u.realName, v.id, v.user_id, CONCAT_WS(' ', v.made_year, mk.make, md.model), m.id, m.price, m.product_rating, m.purchase_rating, m.comments, p.title
            FROM {$db_prefix}garage_vehicles AS v, {$db_prefix}garage_makes AS mk, {$db_prefix}garage_models AS md, {$db_prefix}garage_modifications AS m, {$db_prefix}garage_products AS p, {$db_prefix}members AS u
            WHERE m.manufacturer_id = ".$context['mfg']['bid']."
                AND m.product_id = p.id
                AND m.vehicle_id = v.id
                AND v.make_id = mk.id
                AND v.model_id = md.id
...
function G_Dynocenter_Review()
{
    ...
    $context['linktree'][] = array(
        'url' => $scripturl . '?action=garage;sa=dc_review'.$_GET['BID'],
        'name' => &$txt['smfg_dynocenter_review']
    );
    ...
    $request = db_query("
        ...
        list($context['dc']['bid'],
             ...
             $context['dc']['pending']) = mysql_fetch_row($request);
        mysql_free_result($request);
    ...
    if($context['dc']['pending'] == '1' && !allowedTo('manage_garage_pending')) {
        ...
        // Build 'mailto' link if there is an address
        if(!empty($context['dc']['email'])) $context['dc']['email'] = "<a href=\"mailto:".$context['dc']['email']."\">".$context['dc']['email']."</a>";
        // Add to linktree
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; ' . $txt['smfg_dynocenter_reviews'] . ' &gt; ' . $context['dc']['title'];
        $context['linktree'][] = array(
...
function G_Insert_Vehicle_Images()
{
    ...
    $request = db_query("
        SELECT id
        FROM {$db_prefix}garage_vehicles_gallery
        WHERE vehicle_id = ".$context['vehicle_id'],__FILE__,__LINE__);
    $results = mysql_num_rows($request);
    mysql_free_result($request);
    if($results > 0) $hilite = 0;
        else $hilite = 1;
    
    // Insert table date for vehicles_gallery
    $request = db_query("
        INSERT INTO {$db_prefix}garage_vehicles_gallery (vehicle_id, image_id, hilite)
        VALUES (".$context['vehicle_id'].", ".$context['image_id'].", ".$hilite.")",__FILE__,__LINE__);
    
    // Update vehicle's' "last updated" time
    $request = db_query("
        UPDATE {$db_prefix}garage_vehicles 
        SET date_updated = ".$context['date_created']."
        WHERE id = ".$context['vehicle_id'], __FILE__, __LINE__);    
...
function G_Remove_Vehicle_Image()
{
    ...
    $request = db_query("
        SELECT attach_location, attach_thumb_location 
        FROM {$db_prefix}garage_images
        WHERE attach_id = ".$_GET['image_id'],__FILE__,__LINE__);
        list($context['attach_location'],
             $context['attach_thumb_location']) = mysql_fetch_row($request);
        mysql_free_result($request);
    ...
    $request = db_query("
        DELETE FROM {$db_prefix}garage_vehicles_gallery
        WHERE image_id = ".$_GET['image_id'],__FILE__,__LINE__);
...
function G_Insert_Modification_Images()
{
    ...
    if($smfgSettings['enable_modification_images']) {
        ...
        $request = db_query("
            SELECT id
            FROM {$db_prefix}garage_modifications_gallery
            WHERE modification_id = ".$context['MID'],__FILE__,__LINE__);
        $results = mysql_num_rows($request);
        mysql_free_result($request);
        if($results > 0) $hilite = 0;
            else $hilite = 1;
        ...
        $request = db_query("
            INSERT INTO {$db_prefix}garage_modifications_gallery (vehicle_id, modification_id, image_id, hilite)
            VALUES (".$context['vehicle_id'].", ".$context['MID'].", ".$context['image_id'].", ".$hilite.")",__FILE__,__LINE__);
            
        // Update modification's' "last updated" time
        $request = db_query("
            UPDATE {$db_prefix}garage_modifications 
            SET date_updated = ".$context['date_created']."
            WHERE id = ".$context['MID'], __FILE__, __LINE__);          
...
function G_Insert_Modification_Video()
{
    ...
    if($smfgSettings['enable_modification_video']) {
        ...
        $request = db_query("
            UPDATE {$db_prefix}garage_modifications 
            SET date_updated = ".$context['date_created']."
            WHERE id = ".$context['mod_id'], __FILE__, __LINE__); 
...
function G_Insert_Quartermile_Images()
{
    ...
    if($smfgSettings['enable_quartermile_images']) {
        ...
        $request = db_query("
            SELECT id
            FROM {$db_prefix}garage_quartermiles_gallery
            WHERE quartermile_id = ".$context['QID'],__FILE__,__LINE__);
        $results = mysql_num_rows($request);
        mysql_free_result($request);
        if($results > 0) $hilite = 0;
            else $hilite = 1;
        ...
        $request = db_query("
            INSERT INTO {$db_prefix}garage_quartermiles_gallery (vehicle_id, quartermile_id, image_id, hilite)
            VALUES (".$context['vehicle_id'].", ".$context['QID'].", ".$context['image_id'].", ".$hilite.")",__FILE__,__LINE__);             
...
function G_Insert_Dynorun_Images()
{
    ...
    if($smfgSettings['enable_dynorun_images']) {
        ...
        $request = db_query("
            SELECT id
            FROM {$db_prefix}garage_dynoruns_gallery
            WHERE dynorun_id = ".$context['DID'],__FILE__,__LINE__);
        $results = mysql_num_rows($request);
        mysql_free_result($request);
        if($results > 0) $hilite = 0;
            else $hilite = 1;
        ...
        $request = db_query("
            INSERT INTO {$db_prefix}garage_dynoruns_gallery (vehicle_id, dynorun_id, image_id, hilite)
            VALUES (".$context['vehicle_id'].", ".$context['DID'].", ".$context['image_id'].", ".$hilite.")",__FILE__,__LINE__);         
...
function G_Insert_Laptime_Images()
{
    ...
    if($smfgSettings['enable_lap_images']) {
        ...
        $request = db_query("
            SELECT id
            FROM {$db_prefix}garage_laps_gallery
            WHERE lap_id = ".$context['LID'],__FILE__,__LINE__);
        $results = mysql_num_rows($request);
        mysql_free_result($request);
        if($results > 0) $hilite = 0;
            else $hilite = 1;
        ...
        $request = db_query("
            INSERT INTO {$db_prefix}garage_laps_gallery (vehicle_id, lap_id, image_id, hilite)
            VALUES (".$context['vehicle_id'].", ".$context['LID'].", ".$context['image_id'].", ".$hilite.")",__FILE__,__LINE__);          
...
function G_Remove_Video()
{
    ...
    $request = db_query("
        ...
        WHERE id = ".$_GET['video_id'],__FILE__,__LINE__);
        
    $request = db_query("
        DELETE FROM {$db_prefix}garage_video_gallery
        WHERE video_id = ".$_GET['video_id'],__FILE__,__LINE__);
...
function G_Set_Main_Vehicle()
{
    ...
    $request = db_query(" 
          ...
          WHERE user_id = ".$_GET['user_id']." 
            AND main_vehicle = 1",__FILE__,__LINE__); 
      list($context['main_vehicle']['VID']) = mysql_fetch_row($request); 
      mysql_free_result($request); 
      ...
      if (isset($context['main_vehicle']['VID']) && $context['main_vehicle']['VID'] > 0) { 
          $request = db_query(" 
              UPDATE {$db_prefix}garage_vehicles
              SET main_vehicle = 0 
              WHERE id = ".$context['main_vehicle']['VID'],__FILE__,__LINE__); 
      } 
...
function G_Set_Hilite_Image()
{
    ...
    // Check if there is already a hilite 
      $request = db_query(" 
          ...
          WHERE vehicle_id = ".$_GET['VID']." 
            AND hilite = 1",__FILE__,__LINE__); 
      list($context['hilite']['image_id']) = mysql_fetch_row($request); 
      mysql_free_result($request); 
      ...
      if (isset($context['hilite']['image_id']) && $context['hilite']['image_id'] > 0) { 
          $request = db_query(" 
              ...
              SET hilite = 0 
              WHERE image_id = ".$context['hilite']['image_id'],__FILE__,__LINE__); 
      } 
...
function G_Set_Hilite_Image_Mod()
{
    ...
    // Check if there is already a hilite 
      $request = db_query(" 
          SELECT image_id 
          FROM {$db_prefix}garage_modifications_gallery 
          WHERE modification_id = ".$_GET['MID']." 
            AND hilite = 1",__FILE__,__LINE__); 
      list($context['hilite']['image_id']) = mysql_fetch_row($request); 
      mysql_free_result($request); 
...
function G_Update_Text()
{
    ...
    if(isset($_POST) && !empty($_POST)) {
        ...
        if(strpos($_POST['id'], 'image') !== FALSE) $type = 'image_desc';
        else if(strpos($_POST['id'], 'video_title') !== FALSE) $type = 'video_title';
        else $type = 'video_desc';    
        ...
        switch($type){
            case 'image_desc':
                ...
                $request = db_query("
                    ...
                    SET attach_desc = '".$_POST['content']."'
                    WHERE attach_id = ".$id,__FILE__,__LINE__);
                if (!$request) {
                    echo '0';
                    exit;
                } else {
...
function G_Update_Attach_Desc()
{
    ...
    $request = db_query("
        UPDATE {$db_prefix}garage_images
        SET attach_desc = '".$_POST['desc']."'
        WHERE attach_id = ".$_POST['image_id'],__FILE__,__LINE__);
    if (!$request) {
        echo '0';
        exit;
    } else {
...
function G_Update_Video_Desc()
{
    ...
    $request = db_query("
        UPDATE {$db_prefix}garage_video
        SET video_desc = '".$_POST['desc']."'
        WHERE id = ".$_POST['video_id'],__FILE__,__LINE__);
    if (!$request) {
        echo '0';
        exit;
    } else {
...
{    
    ...
    $request = db_query("
        INSERT INTO {$db_prefix}garage_ratings (vehicle_id, rating, user_id, rate_date) 
        VALUES (".$_POST['VID'].", ".$_POST['rating'].", ".$_POST['user_id'].", ".$context['date_created'].")", __FILE__, __LINE__);  
...
{    
    ...
    $request = db_query("
        SELECT user_id
        FROM {$db_prefix}garage_ratings
        WHERE id = ".$_GET['RID'],__FILE__,__LINE__);
    list($context['user_id']) = mysql_fetch_row($request);
    mysql_free_result($request);
...
function G_Submit_Make()
{
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="4" align="center" class="bordercolor">
        <tr>
            <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" nowrap="nowrap">'.$txt['smfg_submit_make'].'</td>
        </tr>
        ...
        <tr>
            ...
            <table width="100%" cellpadding="3" cellspacing="1" border="0" class="bordercolor">
                <tr>
                    <td class="windowbg2" width="30%" align="right"><b>'.$txt['smfg_make'].'</b>&nbsp;</td>
                    <td class="windowbg"><input name="make" type="text" size="15" value="" /></td>
                </tr>
                <tr>
                    <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" height="28" colspan="2"><input type="hidden" name="redirecturl" value="', $_SESSION['old_url'], '" /><input type="hidden" name="sc" value="', $context['session_id'], '" /><input name="submit" type="submit" value="'.$txt['smfg_submit_make'].'" /></td>
                </tr>      
            </table>
            </form>
...
function G_Submit_Model()
{
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="4" align="center" class="bordercolor">
        <tr>
            <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" nowrap="nowrap">'.$txt['smfg_submit_model'].'</td>
        </tr>
        ...
        <tr>
            ...
            <table width="100%" cellpadding="3" cellspacing="1" border="0" class="bordercolor">
                ...
                <tr>
                    <td class="windowbg2" width="30%" align="right"><b>'.$txt['smfg_submit_model'].'</b>&nbsp;</td>
                    <td class="windowbg"><input name="model" type="text" size="15" value="" /></td>
                </tr>
                <tr>
                    <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" height="28" colspan="2"><input type="hidden" name="redirecturl" value="', $_SESSION['old_url'], '" /><input type="hidden" name="sc" value="', $context['session_id'], '" /><input name="submit" type="submit" value="'.$txt['smfg_submit_model'].'" /></td>
                </tr>      
            </table>
            </form>
            <script language="JavaScript" type="text/javascript">
...
function G_Submit_Business()
{
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="4" align="center" class="bordercolor">
        <tr>
            <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" nowrap="nowrap">'.$txt['smfg_submit_business'].'</td>
        </tr>
        ...
        <tr>
            ...
            <table width="100%" cellpadding="3" cellspacing="1" border="0" class="bordercolor">
                ...
                <tr>
                    <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" height="28" colspan="2"><input type="hidden" name="redirecturl" value="', $_SESSION['old_url'], '" /><input type="hidden" name="sc" value="', $context['session_id'], '" /><input name="submit" type="submit" value="'.$txt['smfg_submit_business'].'" /></td>
                </tr>      
            </table>
            </form>
            <script language="JavaScript" type="text/javascript"> 
...
function G_Submit_Product()
{
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="4" align="center" class="bordercolor">
        <tr>
            <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" nowrap="nowrap">'.$txt['smfg_submit_product'].'</td>
        </tr>
        ...
        <tr>
            ...
            <table width="100%" cellpadding="3" cellspacing="1" border="0" class="bordercolor">
                <tr>
                    <td class="windowbg2" width="30%" align="right"><b>'.$txt['smfg_category'].'</b>&nbsp;</td>
                    <td class="windowbg"><select id="category_id" name="category_id">
                ...
                <tr>
                    <td class="windowbg2" width="30%" align="right"><b>'.$txt['smfg_manufacturer'].'</b>&nbsp;</td>
                    <td class="windowbg"><select id="manufacturer_id" name="manufacturer_id">
                ...
                <tr>
                    <td class="windowbg2" width="30%" align="right"><b>'.$txt['smfg_product'].'</b>&nbsp;</td>
                    <td class="windowbg"><input name="product" type="text" size="15" value="" /></td>
                </tr>
                <tr>
                    <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" height="28" colspan="2"><input type="hidden" name="redirecturl" value="', $_SESSION['old_url'], '" /><input type="hidden" name="sc" value="', $context['session_id'], '" /><input name="submit" type="submit" value="'.$txt['smfg_submit_product'].'" /></td>
                </tr>      
            </table>
            </form>
            <script language="JavaScript" type="text/javascript">
...
function G_Submit_Track()
{
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="4" align="center" class="bordercolor">
        <tr>
            <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" nowrap="nowrap">'.$txt['smfg_submit_track'].'</td>
        </tr>
        ...
        <tr>
            ...
            <table width="100%" cellpadding="3" cellspacing="1" border="0" class="bordercolor">
                <tr>
                    <td class="windowbg2" width="30%" align="right"><b>'.$txt['smfg_track'].'</b>&nbsp;</td>
                    <td class="windowbg"><input name="track" type="text" size="15" value="" /></td>
                </tr>
                <tr>
                    <td class="windowbg2" width="30%" align="right"><b>'.$txt['smfg_length'].'</b>&nbsp;</td>
                    <td class="windowbg"><input class="medium" type="text" id="length" name="length" value="" maxlength="255" /></td>
                </tr>
                <tr>
                    <td class="windowbg2" width="30%" align="right"><b>'.$txt['smfg_mileage_unit'].'</b>&nbsp;</td>
                    <td class="windowbg"><select name="mileage_unit" id="mileage_unit">
                        <option value="">------</option>
                ...
                <tr>
                    <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" height="28" colspan="2"><input type="hidden" name="redirecturl" value="', $_SESSION['old_url'], '" /><input type="hidden" name="sc" value="', $context['session_id'], '" /><input name="submit" type="submit" value="'.$txt['smfg_submit_track'].'" /></td>
                </tr>      
            </table>
            </form>
            <script language="JavaScript" type="text/javascript">
...
function G_Submit_Make_Insert()
{
    ...
    if($smfgSettings['enable_make_approval']) $pending = '1';
        else $pending = '0';
    
    // Insert the make
    $request = db_query("
        INSERT INTO {$db_prefix}garage_makes (make, pending)
        VALUES ('".$_POST['make']."', '".$pending."')",__FILE__,__LINE__);
...
function G_Submit_Model_Insert()
{
    ...
    // Check if submissions need approval
    if($smfgSettings['enable_model_approval']) $pending = '1';
        else $pending = '0';
    
    // Insert the model
    $request = db_query("
        INSERT INTO {$db_prefix}garage_models (make_id, model, pending)
        VALUES (".$_POST['make_id'].", '".$_POST['model']."', '".$pending."')",__FILE__,__LINE__);
...
function G_Submit_Business_Insert()
{
    ...
    foreach($_POST['type'] as $type) {
        ...
        $request = db_query("
            ...
            WHERE title = '".$_POST['title']."'
                AND ".$type." = 1",__FILE__,__LINE__);
        $matching_type = mysql_num_rows($request);
        mysql_free_result($request);
    ...
    // Check if submissions need approval
    if($smfgSettings['enable_business_approval']) $pending = '1';
        else $pending = '0';
    ...
    if ($matching_business > 0) {
        ...
        $request = db_query("
            ...
            SET ".$typestring."pending = '".$pending."'
            WHERE title = '".$_POST['title']."'",__FILE__,__LINE__);
    } else {
        // Insert the business
        $request = db_query("
            ...
            VALUES ('".$_POST['title']."', '".$_POST['address']."', '".$_POST['telephone']."', '".$_POST['fax']."', '".$_POST['website']."', '".$_POST['email']."', '".$_POST['opening_hours']."', ". ($typeval['product'] ? 1 : 0) .", ". ($typeval['retail'] ? 1 : 0) .", ". ($typeval['garage'] ? 1 : 0) .", ". ($typeval['insurance'] ? 1 : 0) .", ". ($typeval['dynocenter'] ? 1 : 0) .", '".$pending."')",__FILE__,__LINE__);
    }
...
function G_Submit_Product_Insert()
{
    ...
    $request = db_query("
        ...
        WHERE business_id = ".$_POST['manufacturer_id']."
            AND category_id = ".$_POST['category_id']."
            AND title = '".$_POST['product']."'",__FILE__,__LINE__);
    ...
    // Check if submissions need approval
    if($smfgSettings['enable_product_approval']) $pending = '1';
        else $pending = '0';
    
    // Insert the product
    $request = db_query("
        INSERT INTO {$db_prefix}garage_products (business_id, category_id, title, pending)
        VALUES (".$_POST['manufacturer_id'].", ".$_POST['category_id'].", '".$_POST['product']."', '".$pending."')",__FILE__,__LINE__);
...
function G_Submit_Track_Insert()
{
    ...
    $request = db_query("
        SELECT title
        FROM {$db_prefix}garage_tracks
        WHERE title = '".$_POST['track']."'",__FILE__,__LINE__);
    ...
    // Check if submissions need approval
    if($smfgSettings['enable_track_approval']) $pending = '1';
        else $pending = '0';
    
    // Insert the make
    $request = db_query("
        INSERT INTO {$db_prefix}garage_tracks (title, length, mileage_unit, pending)
        VALUES ('".$_POST['track']."', '".$_POST['length']."', '".$_POST['mileage_unit']."', '".$pending."')",__FILE__,__LINE__);
...
function G_Garage_Card()
{
    ...
    if(isset($_GET['user']) && !empty($_GET['user'])){
        ...
        $request = db_query("
            ...
            WHERE u.memberName = '".$user."'
                ...
                AND v.main_vehicle",__FILE__,__LINE__);
        // check to see if the username submitted is valid
        $num_results = mysql_num_rows($request);
        if($num_results == 0){
    ...
    $request = db_query( "
        ...
        LEFT OUTER JOIN (
                            SELECT vehicle_id, ".$ratingfunc."( rating ) AS rating, COUNT( id ) AS poss_rating
                            FROM {$db_prefix}garage_ratings
        ...
        WHERE v.id = ".$VID."
            ...
            AND v.model_id = md.id
            AND v.currency = c.id
        GROUP BY Vehicle",__FILE__,__LINE__);
    ...
    while($g_card = mysql_fetch_array($request))
    {
        $user_name = $g_card['memberName'];
        $vehicle = $g_card['Vehicle'];
    $maxlinelen = 22;
    if (strlen($vehicle) > $maxlinelen) {
        $vehicle_array = split(" ", $vehicle);
        $linelen = 0;
        $lineno = 0;
        $vehicle = ARRAY();
        foreach ($vehicle_array AS $vehicle_word) {
            // Make sure the word fits at least of just give up now
    ...
    if($smfgSettings['rating_system'] == 0)
        ...
        if($poss_rating != 0) $poss_rating = 10;
    ...
    if(isset($thumb) && !empty($thumb)){
        if($is_remote) {
            ...
            if(url_validate($thumb)) getRemoteImage($thumb,$target);
                else $veh_image_thumb = $boarddir."/Themes/default/images/no_image.png";
            $veh_image_thumb = $target;
        } else {
            $veh_image_thumb = $boarddir."/".$smfgSettings['upload_directory'].$thumb;
        }
    } else {
        $veh_image_thumb = $boarddir."/Themes/default/images/no_image.png";
    }
    ...
    if(isset($style) && $style == "1") {
        ...
        $bgtextcolorg = "255";
        $bgtextcolorb = "255";
    } else if(isset($style) && $style == "2") { //end style 1 start style 2
        ...
        $bgtextcolorg = "255";
        $bgtextcolorb = "255";
    } else if(isset($style) && $style == "3") { //end style 2 start style 3
        ...
        $bgtextcolorg = "255";
        $bgtextcolorb = "255";
    } else if(isset($style) && $style == "4") { //end style 3 start style 4
    ...
    imagecopyresized($thumb_image, $overlay_image_source, 0, 0, 0, 0, $new_thumb_width, $new_thumb_height, $thumb_width, $thumb_height);
    ...
    if($smfgSettings['gcard_watermark']) {
        ...
        else if($wm_image_type == "jpg")
            $watermark_source = imagecreatefromjpeg($watermark); 
        else if ($wm_image_type == "png")   
            $watermark_source = imagecreatefrompng($watermark);
        // Since style 1 just had to be different, lets move it a tad over
        if(isset($style) && $style == "1") imagecopy($img_bg, $watermark_source, ($x_coor)-6, ($y_coor)-6, 0, 0, $wm_width, $wm_height);
            else imagecopy($img_bg, $watermark_source, $x_coor, $y_coor, 0, 0, $wm_width, $wm_height);
    }     
    Header("Content-type: image/png");
    Imagepng($img_bg);
    ImageDestroy($img_bg);
    if($is_remote) unlink($target);
    exit;
...
function G_Get_Garage_Card()
{
    ...
    $request = db_query("
        SELECT memberName
        FROM {$db_prefix}members
        WHERE ID_MEMBER = ".$_REQUEST['u'],__FILE__,__LINE__);
    ...
    $request = db_query("
        SELECT id
        FROM {$db_prefix}garage_vehicles
        WHERE user_id = ".$_REQUEST['u']."
        AND main_vehicle = 1",__FILE__,__LINE__);
    $row = mysql_fetch_array($request);
    $VID = $row['id'];
    mysql_free_result($request);
    
    //echo '<div class="smalltext">'.$txt['smfg_gcard_info'].'</div><br />';
          
    echo '
    <table border="0" cellspacing="1" cellpadding="4" align="center" class="bordercolor" style="width: 505px;">
        <tr>
            <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" nowrap="nowrap">'.$txt['smfg_g_sig_cards'].'</td>
        </tr>
        <tr>
            ...
            <br />
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_1_bb" id="style_1_bb" type="text" size="58" readonly="readonly" value="[img]'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=1[/img]" onClick="this.select();" /></div>'.$txt['smfg_bbcode'].':</div>
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_1_bblink" id="style_1_bblink" type="text" size="58" readonly="readonly" value="[url='.$scripturl.'?action=garage;sa=view_vehicle;VID='.$VID.'][img]'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=1[/img][/url]" onClick="this.select();" /></div>'.$txt['smfg_bbcode_link'].':</div>
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_1_htmllink" id="style_1_htmllink" type="text" size="58" readonly="readonly" value="<a href=&quot;'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$VID.'&quot;><img src=&quot;'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=1&quot; /></a>" onClick="this.select();" /></div>'.$txt['smfg_html_link'].':</div>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle">
            ...
            <br />
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_2_bb" id="style_2_bb" type="text" size="58" readonly="readonly" value="[img]'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=2[/img]" onClick="this.select();" /></div>'.$txt['smfg_bbcode'].':</div>
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_2_bblink" id="style_2_bblink" type="text" size="58" readonly="readonly" value="[url='.$scripturl.'?action=garage;sa=view_vehicle;VID='.$VID.'][img]'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=2[/img][/url]" onClick="this.select();" /></div>'.$txt['smfg_bbcode_link'].':</div>
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_2_htmllink" id="style_2_htmllink" type="text" size="58" readonly="readonly" value="<a href=&quot;'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$VID.'&quot;><img src=&quot;'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=2&quot; /></a>" onClick="this.select();" /></div>'.$txt['smfg_html_link'].':</div>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle">
            ...
            <br />
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_3_bb" id="style_3_bb" type="text" size="58" readonly="readonly" value="[img]'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=3[/img]" onClick="this.select();" /></div>'.$txt['smfg_bbcode'].':</div>
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_3_bblink" id="style_3_bblink" type="text" size="58" readonly="readonly" value="[url='.$scripturl.'?action=garage;sa=view_vehicle;VID='.$VID.'][img]'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=3[/img][/url]" onClick="this.select();" /></div>'.$txt['smfg_bbcode_link'].':</div>
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_3_htmllink" id="style_3_htmllink" type="text" size="58" readonly="readonly" value="<a href=&quot;'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$VID.'&quot;><img src=&quot;'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=3&quot; /></a>" onClick="this.select();" /></div>'.$txt['smfg_html_link'].':</div>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle">
            ...
            <br />
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_4_bb" id="style_4_bb" type="text" size="58" readonly="readonly" value="[img]'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=1[/img]" onClick="this.select();" /></div>'.$txt['smfg_bbcode'].':</div>
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_4_bblink" id="style_4_bblink" type="text" size="58" readonly="readonly" value="[url='.$scripturl.'?action=garage;sa=view_vehicle;VID='.$VID.'][img]'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=4[/img][/url]" onClick="this.select();" /></div>'.$txt['smfg_bbcode_link'].':</div>
            <div style="padding:2px; text-align: left; width: 100%;"><div style="float:right"><input name="style_4_htmllink" id="style_4_htmllink" type="text" size="58" readonly="readonly" value="<a href=&quot;'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$VID.'&quot;><img src=&quot;'.$scripturl.'?action=garage;sa=gcard;user='.$username.';style=4&quot; /></a>" onClick="this.select();" /></div>'.$txt['smfg_html_link'].':</div>
            </td>
        </tr>
    </table>';
    exit;
...
function G_Video()
{
    ...
    $request = db_query("
        ...
        WHERE id = ".$_GET['id']."
        LIMIT 1",__FILE__,__LINE__);
    list($video_url, $video_title, $video_desc) = mysql_fetch_row($request);
    mysql_free_result($request);
...
function G_Supported_Video()
{
    ...
    //echo '<div class="smalltext">'.$txt['smfg_video_instructions'].'</div><br />';
    
    echo '
    <table border="0" cellspacing="1" cellpadding="4" align="center" width="100%" class="bordercolor">
        <tr>
            <td class="', empty($settings['use_tabs']) ? 'catbg' : 'titlebg', '" align="center" nowrap="nowrap">'.$txt['smfg_supported_videos'].'</td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.123video.nl/" target="new">123Video.nl</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.aniboom.com/" target="new">Aniboom</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://uncutvideo.aol.com/" target="new">AOL Uncut</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.atomfilms.com/" target="new">AtomFilms Uploads</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.biku.com/" target="new">Biku</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.brightcove.com/" target="new">BrightCove</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.cellfish.com/" target="new">CellFish</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.clipfish.de/" target="new">ClipFish.de</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.collegehumor.com/" target="new">CollegeHumor</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.dailymotion.com/" target="new">DailyMotion</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://dave.tv/" target="new">Dave.tv</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://dv.ouou.com" target="new">dv.ouou</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://sports.espn.go.com/broadband/video/" target="new">ESPN</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.gametrailers.com/" target="new">GameTrailers</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.gamevideos.com/" target="new">GameVideos</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.glumbert.com/" target="new">Glumbert</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.godtube.com/" target="new">GodTube</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://video.google.com/" target="new">Google Video</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.guba.com/" target="new">Guba</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.hulu.com/" target="new">Hulu</a> (US Only)
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.koreus.com/videos.php" target="new">Koreus</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://arianna.libero.it/hpvideo.html" target="new">Libero.it</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.liveleak.com/" target="new">LiveLeak</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.livevideo.com/" target="new">LiveVideo</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.megavideo.com/" target="new">Megavideo</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.metacafe.com/" target="new">MetaCafe</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://video.msn.com/" target="new">MSN Live/Soapbox Video</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://tv.mofile.com/" target="new">Mofile</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.mthai.com/" target="new">MThai</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://vids.myspace.com/" target="new">MySpaceTV</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.myvideo.de/" target="new">MyVideo.de</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.onsmash.com/" target="new">OnSmash</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.revver.com/" target="new">Revver</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://en.sevenload.com/" target="new">Sevenload</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.stage6.com/" target="new">Stage6</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.streetfire.net/" target="new">Streetfire.net</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.tudou.com/" target="new">Tudou</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.veoh.com/" target="new">Veoh</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.videotube.de/" target="new">Videotube.de</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.vidiac.com/" target="new">Vidiac</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.vidmax.com/" target="new">VidMax</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.vimeo.com/" target="new">Vimeo</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.vsocial.com/" target="new">VSocial</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://tv.yahoo.com/" target="new">Yahoo</a>/<a href="http://hk.yahoo.com/">Yahoo HK</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.youku.com" target="new">Youku</a>
            </td>
        </tr>
        <tr>
            <td class="windowbg" align="center" valign="middle"><a href="http://www.youtube.com" target="new">YouTube/YouTube Playlists</a>
            </td>
        </tr>
    </table>';
    exit;
