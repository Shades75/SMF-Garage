...
**********************************************************************************/
 ...
 {   
   ...
   $result = db_query("
        ...
        ORDER BY model ASC", __FILE__,__LINE__);
   while($row = mysql_fetch_array($result)) { 
 ...
 { 
     ...
     loadLanguage('Garage');
        ...
        for($i=$start_year; $i<=$end_year; $i++) { 
          if($current == $i) $year_options .= "<option value=\"" . $i . "\" selected=\"selected\">" . $i . "</option>\n        "; 
          else $year_options .= "<option value=\"" . $i . "\">" . $i . "</option>\n        "; 
        } 
        return $year_options; 
 }
 ...
 {   
   ...
   $request = db_query("
        ...
        WHERE {$db_prefix}garage_products.business_id = {$db_prefix}garage_business.id",__FILE__,__LINE__);
   $count = 0;
   ...
   list($man_opts[$count]['category_id']) = $row; 
        ...
        $request2 = db_query("
            ...
            WHERE {$db_prefix}garage_products.business_id = {$db_prefix}garage_business.id 
                AND ".$man_opts[$count]['category_id']." = {$db_prefix}garage_products.category_id
                ORDER BY {$db_prefix}garage_business.title ASC",__FILE__,__LINE__);
        $count2 = 0;
        while($row2 = mysql_fetch_row($request2)) {
        list($man_opts[$count2]['title'],
             $man_opts[$count2]['business_id']) = $row2;
        if($count2 > 0) $separator = ", ";
        else $separator = "";
        ...
        $request2 = db_query("
            ...
            FROM {$db_prefix}garage_products, {$db_prefix}garage_business 
            WHERE {$db_prefix}garage_products.business_id = {$db_prefix}garage_business.id 
                AND ".$man_opts[$count]['category_id']." = {$db_prefix}garage_products.category_id",__FILE__,__LINE__);
        $count3 = 0;
        ...
        list($man_opts[$count3]['business_id']) = $row2;
             ...
             $request3 = db_query("
                ...
                WHERE category_id = ".$man_opts[$count]['category_id']."
                    AND business_id = ".$man_opts[$count3]['business_id']."
                    ORDER BY title ASC",__FILE__,__LINE__);
             $count4 = 0;
             while($row3 = mysql_fetch_row($request3)) {
                 list($prod_opts[$count4]['id'],
                      $prod_opts[$count4]['title']) = $row3;
             $prod_opts[$count4]['title'] = str_replace('"', '\"', $prod_opts[$count4]['title']);
             if($count4 > 0) $separator = ", ";
             else $separator = "";
 ...
 { 
   ...
   $result = db_query("
        ...
        ORDER BY title ASC",__FILE__, __LINE__); 
   $count = 0;
   while($row[$count] = mysql_fetch_array($result)) { 
 ...
 { 
   ...
   $dynoqm_select = ''; 
    ...
    $result = db_query("
        ...
        WHERE vehicle_id = ".$VID,__FILE__,__LINE__);
   while($row = mysql_fetch_array($result)) { 
 ...
 {  
    global $smfgSettings;
      ...
      // Apply watermark
      imagecopymerge($newimageres, $watermarkres, $dest_x, $dest_y, 0, 0, $watermark_width, $watermark_height, $smfgSettings['watermark_opacity']);
...
//                echo "HTTP-Response: $http_response<br>";
 ...
 function model_divs()
 {
  ...
  $request = db_query("
    ...
    while($row = mysql_fetch_row($request)) {
        ...
        if($context['makes'][$count]['id_length'] == 1) $context['makes'][$count]['name'] = "00".$context['makes'][$count]['id'];
        else if($context['makes'][$count]['id_length'] == 2) $context['makes'][$count]['name'] = "0".$context['makes'][$count]['id'];
        else if($context['makes'][$count]['id_length'] == 3) $context['makes'][$count]['name'] = $context['makes'][$count]['id'];
        ...
        $request2 = db_query("
            ...
            FROM {$db_prefix}garage_models
            WHERE make_id = ".$context['makes'][$count]['id']."
            ORDER BY model ASC",__FILE__,__LINE__);
            $count2 = 0;
            while($row2 = mysql_fetch_row($request2)) {
                ...
                $output .= '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['models'][$count][$count2]['title'].'</td>
                                    ...
                                    if($context['models'][$count][$count2]['pending'] == '1') {
                                        ...
                                        $output .= '<form action="'.$scripturl.'?action=garagemanagement;sa=model_approve;mdid='.$context['models'][$count][$count2]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_model_'.$context['models'][$count][$count2]['id'].'" id="approve_model_'.$context['models'][$count][$count2]['id'].'" style="display: inline;">
                                        ...
                                        $output .= '<form action="'.$scripturl.'?action=garagemanagement;sa=model_disable;mdid='.$context['models'][$count][$count2]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_model_'.$context['models'][$count][$count2]['id'].'" id="disable_model_'.$context['models'][$count][$count2]['id'].'" style="display: inline;">
                                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels#models" />
                                    ...
                                    $output .= '<a href="'.$scripturl.'?action=garagemanagement;sa=model_edit;mdid='.$context['models'][$count][$count2]['id'].'"><img src="'. $settings['default_images_url'] . '/icon_edit.gif" alt="Edit" title="Edit" /></a>';
                                    $output .= '<form action="'.$scripturl.'?action=garagemanagement;sa=model_delete;mdid='.$context['models'][$count][$count2]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_model_'.$context['models'][$count][$count2]['id'].'" id="remove_model_'.$context['models'][$count][$count2]['id'].'" style="display: inline;">
                                                    <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels#models" />
 ...
 function product_divs()
 {
  ...
  $request = db_query("
    ...
    while($row = mysql_fetch_row($request)) {
        ...
        if($context['manufacturers'][$count]['id_length'] == 1) $context['manufacturers'][$count]['name'] = "00".$context['manufacturers'][$count]['id'];
        else if($context['manufacturers'][$count]['id_length'] == 2) $context['manufacturers'][$count]['name'] = "0".$context['manufacturers'][$count]['id'];
        else if($context['manufacturers'][$count]['id_length'] == 3) $context['manufacturers'][$count]['name'] = $context['manufacturers'][$count]['id'];
        ...
        $request2 = db_query("
            ...
            WHERE p.business_id = ".$context['manufacturers'][$count]['id']."
                AND p.category_id = c.id
                ORDER BY c.field_order ASC",__FILE__,__LINE__);
            $count2 = 0;
            while($row2 = mysql_fetch_row($request2)) {
                list($context['categories'][$count2]['id'],
                     $context['categories'][$count2]['title']) = $row2; 
                     
                     $output .= '<tr class="tborder">
                                        <td class="catbg" colspan="2">'.$context['categories'][$count2]['title'].'</td>
                                 </tr>';
                                 
                     $request3 = db_query("
                        SELECT id, title, pending
                        FROM {$db_prefix}garage_products
                        WHERE business_id = ".$context['manufacturers'][$count]['id']."
                            AND category_id = ".$context['categories'][$count2]['id'],__FILE__,__LINE__);
                        $count3 = 0;
                        while($row3 = mysql_fetch_row($request3)) {
                            ...
                            $output .= '
                                <tr class="windowbg">
                                    <td align="left" width="95%" valign="middle" class="windowbg2">'.$context['products'][$count3]['title'].'</td>
                                    <td align="right" valign="middle" nowrap="nowrap">';
                                    
                                    if($context['products'][$count3]['pending'] == '1') {
                                        $output .= '<img src="'. $settings['default_images_url'] . '/icon_garage_disapprove_disabled.gif" alt="Disapprove" title="Disapprove" />';
                                        $output .= '<form action="'.$scripturl.'?action=garagemanagement;sa=product_approve;pid='.$context['products'][$count3]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_product_'.$context['products'][$count3]['id'].'" id="approve_product_'.$context['products'][$count3]['id'].'" style="display: inline;">
                                        ...
                                        $output .= '<form action="'.$scripturl.'?action=garagemanagement;sa=product_disable;pid='.$context['products'][$count3]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_product_'.$context['products'][$count3]['id'].'" id="disable_product_'.$context['products'][$count3]['id'].'" style="display: inline;">
                                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=products" />
                                    ...
                                    $output .= '<a href="'.$scripturl.'?action=garagemanagement;sa=product_edit;pid='.$context['products'][$count3]['id'].'"><img src="'. $settings['default_images_url'] . '/icon_edit.gif" alt="Edit" title="Edit" /></a>';
                                    $output .= '<form action="'.$scripturl.'?action=garagemanagement;sa=product_delete;pid='.$context['products'][$count3]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_product_'.$context['products'][$count3]['id'].'" id="remove_product_'.$context['products'][$count3]['id'].'" style="display: inline;">
                                                    <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=products" />
 ...
 function checkOwner($VID)
 {
    ...
    // Make sure this is their vehicle, dont want people editting other peoples vehicles do we?
    // Well, only if they are allowed to...
    $request = db_query("
        SELECT user_id
        FROM {$db_prefix}garage_vehicles
        WHERE id = ".$VID,__FILE__,__LINE__);
             ...
             if($gallery == 'garage') {
                 ...
                 $request = db_query("
                    ...
                    WHERE vehicle_id = ".$VID."
                        AND modification_id = ".$id,__FILE__,__LINE__);         
             } else if($gallery == 'qmile') {  
                 $request = db_query("
                    SELECT COUNT(id)
                    FROM {$db_prefix}garage_quartermiles_gallery
                    WHERE vehicle_id = ".$VID."
                        AND quartermile_id = ".$id,__FILE__,__LINE__);        
             } else if($gallery == 'dynorun') {   
                 $request = db_query("
                    SELECT COUNT(id)
                    FROM {$db_prefix}garage_dynoruns_gallery
                    WHERE vehicle_id = ".$VID."
                        AND dynorun_id = ".$id,__FILE__,__LINE__);       
             } else if($gallery == 'lap') {    
                 $request = db_query("
                    SELECT COUNT(id)
                    FROM {$db_prefix}garage_laps_gallery
                    WHERE vehicle_id = ".$VID."
                        AND lap_id = ".$id,__FILE__,__LINE__);      
             }
             list($context['total']) = mysql_fetch_row($request);
             mysql_free_result($request);
         ...
         case 'video':  
             if($gallery == 'garage') {
                 ...
                 $request = db_query("
                    ...
                    WHERE vehicle_id = ".$VID."
                        AND type = 'mod'
                        AND type_id = ".$id,__FILE__,__LINE__);         
             } else if($gallery == 'qmile') {  
                 $request = db_query("
                    SELECT COUNT(id)
                    FROM {$db_prefix}garage_video_gallery
 ...
 function checkQuota($user_id)
 {
     ...
     list($total_vehicles) = mysql_fetch_row($request);
 ...
 {
     global $db_prefix, $smfgSettings, $modSettings;
    ...
    // From Block
    else if($smfgSettings['enable_featured_vehicle'] == 2) {
        ...
        if($smfgSettings['featured_vehicle_from_block'] == 1) {
            ...
            list($VID) = mysql_fetch_row($request);
            mysql_free_result($request);    
        ...
        // Last Update Vehicle
        else if($smfgSettings['featured_vehicle_from_block'] == 2) {
        ...
        // Newest Modification
        else if($smfgSettings['featured_vehicle_from_block'] == 3) {
        ...
        else if($smfgSettings['featured_vehicle_from_block'] == 4) {
        ...
        else if($smfgSettings['featured_vehicle_from_block'] == 5) {
        ...
        // Most Money Spent
        else if($smfgSettings['featured_vehicle_from_block'] == 6) {
        ...
        // Most Viewed Vehicle
        else if($smfgSettings['featured_vehicle_from_block'] == 7) {
        ...
        else if($smfgSettings['featured_vehicle_from_block'] == 8) {
        ...
        // Top Quartermile
        else if($smfgSettings['featured_vehicle_from_block'] == 9) {
        ...
        // Top Dynorun
        else if($smfgSettings['featured_vehicle_from_block'] == 10) {
        ...
        // Top Rated Vehicle
        else if($smfgSettings['featured_vehicle_from_block'] == 11) {
        ...
        // Top Laptime
        else if($smfgSettings['featured_vehicle_from_block'] == 12) {
    ...
    // Random
    else if($smfgSettings['enable_featured_vehicle'] == 3) {
 ...
 {
     global $context, $smfgSettings, $txt, $db_prefix;
    ...
    if($smfgSettings['enable_pm_pending_notify']) {
        ...
        // Get sender info
        $request = db_query("
            SELECT memberName, realName, emailAddress
            FROM {$db_prefix}members
            WHERE ID_MEMBER = ".$smfgSettings['pending_sender'],__FILE__,__LINE__);
        ...
        if (!empty($recipients['to']) || !empty($recipients['bcc']))
            $context['send_log'] = sendpm($recipients, $smfgSettings['pending_subject'], $txt['smfg_pending_PM'], false, $sender);
        else
    ...
    if($smfgSettings['enable_email_pending_notify']) {   
        ...
        $request = db_query("
            ...
            WHERE n.email_opt_out != 1
                AND n.user_id = u.ID_MEMBER",__FILE__,__LINE__);
        $count = 0;
        while($row = mysql_fetch_row($request)) {
            $to[$count] = $row[0];
            $count++;
 ...
 {    
    ...
    $request = db_query("
            ...
            FROM {$db_prefix}garage_config", false, false);
        $smfgSettings = array();
        if (!$request)
            db_fatal_error();
        while ($row = mysql_fetch_row($request))
 ...
 function smfg_footer()
 {
  ...
  $output =  '
    <table border="0" width="100%">
        ...
        <tr>
            <td align="center">
            <span class="smalltext"><a href="http://www.smfgarage.com" target="_blank">'.$txt['smfg_powered_by'].' '.$smfgSettings['version'].'</a> | <a href="'.$scripturl.'?action=garage;sa=copyright">'.$txt['smfg_copy'].' 2007-2009</a></span>
            </td>
        </tr>
    </table>';
 ...
 {    
    ...
    {            
        ...
        if($arr['enabled'])
        {
            ...
            if($arr['name'] == 'Stage6') $pattern = '#'.$arr['pattern'].'(?:.*)#i';
                else $pattern = '#'.$arr['pattern'].'(?:.*?)#i';
 ...
 function browse_tables($browse_type)
{
    ...
    } else if($browse_type == 'quartermiles') {
        $context['linktree'][] = array(
    ...
    } else if ($browse_type == "modifications") {
        $context['linktree'][] = array(
    ...
    if($browse_type == "vehicles") {
        ...
        $browse_selects .= "v.id, v.made_year, mk.make, md.model, v.color, v.user_id, u.realName, v.views, COUNT(m.id) as total_mods, v.date_updated";
        ...
        $browse_selects .= "v.id, v.made_year, mk.make, md.model, v.user_id, u.realName, m.id, p.title, b.title, c.title, m.date_updated";
        ...
        $browse_selects .= "q.id, v.id, CONCAT_WS( ' ', v.made_year, mk.make, md.model) AS vehicle, v.user_id, u.realName, q.rt, q.sixty, q.three, q.eighth, q.eighthmph, q.thou, q.quart, q.quartmph";
        ...
        $browse_selects .= "v.id, d.id, CONCAT_WS( ' ', v.made_year, mk.make, md.model) AS vehicle, v.user_id, u.realName, d.bhp, d.bhp_unit, d.torque, d.torque_unit, d.boost, d.boost_unit, d.nitrous, d.peakpoint, b.title, b.id";
        ...
        $browse_selects .= "v.id, CONCAT_WS( ' ', v.made_year, mk.make, md.model) AS vehicle, v.user_id, u.realName, l.track_id, t.title, tc.title, lt.title, l.id, CONCAT_WS(':',l.minute, l.second, l.millisecond) AS time";
        ...
        $browse_selects .= "v.id, COUNT( m.id ) AS total_mods, v.user_id, v.made_year, mk.make, md.model, u.realName";
        ...
        $browse_selects .= "v.id, v.made_year, mk.make, md.model, v.views, v.user_id, u.realName";
        ...
        $browse_selects .= "sh.vehicle_id, v.made_year, mk.make, md.model, v.user_id, u.realName, t.title, sh.date_created";
        ...
        $browse_selects .= "r.vehicle_id, ".$ratingfunc."( r.rating ) AS rating, COUNT( r.id ) * 10 AS poss_rating, v.made_year, mk.make, md.model, v.user_id, u.realName";
        ...
        $browse_selects .= "v.id, IFNULL(m.total_mods,0) + IFNULL(s.total_service,0) AS total_spent, v.made_year, mk.make, md.model, v.user_id, u.realName, c.title AS currency";
        ...
        $browse_selects .= "b.vehicle_id, b.blog_title, v.made_year, mk.make, md.model, v.user_id, u.realName, b.post_date";
        ...
        $browse_selects .= "b.id, b.vehicle_id, b.title, v.made_year, mk.make, md.model, v.user_id, u.realName, b2.type, b2.type_id, b.url, b.video_desc";
    ...
    if($browse_type == "vehicles") {
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=browse' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_browse'] .  ' &gt; ' . $txt['smfg_viewing_vehicles'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
            ...
            'name' => $txt['smfg_viewing_vehicles'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
            'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_vehicles'] . ')'
        );
        $context['browse_type_total'] = $txt['smfg_vehicles'];
    } else if($browse_type == 'quartermiles') {
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=quartermiles' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_quartmiles'] .  ' &gt; ' . $txt['smfg_viewing_quartermiles'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
            ...
            'name' => $txt['smfg_viewing_quartermiles'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
            'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_quartermiles'] . ')'
        );
        $context['browse_type_total'] = $txt['smfg_quartermiles_lower'];
    } else if($browse_type == 'dynoruns') {
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=dynoruns' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_dynoruns'] .  ' &gt; ' . $txt['smfg_viewing_dynoruns'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
            ...
            'name' => $txt['smfg_viewing_dynoruns'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
            'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_dynoruns'] . ')'
        );
        $context['browse_type_total'] = $txt['smfg_dynoruns_lower'];
    } else if ($browse_type == "laps") {
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=laptimes' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_laptimes'] .  ' &gt; ' . $txt['smfg_viewing_laps'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
            ...
            'name' => $txt['smfg_viewing_laps'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
            'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_laps'] . ')'
        );
        $context['browse_type_total'] = $txt['smfg_laps_lower'];
    } else if ($browse_type == "modifications") {
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=modifications' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_modifications'] .  ' &gt; ' . $txt['smfg_viewing_modifications'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
            ...
            'name' => $txt['smfg_viewing_modifications'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
            'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_mods'] . ')'
        );
        $context['browse_type_total'] = $txt['smfg_modifications_lower'];
    } else if ($browse_type == "mostmodified") {
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=mostmodified' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_most_modified'] .  ' &gt; ' . $txt['smfg_viewing_vehicles'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
        ...
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=mostviewed' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_most_viewed'] .  ' &gt; ' . $txt['smfg_viewing_vehicles'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
        ...
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=latestservice' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_latest_service'] .  ' &gt; ' . $txt['smfg_viewing_vehicles'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
        ...
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=toprated' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_top_rated'] .  ' &gt; ' . $txt['smfg_viewing_vehicles'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
        ...
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=mostspent' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_most_spent'] .  ' &gt; ' . $txt['smfg_viewing_vehicles'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
        ...
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=latestblog' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_latest_blog'] .  ' &gt; ' . $txt['smfg_viewing_entries'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
            ...
            'name' => $txt['smfg_viewing_entries'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
            'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_entries'] . ')'
        );
        $context['browse_type_total'] = $txt['smfg_entries_lower'];
    } else if ($browse_type == "latestvideo") {
        $context['page_index'] = constructPageIndex($scripturl . '?action=garage;sa=latestvideo' . (isset($_REQUEST['sort']) ? ';sort=' . $_REQUEST['sort'] : '') . (isset($_REQUEST['order']) ? ';order=' . $_REQUEST['order'] : ''), $_REQUEST['start'], $context['total'], $context['display']);
        $context['page_title'] = $txt['smfg_garage'] . ' &gt; '. $txt['smfg_latest_video'] .  ' &gt; ' . $txt['smfg_viewing_videos'] . ' ' . $context['start'] . ' ' . $txt[311] . ' ' . $context['end'];
        $context['linktree'][] = array(
            ...
            'name' => $txt['smfg_viewing_videos'] . ' ' . ($context['total'] == 0 ? $context['total'] : $context['start']) . ' ' . $txt[311] . ' ' . $context['end'] . '',
            'extra_after' => ' (' . $txt[309] . ' ' . $context['total'] . ' ' . $txt['smfg_total_videos'] . ')'
        );
            ...
            if($browse_type == "vehicles") {
                ...
                $context['browse_tables'][$count]['views'] = number_format($context['browse_tables'][$count]['views'], 0, '.', ',');
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_vehicles_gallery
                        WHERE vehicle_id = ".$context['browse_tables'][$count]['vid']."
                            AND hilite = 1",__FILE__,__LINE__);
                    list($context['browse_tables'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    ...
                    if(isset($context['browse_tables'][$count]['image_id'])) {
                        $request2 = db_query("
                            ...
                            WHERE attach_id = ".$context['browse_tables'][$count]['image_id'],__FILE__,__LINE__);
                        list($context['browse_tables'][$count]['attach_location'],
                             ...
                             $context['browse_tables'][$count]['is_remote']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                        if(empty($context['browse_tables'][$count]['attach_desc'])) $context['browse_tables'][$count]['attach_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                        
                        // Build appropriate links for remote images
                        if(isset($context['browse_tables'][$count]['attach_location']))
                        {
                            if($context['browse_tables'][$count]['is_remote'] == 1) $context['browse_tables'][$count]['attach_location'] = urldecode($context['browse_tables'][$count]['attach_location']);
                                else $context['browse_tables'][$count]['attach_location'] = $boardurl.'/'.$smfgSettings['upload_directory'].'cache/'.$context['browse_tables'][$count]['attach_location'];
                        }
                        // If there is an image attached, link to it
                        if(isset($context['browse_tables'][$count]['attach_location'])) $context['browse_tables'][$count]['image'] = "<a href=\"".$context['browse_tables'][$count]['attach_location']."\" rel=\"shadowbox\" title=\"".garage_title_clean($context['browse_tables'][$count]['made_year'].' '.$context['browse_tables'][$count]['make'].' '.$context['browse_tables'][$count]['model'].' :: '.$context['browse_tables'][$count]['attach_desc'])."\" class=\"smfg_imageTitle\"><img src=\"". $settings['default_images_url'] . "/garage_camera.gif\" width=\"16\" height=\"16\" /></a>";
                    }
                    ...
                    if($smfgSettings['enable_vehicle_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['browse_tables'][$count]['vid']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['browse_tables'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                        ...
                        if(isset($context['browse_tables'][$count]['video_id'])) {
                                ...
                                WHERE id = ".$context['browse_tables'][$count]['video_id'],__FILE__,__LINE__);
                        list($context['browse_tables'][$count]['video_url'],
                         $context['browse_tables'][$count]['video_title'],
                         $context['browse_tables'][$count]['video_desc']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                         if(empty($context['browse_tables'][$count]['video_desc'])) $context['browse_tables'][$count]['video_desc'] = '<i>'.$txt['smfg_no_desc'].'</i>';
                         $context['browse_tables'][$count]['video_height'] = displayVideo($context['browse_tables'][$count]['video_url'], 'height');
                         $context['browse_tables'][$count]['video_width'] = displayVideo($context['browse_tables'][$count]['video_url'], 'width');
                         if(!empty($context['browse_tables'][$count]['image_id']) && !empty($context['browse_tables'][$count]['video_id'])) $context['browse_tables'][$count]['spacer'] = '&nbsp;';
                    
                        // If there is an video attached, link to it
                        if(isset($context['browse_tables'][$count]['video_url'])) $context['browse_tables'][$count]['video'] = "<a href=\"".$scripturl."?action=garage;sa=video;id=".$context['browse_tables'][$count]['video_id']."\" rel=\"shadowbox;width=".$context['browse_tables'][$count]['video_width'].";height=".$context['browse_tables'][$count]['video_height']."\" title=\"".garage_title_clean('<b>'.$context['browse_tables'][$count]['video_title'].'</b> :: '.$context['browse_tables'][$count]['video_desc'])."\" class=\"smfg_videoTitle\"><img src=\"". $settings['default_images_url'] . "/garage_video.gif\" width=\"16\" height=\"16\" /></a>";
                        }
                ...
                list($context['browse_tables'][$count]['vid'],
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_modifications_gallery
                        WHERE modification_id = ".$context['browse_tables'][$count]['mid'],__FILE__,__LINE__);
                    list($context['browse_tables'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    // If there is an image, lets find its attributes
                    $context['browse_tables'][$count]['image'] = '';
                    ...
                    if($smfgSettings['enable_modification_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['browse_tables'][$count]['vid']."
                                    AND type = 'mod'
                                    AND type_id = ".$context['browse_tables'][$count]['mid']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['browse_tables'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                        ...
                        if(!empty($context['browse_tables'][$count]['manufacturer'])) $context['browse_tables'][$count]['mod_tooltip'] .= "<b>".$txt['smfg_manufacturer'].":</b> ".$context['browse_tables'][$count]['manufacturer'];
                        if(!empty($context['browse_tables'][$count]['category'])) $context['browse_tables'][$count]['mod_tooltip'] .= "<br /><b>".$txt['smfg_category'].":</b> ".$context['browse_tables'][$count]['category'];
                ...
                list($context['browse_tables'][$count]['qmid'],
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_quartermiles_gallery
                        WHERE quartermile_id = ".$context['browse_tables'][$count]['qmid'],__FILE__,__LINE__);
                    list($context['browse_tables'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    // If there is an image, lets find its attributes
                    $context['browse_tables'][$count]['image'] = '';
                    ...
                    if($smfgSettings['enable_quartermile_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['browse_tables'][$count]['vid']."
                                    AND type = 'qmile'
                                    AND type_id = ".$context['browse_tables'][$count]['qmid']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['browse_tables'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                ...
                list($context['browse_tables'][$count]['vid'],
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_dynoruns_gallery
                        WHERE dynorun_id = ".$context['browse_tables'][$count]['did'],__FILE__,__LINE__);
                    list($context['browse_tables'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    // If there is an image, lets find its attributes
                    $context['browse_tables'][$count]['image'] = '';
                    ...
                    if($smfgSettings['enable_dynorun_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['browse_tables'][$count]['vid']."
                                    AND type = 'dynorun'
                                    AND type_id = ".$context['browse_tables'][$count]['did']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['browse_tables'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                ...
                list($context['browse_tables'][$count]['vid'],
                    ...
                    $request2 = db_query("
                        SELECT image_id
                        FROM {$db_prefix}garage_laps_gallery
                        WHERE lap_id = ".$context['browse_tables'][$count]['lid'],__FILE__,__LINE__);
                    list($context['browse_tables'][$count]['image_id']) = mysql_fetch_row($request2);
                    mysql_free_result($request2);
                    // If there is an image, lets find its attributes
                    $context['browse_tables'][$count]['image'] = '';
                    ...
                    if($smfgSettings['enable_laptime_video']) {
                        ...
                        $request2 = db_query("
                                ...
                                WHERE vehicle_id = ".$context['browse_tables'][$count]['vid']."
                                    AND type = 'lap'
                                    AND type_id = ".$context['browse_tables'][$count]['lid']."
                                    ORDER BY id ASC
                                    LIMIT 1",__FILE__,__LINE__);
                        list($context['browse_tables'][$count]['video_id']) = mysql_fetch_row($request2);
                        mysql_free_result($request2);
                ...
                if($context['browse_tables'][$count]['rating'] > 0)
                    $context['browse_tables'][$count]['rating'] = number_format($context['browse_tables'][$count]['rating'], 2, '.', ',');
                else
                ...
                $context['browse_tables'][$count]['total_spent'] = number_format($context['browse_tables'][$count]['total_spent'], 2, '.', ',');
                ...
                $context['browse_tables'][$count]['video_height'] = displayVideo($context['browse_tables'][$count]['video_url'], 'height');
                $context['browse_tables'][$count]['video_width'] = displayVideo($context['browse_tables'][$count]['video_url'], 'width');
                if(isset($context['browse_tables'][$count]['video_url'])) $context['browse_tables'][$count]['video'] = "<a href=\"".$scripturl."?action=garage;sa=video;id=".$context['browse_tables'][$count]['id']."\" rel=\"shadowbox;width=".$context['browse_tables'][$count]['video_width'].";height=".$context['browse_tables'][$count]['video_height']."\" title=\"".garage_title_clean('<b>'.$context['browse_tables'][$count]['video_title'].'</b> :: '.$context['browse_tables'][$count]['video_desc'])."\" class=\"smfg_videoTitle\"><img src=\"". $settings['default_images_url'] . "/garage_video.gif\" width=\"16\" height=\"16\" /></a>";
            }
