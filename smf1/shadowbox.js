 ...
 * @version     SVN: $Id: shadowbox.js,v 1.4 2008/05/15 15:57:19 quake101 Exp $
 */
...
(function(){
    ...
    var options = {
         ...
         */
        loadingImage:       'Themes/default/images/garage_loading.gif',
         ...
         */
        overlayBgImage:     'Themes/default/images/overlay-85.png',
    ...
    var buildBars = function(){
        ...
        var new_title = link.title.split('::');
        title_i.innerHTML = '<b>' + new_title[0] + '</b> :: ' + new_title[1];
        // end smfg edit
        // empty the toolbar
