...
function template_manage_business()
{
    ...
    echo '
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="margin-left: 10px;" id="tab_table">
                    <tr id="tab_row">
                        ...
                        <td valign="top" class="mirrortab_active_back" id="tab000">
                            <a href="'.$scripturl.'?action=garagemanagement#garages" onclick="change_tab(\'000\');">'.$txt['smfg_garages'].'</a>
                        </td>
                        <td class="mirrortab_active_last" id="tab_active_right">&nbsp;</td>
                        <td valign="top" class="mirrortab_back" id="tab001">
                            <a href="'.$scripturl.'?action=garagemanagement#shops" onclick="change_tab(\'001\');">'.$txt['smfg_shops'].'</a>
                        </td>

                        <td valign="top" class="mirrortab_back" id="tab002">
                            <a href="'.$scripturl.'?action=garagemanagement#insurance" onclick="change_tab(\'002\');">'.$txt['smfg_insurance'].'</a>
                        </td>
                        <td valign="top" class="mirrortab_back" id="tab003">
                            <a href="'.$scripturl.'?action=garagemanagement#dynocenters" onclick="change_tab(\'003\');">'.$txt['smfg_dynocenters'].'</a>
                        </td>
                        <td valign="top" class="mirrortab_back" id="tab004">

                            <a href="'.$scripturl.'?action=garagemanagement#manufacturers" onclick="change_tab(\'004\');">'.$txt['smfg_manufacturers'].'</a>
                        </td>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_garages'].'</td>
                    ...
                    <tr>
                        ...
                        if(isset($context['garages'][$count]['id'])) {
                            while(isset($context['garages'][$count]['id'])) {
                                echo '
                                    <tr class="windowbg">
                                        <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['garages'][$count]['title'].'</td>
                                        ...
                                        if($context['garages'][$count]['pending'] == '1') {
                                            ...
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_approve;BID='.$context['garages'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_garage_'.$context['garages'][$count]['id'].'" id="approve_garage_'.$context['garages'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#garages" />
                                            ...
                                            echo '
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_disable;BID='.$context['garages'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_garage_'.$context['garages'][$count]['id'].'" id="disable_garage_'.$context['garages'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#garages" />
                                        ...
                                        echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=business_edit;BID='.$context['garages'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=garage_delete;BID='.$context['garages'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_garage_'.$context['garages'][$count]['id'].'" id="remove_garage_'.$context['garages'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#garages" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=business_add;type=garage" id="add_garage" name="add_garage" method="post" style="padding:0; margin:0;">
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_shops'].'</td>
                    ...
                    <tr>
                        ...
                        if(isset($context['shops'][$count]['id'])) {
                            while(isset($context['shops'][$count]['id'])) {
                                echo '
                                    <tr class="windowbg">
                                        <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['shops'][$count]['title'].'</td>
                                        <td align="right" width="75%" valign="middle">';
                                        
                                        if($context['shops'][$count]['pending'] == '1') {
                                            echo '
                                            <img src="', $settings['default_images_url'], '/icon_garage_disapprove_disabled.gif" alt="'.$txt['smfg_disapprove'].'" title="'.$txt['smfg_disapprove'].'" />
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_approve;BID='.$context['shops'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_shop_'.$context['shops'][$count]['id'].'" id="approve_shop_'.$context['shops'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#shops" />
                                            ...
                                            echo '
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_disable;BID='.$context['shops'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_shop_'.$context['shops'][$count]['id'].'" id="disable_shop_'.$context['shops'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#shops" />
                                        ...
                                        echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=business_edit;BID='.$context['shops'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=shop_delete;BID='.$context['shops'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_shop_'.$context['shops'][$count]['id'].'" id="remove_shop_'.$context['shops'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#shops" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=business_add;type=retail" id="add_shop" name="add_shop" method="post" style="padding:0; margin:0;">
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
            </tr>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_insurance'].'</td>
                    ...
                    <tr>
                        ...
                        if(isset($context['insurance'][$count]['id'])) {
                            while(isset($context['insurance'][$count]['id'])) {
                                echo '
                                    <tr class="windowbg">
                                        <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['insurance'][$count]['title'].'</td>
                                        <td align="right" width="75%" valign="middle">';
                                        
                                        if($context['insurance'][$count]['pending'] == '1') {
                                            echo '
                                            <img src="', $settings['default_images_url'], '/icon_garage_disapprove_disabled.gif" alt="'.$txt['smfg_disapprove'].'" title="'.$txt['smfg_disapprove'].'" />
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_approve;BID='.$context['insurance'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_insurance_'.$context['insurance'][$count]['id'].'" id="approve_insurance_'.$context['insurance'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#insurance" />
                                            ...
                                            echo '
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_disable;BID='.$context['insurance'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_insurance_'.$context['insurance'][$count]['id'].'" id="disable_insurance_'.$context['insurance'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#insurance" />
                                        ...
                                        echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=business_edit;BID='.$context['insurance'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=insurance_delete;BID='.$context['insurance'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_insurance_'.$context['insurance'][$count]['id'].'" id="remove_insurance_'.$context['insurance'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#insurance" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=business_add;type=insurance" id="add_insurance" name="add_insurance" method="post" style="padding:0; margin:0;">
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
            </tr>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_dynocenters'].'</td>
                    ...
                    <tr>
                        ...
                        if(isset($context['dynocenters'][$count]['id'])) {
                            while(isset($context['dynocenters'][$count]['id'])) {
                                echo '
                                    <tr class="windowbg">
                                        <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['dynocenters'][$count]['title'].'</td>
                                        <td align="right" width="75%" valign="middle">';
                                        
                                        if($context['dynocenters'][$count]['pending'] == '1') {
                                            echo '
                                            <img src="', $settings['default_images_url'], '/icon_garage_disapprove_disabled.gif" alt="'.$txt['smfg_disapprove'].'" title="'.$txt['smfg_disapprove'].'" />
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_approve;BID='.$context['dynocenters'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_dynocenter_'.$context['dynocenters'][$count]['id'].'" id="approve_dynocenter_'.$context['dynocenters'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#dynocenters" />
                                            ...
                                            echo '
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_disable;BID='.$context['dynocenters'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_dynocenter_'.$context['dynocenters'][$count]['id'].'" id="disable_dynocenter_'.$context['dynocenters'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#dynocenters" />
                                        ...
                                        echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=business_edit;BID='.$context['dynocenters'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=dynocenter_delete;BID='.$context['dynocenters'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_dynocenter_'.$context['dynocenters'][$count]['id'].'" id="remove_dynocenter_'.$context['dynocenters'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#dynocenters" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=business_add;type=dynocenter" id="add_dynocenter" name="add_dynocenter" method="post" style="padding:0; margin:0;">
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
            </tr>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_manufacturers'].'</td>
                    ...
                    <tr>
                        ...
                        if(isset($context['manufacturers'][$count]['id'])) {
                            while(isset($context['manufacturers'][$count]['id'])) {
                                echo '
                                    <tr class="windowbg">
                                        <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['manufacturers'][$count]['title'].'</td>
                                        <td align="right" width="75%" valign="middle">';
                                        
                                        if($context['manufacturers'][$count]['pending'] == '1') {
                                            echo '
                                            <img src="', $settings['default_images_url'], '/icon_garage_disapprove_disabled.gif" alt="'.$txt['smfg_disapprove'].'" title="'.$txt['smfg_disapprove'].'" />
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_approve;BID='.$context['manufacturers'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_manufacturer_'.$context['manufacturers'][$count]['id'].'" id="approve_manufacturer_'.$context['manufacturers'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#manufacturers" />
                                            ...
                                            echo '
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=business_disable;BID='.$context['manufacturers'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_manufacturer_'.$context['manufacturers'][$count]['id'].'" id="disable_manufacturer_'.$context['manufacturers'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#manufacturers" />
                                        ...
                                        echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=business_edit;BID='.$context['manufacturers'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=manufacturer_delete;BID='.$context['manufacturers'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_manufacturer_'.$context['manufacturers'][$count]['id'].'" id="remove_manufacturer_'.$context['manufacturers'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement#manufacturers" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=business_add;type=product" id="add_manufacturer" name="add_manufacturer" method="post" style="padding:0; margin:0;">
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
            </tr>
...
function template_add_business()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=business_insert" id="add_business" name="add_business" method="post" accept-charset="ISO-8859-1" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr><td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_create_business'].'</td>
                    ...
                    <tr>
                        <td class="windowbg2" colspan="3" align="center" valign="middle"><input type="submit" value="'.$txt['smfg_save'].'" /></td>
                    </tr>
                </table>
...
function template_edit_business()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=business_update" id="edit_business" name="edit_business" method="post" accept-charset="ISO-8859-1" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr><td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_business'].'</td>
        ...
        <input type="hidden" name="sc" value="'.$context['session_id'].'" /><input type="hidden" name="BID" value="'.$context['business']['bid'].'" />
    </form>
    <script language="JavaScript" type="text/javascript">
    function DoCustomValidation()
                {
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_categories'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['categories'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['categories'][$count]['title'].'</td>
                                    <td align="right" width="75%" valign="middle">';
                                    ...
                                    if($context['categories'][$count]['field_order'] == 1) {
                                        ...
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=category_move;direction=down;CID='.$context['categories'][$count]['id'].';order='.$context['categories'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_cat_down_'.$context['categories'][$count]['id'].'" id="move_cat_down_'.$context['categories'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=categories" />
                                    ...
                                    } else if($context['categories'][$count]['field_order'] == $context['categories']['total']) {
                                        echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=category_move;direction=up;CID='.$context['categories'][$count]['id'].';order='.$context['categories'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_cat_up_'.$context['categories'][$count]['id'].'" id="move_cat_up_'.$context['categories'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=categories" />
                                    ...
                                    echo '
                                    <a href="'.$scripturl.'?action=garagemanagement;sa=category_edit;CID='.$context['categories'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                    <form action="'.$scripturl.'?action=garagemanagement;sa=category_delete;CID='.$context['categories'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_category_'.$context['categories'][$count]['id'].'" id="remove_category_'.$context['categories'][$count]['id'].'" style="display: inline;">
                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=categories" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=category_add" id="category_add" name="category_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=categories" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
...
function template_edit_categories()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=category_update" id="edit_category" name="edit_category" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=categories" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_category'].'</td>
    ...
    echo '
            ...
            <tr>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="margin-left: 10px;" id="tab_table">
                    <tr id="tab_row">
                        ...
                        <td class="mirrortab_active_first" id="tab_active_left">&nbsp;</td>
                        <td valign="top" class="mirrortab_active_back" id="tab000">
                            <a href="'.$scripturl.'?action=garagemanagement;sa=makesmodels#makes" onclick="change_tab(\'000\');">'.$txt['smfg_makes'].'</a>
                        </td>
                        <td class="mirrortab_active_last" id="tab_active_right">&nbsp;</td>
                        <td valign="top" class="mirrortab_back" id="tab001">
                            <a href="'.$scripturl.'?action=garagemanagement;sa=makesmodels#models" onclick="change_tab(\'001\');">'.$txt['smfg_models'].'</a>
                        </td>
                        <td class="mirrortab_last">&nbsp;</td>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_makes'].'</td>
                    </tr>
                    <tr class="windowbg2">
                        <td class="windowbg2" valign="top" width="16"></td>
                        <td valign="top">'.$txt['smfg_create_make'].':</td>
                        <td class="windowbg2" width="70%">
                        <form action="'.$scripturl.'?action=garagemanagement;sa=make_add" id="make_add" name="make_add" method="post" style="padding:0; margin:0;">
                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels" />
                    ...
                    <tr>
                        ...
                        while(isset($context['makes'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['makes'][$count]['title'].'</td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    if($context['makes'][$count]['pending'] == '1') {
                                        echo '
                                        <img src="', $settings['default_images_url'], '/icon_garage_disapprove_disabled.gif" alt="'.$txt['smfg_disapprove'].'" title="'.$txt['smfg_disapprove'].'" />
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=make_approve;mkid='.$context['makes'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_make_'.$context['makes'][$count]['id'].'" id="approve_make_'.$context['makes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels" />
                                        ...
                                        echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=make_disable;mkid='.$context['makes'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_make_'.$context['makes'][$count]['id'].'" id="disable_make_'.$context['makes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels" />
                                    ...
                                    echo '
                                    <a href="'.$scripturl.'?action=garagemanagement;sa=make_edit;mkid='.$context['makes'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                    <form action="'.$scripturl.'?action=garagemanagement;sa=make_delete;mkid='.$context['makes'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_make_'.$context['makes'][$count]['id'].'" id="remove_make_'.$context['makes'][$count]['id'].'" style="display: inline;">
                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=make_add" id="make_add2" name="make_add2" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_models'].'</td>

                    </tr>
                    <tr class="windowbg2">
                        <td class="windowbg2" valign="top" width="16"><a href="'.$scripturl.'?action=helpadmin;help=create_model" onclick="return reqWin(this.href);" class="help"><img src="', $settings['actual_images_url'], '/helptopics.gif" alt="Help" border="0" align="top" /></a></td>
                        <td valign="top">'.$txt['smfg_create_modify_model'].':</td>
                        <td class="windowbg2" width="70%">
                        <form action="'.$scripturl.'?action=garagemanagement;sa=model_add" id="model_add" name="model_add" method="post" style="padding:0; margin:0;">
                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels#models" />
...
function template_edit_make()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=make_update" id="edit_make" name="edit_make" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_make'].'</td>
...
function template_edit_model()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=model_update" id="edit_model" name="edit_model" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=makesmodels#models" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_model'].'</td>
    ...
    var active_model_id = \'000\';
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_products'].'</td>

                    </tr>
                    <tr class="windowbg2">
                        <td class="windowbg2" valign="top" width="16"><a href="'.$scripturl.'?action=helpadmin;help=create_product" onclick="return reqWin(this.href);" class="help"><img src="', $settings['actual_images_url'], '/helptopics.gif" alt="Help" border="0" align="top" /></a></td>
                        <td valign="top">'.$txt['smfg_create_modify_product'].':</td>
                        <td class="windowbg2" width="70%">
                        <form action="'.$scripturl.'?action=garagemanagement;sa=product_add" id="product_add" name="product_add" method="post" style="padding:0; margin:0;">
...
function template_edit_product()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=product_update" id="edit_product" name="edit_product" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=products" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_product'].'</td>
...
function template_add_product()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=product_insert" id="product_add" name="product_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=products" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_create_product'].'</td>
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_tracks'].'</td>
                    ...
                    <tr>
                        ...
                        if(isset($context['tracks'][$count]['id'])) {
                            while(isset($context['tracks'][$count]['id'])) {
                                echo '
                                    <tr class="windowbg">
                                        <td align="left" valign="middle" class="windowbg2" nowrap="nowrap"><a href="'.$scripturl.'?action=garage;sa=view_track;TID='.$context['tracks'][$count]['id'].'">'.$context['tracks'][$count]['title'].'</a></td>
                                        <td align="right" width="75%" valign="middle">';
                                        
                                        if($context['tracks'][$count]['pending'] == '1') {
                                            echo '
                                            <img src="', $settings['default_images_url'], '/icon_garage_disapprove_disabled.gif" alt="'.$txt['smfg_disapprove'].'" title="'.$txt['smfg_disapprove'].'" />
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=track_approve;TID='.$context['tracks'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_track_'.$context['tracks'][$count]['id'].'" id="approve_track_'.$context['tracks'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
                                            ...
                                            echo '
                                            <form action="'.$scripturl.'?action=garagemanagement;sa=track_disable;TID='.$context['tracks'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="disable_track_'.$context['tracks'][$count]['id'].'" id="disable_track_'.$context['tracks'][$count]['id'].'" style="display: inline;">
                                                <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
                                        ...
                                        echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=track_edit;TID='.$context['tracks'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=track_delete;TID='.$context['tracks'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_track_'.$context['tracks'][$count]['id'].'" id="remove_track_'.$context['tracks'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=track_add" id="track_add" name="track_add" method="post" style="padding:0; margin:0;">
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
            </tr>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_track_conditions'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['conditions'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['conditions'][$count]['title'].'</td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    if($context['conditions'][$count]['field_order'] == 1) {
                                        echo '
                                        <img src="', $settings['default_images_url'], '/icon_up_disabled.gif" alt="'.$txt['smfg_move_up'].'" title="'.$txt['smfg_move_up'].'" />
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=tc_move;direction=down;TCID='.$context['conditions'][$count]['id'].';order='.$context['conditions'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_tc_down_'.$context['conditions'][$count]['id'].'" id="move_tc_down_'.$context['conditions'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
                                    ...
                                    } else if($context['conditions'][$count]['field_order'] == $context['conditions']['total']) {
                                        echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=tc_move;direction=up;TCID='.$context['conditions'][$count]['id'].';order='.$context['conditions'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_tc_up_'.$context['conditions'][$count]['id'].'" id="move_tc_up_'.$context['conditions'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
                                    ...
                                    echo '
                                    <a href="'.$scripturl.'?action=garagemanagement;sa=tc_edit;TCID='.$context['conditions'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                    <form action="'.$scripturl.'?action=garagemanagement;sa=tc_delete;TCID='.$context['conditions'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_tc_'.$context['conditions'][$count]['id'].'" id="remove_tc_'.$context['conditions'][$count]['id'].'" style="display: inline;">
                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=tc_add" id="condition_add" name="condition_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_lap_types'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['laptypes'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['laptypes'][$count]['title'].'</td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    if($context['laptypes'][$count]['field_order'] == 1) {
                                        echo '
                                        <img src="', $settings['default_images_url'], '/icon_up_disabled.gif" alt="'.$txt['smfg_move_up'].'" title="'.$txt['smfg_move_up'].'" />
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=lt_move;direction=down;LTID='.$context['laptypes'][$count]['id'].';order='.$context['laptypes'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_lt_down_'.$context['laptypes'][$count]['id'].'" id="move_lt_down_'.$context['laptypes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
                                    ...
                                    } else if($context['laptypes'][$count]['field_order'] == $context['laptypes']['total']) {
                                        echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=lt_move;direction=up;LTID='.$context['laptypes'][$count]['id'].';order='.$context['laptypes'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_lt_up_'.$context['laptypes'][$count]['id'].'" id="move_lt_up_'.$context['laptypes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
                                    ...
                                    echo '
                                    <a href="'.$scripturl.'?action=garagemanagement;sa=lt_edit;LTID='.$context['laptypes'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                    <form action="'.$scripturl.'?action=garagemanagement;sa=lt_delete;LTID='.$context['laptypes'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_lt_'.$context['laptypes'][$count]['id'].'" id="remove_lt_'.$context['laptypes'][$count]['id'].'" style="display: inline;">
                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=lt_add" id="laptype_add" name="laptype_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
...
function template_add_track()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=track_insert" id="track_add" name="track_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_create_track'].'</td>
...
function template_edit_track()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=track_update" id="edit_track" name="edit_track" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_track'].'</td>
...
function template_edit_track_condition()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=tc_update" id="edit_track_condition" name="edit_track_condition" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_track_condition'].'</td>
...
function template_edit_lap_type()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=lt_update" id="edit_lap_type" name="edit_lap_type"method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=tracks" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_lap_type'].'</td>
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_premium_types'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['premiumtypes'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['premiumtypes'][$count]['title'].'</td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    if($context['premiumtypes'][$count]['field_order'] == 1) {
                                        echo '
                                        <img src="', $settings['default_images_url'], '/icon_up_disabled.gif" alt="'.$txt['smfg_move_up'].'" title="'.$txt['smfg_move_up'].'" />
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=pt_move;direction=down;PTID='.$context['premiumtypes'][$count]['id'].';order='.$context['premiumtypes'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_pt_down_'.$context['premiumtypes'][$count]['id'].'" id="move_pt_down_'.$context['premiumtypes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
                                    ...
                                    } else if($context['premiumtypes'][$count]['field_order'] == $context['premiumtypes']['total']) {
                                        echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=pt_move;direction=up;PTID='.$context['premiumtypes'][$count]['id'].';order='.$context['premiumtypes'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_pt_up_'.$context['premiumtypes'][$count]['id'].'" id="move_pt_up_'.$context['premiumtypes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
                                    ...
                                    echo '
                                    <a href="'.$scripturl.'?action=garagemanagement;sa=pt_edit;PTID='.$context['premiumtypes'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                    <form action="'.$scripturl.'?action=garagemanagement;sa=pt_delete;PTID='.$context['premiumtypes'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_pt_'.$context['premiumtypes'][$count]['id'].'" id="remove_pt_'.$context['premiumtypes'][$count]['id'].'" style="display: inline;">
                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=pt_add" id="pt_add" name="pt_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_engine_types'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['enginetypes'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['enginetypes'][$count]['title'].'</td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    if($context['enginetypes'][$count]['field_order'] == 1) {
                                        echo '
                                        <img src="', $settings['default_images_url'], '/icon_up_disabled.gif" alt="'.$txt['smfg_move_up'].'" title="'.$txt['smfg_move_up'].'" />
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=et_move;direction=down;ETID='.$context['enginetypes'][$count]['id'].';order='.$context['enginetypes'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_et_down_'.$context['enginetypes'][$count]['id'].'" id="move_et_down_'.$context['enginetypes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
                                    ...
                                    } else if($context['enginetypes'][$count]['field_order'] == $context['enginetypes']['total']) {
                                        echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=et_move;direction=up;ETID='.$context['enginetypes'][$count]['id'].';order='.$context['enginetypes'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_et_up_'.$context['enginetypes'][$count]['id'].'" id="move_et_up_'.$context['enginetypes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
                                    ...
                                    echo '
                                    <a href="'.$scripturl.'?action=garagemanagement;sa=et_edit;ETID='.$context['enginetypes'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                    <form action="'.$scripturl.'?action=garagemanagement;sa=et_delete;ETID='.$context['enginetypes'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_et_'.$context['enginetypes'][$count]['id'].'" id="remove_et_'.$context['enginetypes'][$count]['id'].'" style="display: inline;">
                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=et_add" id="et_add" name="et_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_service_types'].'</td>
                        ...
                        while(isset($context['servicetypes'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    ...
                                    } else if($context['servicetypes'][$count]['field_order'] == $context['servicetypes']['total']) {
                                        echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=st_move;direction=up;STID='.$context['servicetypes'][$count]['id'].';order='.$context['servicetypes'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_st_up_'.$context['servicetypes'][$count]['id'].'" id="move_st_up_'.$context['servicetypes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
                                    ...
                                    echo '
                                    <a href="'.$scripturl.'?action=garagemanagement;sa=st_edit;STID='.$context['servicetypes'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                    <form action="'.$scripturl.'?action=garagemanagement;sa=st_delete;STID='.$context['servicetypes'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_st_'.$context['servicetypes'][$count]['id'].'" id="remove_st_'.$context['servicetypes'][$count]['id'].'" style="display: inline;">
                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=st_add" id="st_add" name="st_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_currency_types'].'</td>
                        ...
                        while(isset($context['currencytypes'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    ...
                                    } else if($context['currencytypes'][$count]['field_order'] == $context['currencytypes']['total']) {
                                        echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=ct_move;direction=up;CTID='.$context['currencytypes'][$count]['id'].';order='.$context['currencytypes'][$count]['field_order'].';sesc=' . $context['session_id'] . '" method="post" name="move_ct_up_'.$context['currencytypes'][$count]['id'].'" id="move_ct_up_'.$context['currencytypes'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
                                    ...
                                    echo '
                                    <a href="'.$scripturl.'?action=garagemanagement;sa=ct_edit;CTID='.$context['currencytypes'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                    <form action="'.$scripturl.'?action=garagemanagement;sa=ct_delete;CTID='.$context['currencytypes'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_ct_'.$context['currencytypes'][$count]['id'].'" id="remove_ct_'.$context['currencytypes'][$count]['id'].'" style="display: inline;">
                                        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        ...
        <form action="'.$scripturl.'?action=garagemanagement;sa=ct_add" id="ct_add" name="ct_add" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td>&nbsp;</td>
...
function template_edit_premium_type()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=pt_update" id="edit_premium_type" name="edit_premium_type" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_premium_type'].'</td>
...
function template_edit_engine_type()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=et_update" id="edit_engine_type" name="edit_engine_type" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_engine_type'].'</td>
...
function template_edit_service_type()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=st_update" id="edit_service_type" name="edit_service_type" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_service_type'].'</td>
...
function template_edit_currency_type()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=ct_update" id="edit_currency_type" name="edit_currency_type" method="post" style="padding:0; margin:0;">
        <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=other" />
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td>
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_edit_currency_type'].'</td>
...
function template_tools()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=orphan_results" id="tools_submit" name="tools_submit" method="post" style="padding:0; margin:0;">
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td align="center">
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_image_directory_size'].'</td>
                    </tr>
                    <tr>
                        <td class="windowbg">
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_optimize'].'</td>
                    </tr>
                    <tr>
                        <td class="windowbg">
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                            echo '
                                <tr class="windowbg">
                                    <td align="center" valign="middle" class="windowbg2">'.$txt['smfg_tools_description'].'
                                    </td>
                                </tr>';
                        echo '
                        </table>
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_regen_cache'].'</td>
                    </tr>
                    <tr>
                        <td class="windowbg">
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td align="center">
                <div id="rebuild_images_status" style="width: 50%; height: 45px; border: 1px dashed #000; text-align: center; ; margin-left: auto; margin-right: auto;" class="windowbg2"></div>
                </td>
            </tr>
        </table>
        <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
            ...
            <form method="get" action="'.$scripturl.'?action=garagemanagement;sa=rebuildimagesajax;regen=start" id="smfg_rebuild_images_form">
...
function template_orphan_results()
{
    ...
    echo '
        <form action="'.$scripturl.'?action=garagemanagement;sa=optimize" id="optimizedatabase" name="optimizedatabase" method="post" style="padding:0; margin:0;">
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                <td align="center">
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr>
                        ...
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">
                                <tr class="windowbg">
                                    <td align="center" valign="middle" class="windowbg2">'.$txt['smfg_orphan_results_description'].'</td>
                                </tr>
                        </table>
                        </td>
                    </tr>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_orphaned_files'].'</td>
                    </tr>
                    <tr>
                        <td class="windowbg" align="center">
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                        if(!empty($orphans)) {
                            ...
                            foreach($orphans AS $orphan) {
                                ...
                                echo '
                                        <tr class="windowbg">
                                            <td align="left" valign="middle" class="windowbg2"><input type="checkbox" name="orphaned_files[]" value="'.$orphan.'" />&nbsp;<a href="'.$boardurl.'/'.$smfgSettings['upload_directory'].$file[count($file)-1].'" rel="shadowbox">'.$file[count($file)-1].'</a></td>
                                        </tr>';
                                $count++;
                            }
                        } else {
                            echo '
                                <tr class="windowbg">
                                    <td align="center" valign="middle" class="windowbg2">'.$txt['smfg_no_orphans'].'</td>
                                </tr>';
                        }
                        echo '
                        </table>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_db_entries'].'</td>
                    </tr>
                    <tr>
                        <td class="windowbg" align="center">                      
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                        if(!empty($entries)) {
                            ...
                            foreach($entries AS $entry) {
                                echo '
                                        <tr class="windowbg">
                                            <td align="left" valign="middle" class="windowbg2"><input type="checkbox" name="db_entries[]" value="'.$entry.'" />&nbsp;'.$entry.'</td>
                                        </tr>';
                                $count++;
                            }
                        } else {
                            echo '
                                <tr class="windowbg">
                                    <td align="center" valign="middle" class="windowbg2">'.$txt['smfg_no_entries'].'</td>
                                </tr>';                            
                        }
                        echo '
                        </table>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_db_regen'].'</td>
                    </tr>
                    <tr>
                        <td class="windowbg" align="center">                      
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                        if(!empty($regen)) {
                            ...
                            foreach($regen AS $gen) {
                                echo '
                                        <tr class="windowbg">
                                            <td align="left" valign="middle" class="windowbg2"><input type="checkbox" name="db_regen[]" value="'.$gen.'" />&nbsp;<a href="'.$boardurl.'/'.$smfgSettings['upload_directory'].$gen.'" rel="shadowbox">'.$gen.'</a></td>
                                        </tr>';
                                $count++;
                            }
                        } else {
                            echo '
                                <tr class="windowbg">
                                    <td align="center" valign="middle" class="windowbg2">'.$txt['smfg_no_regen'].'</td>
                                </tr>';                            
                        }
                        echo '
                        </table>
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_db_missing_originals'].'</td>
                    </tr>
                    <tr>
                        <td class="windowbg" align="center">                      
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                        ...
                        foreach($missing AS $lost) {
                            echo '
                                    <tr class="windowbg">
                                        <td align="left" valign="middle" class="windowbg2"><!--<input type="checkbox" name="db_entries[]" value="'.$entry.'" />-->&nbsp;'.$lost.'</td>
                                    </tr>';
                            $count++;
                        }
                        echo '
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_vehicles_caps'].'</td>
                    </tr>
                    <tr>
                        <td class="windowbg">
                        <table border="0" cellpadding="3" cellspacing="1" width="100%" class="bordercolor">';
                        while(isset($context['vehicles'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap"><a href="'.$scripturl.'?action=profile;u='.$context['vehicles'][$count]['owner_id'].'">'.$context['vehicles'][$count]['owner'].'</a>\'s <a href="'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$context['vehicles'][$count]['id'].'">'.$context['vehicles'][$count]['vehicle'].'</a></td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=vehicle_approve;VID='.$context['vehicles'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_vehicle_'.$context['vehicles'][$count]['id'].'" id="approve_vehicle_'.$context['vehicles'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        ...
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=delete_vehicle;VID='.$context['vehicles'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_vehicle_'.$context['vehicles'][$count]['id'].'" id="remove_vehicle_'.$context['vehicles'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_modifications'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['mods'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap"><a href="'.$scripturl.'?action=garage;sa=view_modification;VID='.$context['mods'][$count]['vid'].';MID='.$context['mods'][$count]['id'].'">'.$context['mods'][$count]['modification'].'</a> on <a href="'.$scripturl.'?action=profile;u='.$context['mods'][$count]['owner_id'].'">'.$context['mods'][$count]['owner'].'</a>\'s <a href="'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$context['mods'][$count]['vid'].'">'.$context['mods'][$count]['vehicle'].'</a></td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=modification_approve;MID='.$context['mods'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_mod_'.$context['mods'][$count]['id'].'" id="approve_mod_'.$context['mods'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        ...
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=delete_modification;VID='.$context['mods'][$count]['vid'].';MID='.$context['mods'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_mod_'.$context['mods'][$count]['id'].'" id="remove_mod_'.$context['mods'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    ...
                    <tr>
                        ...
                        while(isset($context['makes'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['makes'][$count]['make'].'</td>
                                    <td align="right" width="75%" valign="middle">';
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    ...
                    <tr>
                        ...
                        while(isset($context['models'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['models'][$count]['make'].' '.$context['models'][$count]['model'].'</td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=model_approve;mdid='.$context['models'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_model_'.$context['models'][$count]['id'].'" id="approve_model_'.$context['models'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=model_edit;mdid='.$context['models'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=model_delete;mdid='.$context['models'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_model_'.$context['models'][$count]['id'].'" id="remove_model_'.$context['models'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_quartermiles'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['qmiles'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap"><a href="'.$scripturl.'?action=garage;sa=view_quartermile;VID='.$context['qmiles'][$count]['vid'].';QID='.$context['qmiles'][$count]['id'].'">Quartermile</a> for <a href="'.$scripturl.'?action=profile;u='.$context['qmiles'][$count]['owner_id'].'">'.$context['qmiles'][$count]['owner'].'</a>\'s <a href="'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$context['qmiles'][$count]['vid'].'">'.$context['qmiles'][$count]['vehicle'].'</a></td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=quartermile_approve;QID='.$context['qmiles'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_qmile_'.$context['qmiles'][$count]['id'].'" id="approve_qmile_'.$context['qmiles'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        ...
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=delete_quartermile;VID='.$context['qmiles'][$count]['vid'].';QID='.$context['qmiles'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_qmile_'.$context['qmiles'][$count]['id'].'" id="remove_qmile_'.$context['qmiles'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_dynoruns'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['dynoruns'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap"><a href="'.$scripturl.'?action=garage;sa=view_dynorun;VID='.$context['dynoruns'][$count]['vid'].';DID='.$context['dynoruns'][$count]['id'].'">Dynorun</a> for <a href="'.$scripturl.'?action=profile;u='.$context['dynoruns'][$count]['owner_id'].'">'.$context['dynoruns'][$count]['owner'].'</a>\'s <a href="'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$context['dynoruns'][$count]['vid'].'">'.$context['dynoruns'][$count]['vehicle'].'</a></td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=dynorun_approve;DID='.$context['dynoruns'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_dynorun_'.$context['dynoruns'][$count]['id'].'" id="approve_dynorun_'.$context['dynoruns'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        ...
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=delete_dynorun;VID='.$context['dynoruns'][$count]['vid'].';DID='.$context['dynoruns'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_dynorun_'.$context['dynoruns'][$count]['id'].'" id="remove_dynorun_'.$context['dynoruns'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_laptimes'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['laps'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap"><a href="'.$scripturl.'?action=garage;sa=view_laptime;VID='.$context['laps'][$count]['vid'].';LID='.$context['laps'][$count]['id'].'">Laptime</a> for <a href="'.$scripturl.'?action=profile;u='.$context['laps'][$count]['owner_id'].'">'.$context['laps'][$count]['owner'].'</a>\'s <a href="'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$context['laps'][$count]['vid'].'">'.$context['laps'][$count]['vehicle'].'</a></td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=laptime_approve;LID='.$context['laps'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_laptime_'.$context['laps'][$count]['id'].'" id="approve_laptime_'.$context['laps'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        ...
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=delete_laptime;VID='.$context['laps'][$count]['vid'].';LID='.$context['laps'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_laptime_'.$context['laps'][$count]['id'].'" id="remove_laptime_'.$context['laps'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    ...
                    <tr>
                        ...
                        while(isset($context['tracks'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap"><a href="'.$scripturl.'?action=garage;sa=view_track;TID='.$context['tracks'][$count]['id'].'">'.$context['tracks'][$count]['track'].'</a></td>
                                    <td align="right" width="75%" valign="middle">';
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_businesses'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['business'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['business'][$count]['business'].' ('.$context['business'][$count]['type'].')</td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=business_approve;BID='.$context['business'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_business_'.$context['business'][$count]['id'].'" id="approve_business_'.$context['business'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=business_edit;BID='.$context['business'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa='.$context['business'][$count]['lowertype'].'_delete;BID='.$context['business'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_business_'.$context['business'][$count]['id'].'" id="remove_business_'.$context['business'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    ...
                    <tr>
                        ...
                        while(isset($context['products'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">'.$context['products'][$count]['manufacturer'].' '.$context['products'][$count]['product'].' ('.$context['products'][$count]['category'].')</td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=product_approve;pid='.$context['products'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_product_'.$context['products'][$count]['id'].'" id="approve_product_'.$context['products'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        <a href="'.$scripturl.'?action=garagemanagement;sa=product_edit;pid='.$context['products'][$count]['id'].'"><img src="', $settings['default_images_url'], '/icon_edit.gif" alt="'.$txt['smfg_edit'].'" title="'.$txt['smfg_edit'].'" /></a>
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=product_delete;pid='.$context['products'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_product_'.$context['products'][$count]['id'].'" id="remove_product_'.$context['products'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_comments'].'</td>
                    ...
                    <tr>
                        ...
                        while(isset($context['comments'][$count]['id'])) {
                            echo '
                                <tr class="windowbg">
                                    <td align="left" valign="middle" class="windowbg2" nowrap="nowrap">Comment by <a href="'.$scripturl.'?action=profile;u='.$context['comments'][$count]['author_id'].'">'.$context['comments'][$count]['author'].'</a> on <a href="'.$scripturl.'?action=garage;sa=view_vehicle;VID='.$context['comments'][$count]['vid'].'">'.$context['comments'][$count]['vehicle'].'</a></td>
                                    <td align="right" width="75%" valign="middle">';
                                    
                                    echo '
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=comment_approve;CID='.$context['comments'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="approve_comment_'.$context['comments'][$count]['id'].'" id="approve_comment_'.$context['comments'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
                                    ...
                                    echo '
                                        ...
                                        <form action="'.$scripturl.'?action=garagemanagement;sa=delete_comment;VID='.$context['comments'][$count]['id'].';CID='.$context['comments'][$count]['id'].';sesc=' . $context['session_id'] . '" method="post" name="remove_comment_'.$context['comments'][$count]['id'].'" id="remove_comment_'.$context['comments'][$count]['id'].'" style="display: inline;">
                                            <input type="hidden" name="redirecturl" value="'.$scripturl.'?action=garagemanagement;sa=pending" />
    ...
    echo '
        <table width="80%" border="0" cellspacing="0" cellpadding="0" class="tborder" align="center">
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr class="titlebg">
                        <td colspan="3">'.$txt['smfg_pending_items'].'</td>
